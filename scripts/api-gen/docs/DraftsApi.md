# WriRestorationMarketplaceApi.DraftsApi
...
var apiInstance = new WriRestorationMarketplaceApi.DraftsApi();
...
apiInstance.draftsIDDelete(ID, callback);
```
...
apiInstance.draftsIDGet(ID, callback);
```
...
var body = new WriRestorationMarketplaceApi.DraftUpdate(); // DraftUpdate | 
...
apiInstance.draftsIDPatch(ID, body, callback);
```
...
apiInstance.draftsIDPublishPatch(ID, callback);
```
...
apiInstance.draftsOffersGet(callback);
```
...
apiInstance.draftsPitchesGet(callback);
```
...
var body = new WriRestorationMarketplaceApi.DraftCreate(); // DraftCreate | 
...
apiInstance.draftsPost(body, callback);
```
