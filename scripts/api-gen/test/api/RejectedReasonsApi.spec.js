...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RejectedReasonsApi();
  });
  ...
  describe('RejectedReasonsApi', function() {
    describe('rejectedReasonsGet', function() {
      it('should call rejectedReasonsGet successfully', function(done) {
        //uncomment below and update the code to test rejectedReasonsGet
        //instance.rejectedReasonsGet(function(error) {
