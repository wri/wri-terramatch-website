...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchVersionsApi();
  });
  ...
  describe('PitchVersionsApi', function() {
    describe('pitchVersionsIDApprovePatch', function() {
      it('should call pitchVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test pitchVersionsIDApprovePatch
        //instance.pitchVersionsIDApprovePatch(function(error) {
    ...
    describe('pitchVersionsIDDelete', function() {
      it('should call pitchVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test pitchVersionsIDDelete
        //instance.pitchVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchVersionsIDGet', function() {
      it('should call pitchVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test pitchVersionsIDGet
        //instance.pitchVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchVersionsIDRejectPatch', function() {
      it('should call pitchVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test pitchVersionsIDRejectPatch
        //instance.pitchVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDPitchVersionsGet', function() {
      it('should call pitchesIDPitchVersionsGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDPitchVersionsGet
        //instance.pitchesIDPitchVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
