...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionsApi();
  });
  ...
  describe('OrganisationDocumentVersionsApi', function() {
    describe('organisationDocumentVersionsIDApprovePatch', function() {
      it('should call organisationDocumentVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentVersionsIDApprovePatch
        //instance.organisationDocumentVersionsIDApprovePatch(function(error) {
    ...
    describe('organisationDocumentVersionsIDDelete', function() {
      it('should call organisationDocumentVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentVersionsIDDelete
        //instance.organisationDocumentVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationDocumentVersionsIDGet', function() {
      it('should call organisationDocumentVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentVersionsIDGet
        //instance.organisationDocumentVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationDocumentVersionsIDRejectPatch', function() {
      it('should call organisationDocumentVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentVersionsIDRejectPatch
        //instance.organisationDocumentVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationDocumentsIDOrganisationDocumentVersionsGet', function() {
      it('should call organisationDocumentsIDOrganisationDocumentVersionsGet successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentsIDOrganisationDocumentVersionsGet
        //instance.organisationDocumentsIDOrganisationDocumentVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
