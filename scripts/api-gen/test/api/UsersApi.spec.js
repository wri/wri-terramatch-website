...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    describe('organisationsIDUsersGet', function() {
      it('should call organisationsIDUsersGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDUsersGet
        //instance.organisationsIDUsersGet(function(error) {
    ...
    describe('usersAcceptPost', function() {
      it('should call usersAcceptPost successfully', function(done) {
        //uncomment below and update the code to test usersAcceptPost
        //instance.usersAcceptPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersInvitePost', function() {
      it('should call usersInvitePost successfully', function(done) {
        //uncomment below and update the code to test usersInvitePost
        //instance.usersInvitePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
