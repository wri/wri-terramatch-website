...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricsApi();
  });
  ...
  describe('RestorationMethodMetricsApi', function() {
    describe('pitchesIDRestorationMethodMetricsGet', function() {
      it('should call pitchesIDRestorationMethodMetricsGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDRestorationMethodMetricsGet
        //instance.pitchesIDRestorationMethodMetricsGet(function(error) {
    ...
    describe('pitchesIDRestorationMethodMetricsInspectGet', function() {
      it('should call pitchesIDRestorationMethodMetricsInspectGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDRestorationMethodMetricsInspectGet
        //instance.pitchesIDRestorationMethodMetricsInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricsIDDelete', function() {
      it('should call restorationMethodMetricsIDDelete successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricsIDDelete
        //instance.restorationMethodMetricsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricsIDGet', function() {
      it('should call restorationMethodMetricsIDGet successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricsIDGet
        //instance.restorationMethodMetricsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricsIDPatch', function() {
      it('should call restorationMethodMetricsIDPatch successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricsIDPatch
        //instance.restorationMethodMetricsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricsPost', function() {
      it('should call restorationMethodMetricsPost successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricsPost
        //instance.restorationMethodMetricsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
