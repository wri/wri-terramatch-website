...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.SustainableDevelopmentGoalsApi();
  });
  ...
  describe('SustainableDevelopmentGoalsApi', function() {
    describe('sustainableDevelopmentGoalsGet', function() {
      it('should call sustainableDevelopmentGoalsGet successfully', function(done) {
        //uncomment below and update the code to test sustainableDevelopmentGoalsGet
        //instance.sustainableDevelopmentGoalsGet(function(error) {
