  ...
  describe('OrganisationsApi', function() {
    ...
    describe('organisationsIDGet', function() {
      it('should call organisationsIDGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDGet
        //instance.organisationsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsIDPatch', function() {
      it('should call organisationsIDPatch successfully', function(done) {
        //uncomment below and update the code to test organisationsIDPatch
        //instance.organisationsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
