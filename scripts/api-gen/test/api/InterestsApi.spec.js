...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.InterestsApi();
  });
  ...
  describe('InterestsApi', function() {
    describe('interestsIDDelete', function() {
      it('should call interestsIDDelete successfully', function(done) {
        //uncomment below and update the code to test interestsIDDelete
        //instance.interestsIDDelete(function(error) {
    ...
    describe('interestsInitiatedGet', function() {
      it('should call interestsInitiatedGet successfully', function(done) {
        //uncomment below and update the code to test interestsInitiatedGet
        //instance.interestsInitiatedGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('interestsPost', function() {
      it('should call interestsPost successfully', function(done) {
        //uncomment below and update the code to test interestsPost
        //instance.interestsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('interestsReceivedGet', function() {
      it('should call interestsReceivedGet successfully', function(done) {
        //uncomment below and update the code to test interestsReceivedGet
        //instance.interestsReceivedGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
