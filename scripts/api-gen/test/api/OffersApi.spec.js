  ...
  describe('OffersApi', function() {
    describe('offersIDCompletePatch', function() {
      it('should call offersIDCompletePatch successfully', function(done) {
        //uncomment below and update the code to test offersIDCompletePatch
        //instance.offersIDCompletePatch(function(error) {
    ...
    describe('offersIDGet', function() {
      it('should call offersIDGet successfully', function(done) {
        //uncomment below and update the code to test offersIDGet
        //instance.offersIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offersIDPatch', function() {
      it('should call offersIDPatch successfully', function(done) {
        //uncomment below and update the code to test offersIDPatch
        //instance.offersIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offersSearchPost', function() {
      it('should call offersSearchPost successfully', function(done) {
        //uncomment below and update the code to test offersSearchPost
        //instance.offersSearchPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsIDOffersGet', function() {
      it('should call organisationsIDOffersGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDOffersGet
        //instance.organisationsIDOffersGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
