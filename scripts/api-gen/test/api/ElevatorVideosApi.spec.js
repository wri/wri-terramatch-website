...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ElevatorVideosApi();
  });

  describe('(package)', function() {
    describe('ElevatorVideosApi', function() {
      describe('elevatorVideosIDGet', function() {
        it('should call elevatorVideosIDGet successfully', function(done) {
          // TODO: uncomment, update parameter values for elevatorVideosIDGet call and complete the assertions
          /*
          var ID = 56;

          instance.elevatorVideosIDGet(ID, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.ElevatorVideoRead);
            expect(data.id).to.be.a('number');
            expect(data.id).to.be(0);
            expect(data.upload_id).to.be.a('number');
            expect(data.upload_id).to.be(0);
            expect(data.status).to.be.a('string');
            expect(data.status).to.be("");
            expect(data.uploaded_at).to.be.a(Date);
            expect(data.uploaded_at).to.be(new Date());
      ...
      describe('elevatorVideosPost', function() {
        it('should call elevatorVideosPost successfully', function(done) {
          // TODO: uncomment, update parameter values for elevatorVideosPost call and complete the assertions
          /*
          var body = new WriRestorationMarketplaceApi.ElevatorVideoCreate();
          body.introduction = 0;
          body.aims = 0;
          body.importance = 0;

          instance.elevatorVideosPost(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
