...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesApi();
  });
  ...
  describe('TreeSpeciesApi', function() {
    describe('pitchesIDTreeSpeciesGet', function() {
      it('should call pitchesIDTreeSpeciesGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDTreeSpeciesGet
        //instance.pitchesIDTreeSpeciesGet(function(error) {
    ...
    describe('pitchesIDTreeSpeciesInspectGet', function() {
      it('should call pitchesIDTreeSpeciesInspectGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDTreeSpeciesInspectGet
        //instance.pitchesIDTreeSpeciesInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesIDDelete', function() {
      it('should call treeSpeciesIDDelete successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesIDDelete
        //instance.treeSpeciesIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesIDGet', function() {
      it('should call treeSpeciesIDGet successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesIDGet
        //instance.treeSpeciesIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesIDPatch', function() {
      it('should call treeSpeciesIDPatch successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesIDPatch
        //instance.treeSpeciesIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesPost', function() {
      it('should call treeSpeciesPost successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesPost
        //instance.treeSpeciesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
