...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentsApi();
  });
  ...
  describe('OrganisationDocumentsApi', function() {
    describe('organisationDocumentsIDDelete', function() {
      it('should call organisationDocumentsIDDelete successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentsIDDelete
        //instance.organisationDocumentsIDDelete(function(error) {
    ...
    describe('organisationDocumentsIDGet', function() {
      it('should call organisationDocumentsIDGet successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentsIDGet
        //instance.organisationDocumentsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationDocumentsIDPatch', function() {
      it('should call organisationDocumentsIDPatch successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentsIDPatch
        //instance.organisationDocumentsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationDocumentsPost', function() {
      it('should call organisationDocumentsPost successfully', function(done) {
        //uncomment below and update the code to test organisationDocumentsPost
        //instance.organisationDocumentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsIDOrganisationDocumentsGet', function() {
      it('should call organisationsIDOrganisationDocumentsGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDOrganisationDocumentsGet
        //instance.organisationsIDOrganisationDocumentsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsIDOrganisationDocumentsInspectGet', function() {
      it('should call organisationsIDOrganisationDocumentsInspectGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDOrganisationDocumentsInspectGet
        //instance.organisationsIDOrganisationDocumentsInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
