...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchContactsApi();
  });
  ...
  describe('PitchContactsApi', function() {
    describe('pitchContactsIDDelete', function() {
      it('should call pitchContactsIDDelete successfully', function(done) {
        //uncomment below and update the code to test pitchContactsIDDelete
        //instance.pitchContactsIDDelete(function(error) {
    ...
    describe('pitchContactsPost', function() {
      it('should call pitchContactsPost successfully', function(done) {
        //uncomment below and update the code to test pitchContactsPost
        //instance.pitchContactsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDPitchContactsGet', function() {
      it('should call pitchesIDPitchContactsGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDPitchContactsGet
        //instance.pitchesIDPitchContactsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
