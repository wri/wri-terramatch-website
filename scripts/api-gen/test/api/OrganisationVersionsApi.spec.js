...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationVersionsApi();
  });
  ...
  describe('OrganisationVersionsApi', function() {
    describe('organisationVersionsIDApprovePatch', function() {
      it('should call organisationVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test organisationVersionsIDApprovePatch
        //instance.organisationVersionsIDApprovePatch(function(error) {
    ...
    describe('organisationVersionsIDDelete', function() {
      it('should call organisationVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test organisationVersionsIDDelete
        //instance.organisationVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationVersionsIDGet', function() {
      it('should call organisationVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test organisationVersionsIDGet
        //instance.organisationVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationVersionsIDRejectPatch', function() {
      it('should call organisationVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test organisationVersionsIDRejectPatch
        //instance.organisationVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsIDOrganisationVersionsGet', function() {
      it('should call organisationsIDOrganisationVersionsGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDOrganisationVersionsGet
        //instance.organisationsIDOrganisationVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
