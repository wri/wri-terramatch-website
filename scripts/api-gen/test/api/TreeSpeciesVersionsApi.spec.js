...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionsApi();
  });
  ...
  describe('TreeSpeciesVersionsApi', function() {
    describe('treeSpeciesIDTreeSpeciesVersionsGet', function() {
      it('should call treeSpeciesIDTreeSpeciesVersionsGet successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesIDTreeSpeciesVersionsGet
        //instance.treeSpeciesIDTreeSpeciesVersionsGet(function(error) {
    ...
    describe('treeSpeciesVersionsIDApprovePatch', function() {
      it('should call treeSpeciesVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesVersionsIDApprovePatch
        //instance.treeSpeciesVersionsIDApprovePatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesVersionsIDDelete', function() {
      it('should call treeSpeciesVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesVersionsIDDelete
        //instance.treeSpeciesVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesVersionsIDGet', function() {
      it('should call treeSpeciesVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesVersionsIDGet
        //instance.treeSpeciesVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('treeSpeciesVersionsIDRejectPatch', function() {
      it('should call treeSpeciesVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesVersionsIDRejectPatch
        //instance.treeSpeciesVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
