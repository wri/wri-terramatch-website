...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationCategoriesApi();
  });
  ...
  describe('OrganisationCategoriesApi', function() {
    describe('organisationCategoriesGet', function() {
      it('should call organisationCategoriesGet successfully', function(done) {
        //uncomment below and update the code to test organisationCategoriesGet
        //instance.organisationCategoriesGet(function(error) {
