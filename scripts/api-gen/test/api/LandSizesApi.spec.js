...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandSizesApi();
  });
  ...
  describe('LandSizesApi', function() {
    describe('landSizesGet', function() {
      it('should call landSizesGet successfully', function(done) {
        //uncomment below and update the code to test landSizesGet
        //instance.landSizesGet(function(error) {
