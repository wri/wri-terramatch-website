...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentVersionsApi();
  });
  ...
  describe('PitchDocumentVersionsApi', function() {
    describe('pitchDocumentVersionsIDApprovePatch', function() {
      it('should call pitchDocumentVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentVersionsIDApprovePatch
        //instance.pitchDocumentVersionsIDApprovePatch(function(error) {
    ...
    describe('pitchDocumentVersionsIDDelete', function() {
      it('should call pitchDocumentVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentVersionsIDDelete
        //instance.pitchDocumentVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchDocumentVersionsIDGet', function() {
      it('should call pitchDocumentVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentVersionsIDGet
        //instance.pitchDocumentVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchDocumentVersionsIDRejectPatch', function() {
      it('should call pitchDocumentVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentVersionsIDRejectPatch
        //instance.pitchDocumentVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchDocumentsIDPitchDocumentVersionsGet', function() {
      it('should call pitchDocumentsIDPitchDocumentVersionsGet successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentsIDPitchDocumentVersionsGet
        //instance.pitchDocumentsIDPitchDocumentVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
