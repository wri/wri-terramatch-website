...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesOwnersApi();
  });
  ...
  describe('TreeSpeciesOwnersApi', function() {
    describe('treeSpeciesOwnersGet', function() {
      it('should call treeSpeciesOwnersGet successfully', function(done) {
        //uncomment below and update the code to test treeSpeciesOwnersGet
        //instance.treeSpeciesOwnersGet(function(error) {
