...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ContinentsApi();
  });
  ...
  describe('ContinentsApi', function() {
    describe('continentsGet', function() {
      it('should call continentsGet successfully', function(done) {
        //uncomment below and update the code to test continentsGet
        //instance.continentsGet(function(error) {
