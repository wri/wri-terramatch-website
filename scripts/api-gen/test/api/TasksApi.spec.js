...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TasksApi();
  });
  ...
  describe('TasksApi', function() {
    describe('tasksMatchesGet', function() {
      it('should call tasksMatchesGet successfully', function(done) {
        //uncomment below and update the code to test tasksMatchesGet
        //instance.tasksMatchesGet(function(error) {
    ...
    describe('tasksOrganisationsGet', function() {
      it('should call tasksOrganisationsGet successfully', function(done) {
        //uncomment below and update the code to test tasksOrganisationsGet
        //instance.tasksOrganisationsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('tasksPitchesGet', function() {
      it('should call tasksPitchesGet successfully', function(done) {
        //uncomment below and update the code to test tasksPitchesGet
        //instance.tasksPitchesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
