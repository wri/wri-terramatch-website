...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.NotificationsApi();
  });
  ...
  describe('NotificationsApi', function() {
    ...
    describe('notificationsIDMarkPatch', function() {
      it('should call notificationsIDMarkPatch successfully', function(done) {
        //uncomment below and update the code to test notificationsIDMarkPatch
        //instance.notificationsIDMarkPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
