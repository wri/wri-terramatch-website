...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationsApi();
  });
  ...
  describe('CarbonCertificationsApi', function() {
    describe('carbonCertificationsIDDelete', function() {
      it('should call carbonCertificationsIDDelete successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationsIDDelete
        //instance.carbonCertificationsIDDelete(function(error) {
    ...
    describe('carbonCertificationsIDGet', function() {
      it('should call carbonCertificationsIDGet successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationsIDGet
        //instance.carbonCertificationsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('carbonCertificationsIDPatch', function() {
      it('should call carbonCertificationsIDPatch successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationsIDPatch
        //instance.carbonCertificationsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('carbonCertificationsPost', function() {
      it('should call carbonCertificationsPost successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationsPost
        //instance.carbonCertificationsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDCarbonCertificationsGet', function() {
      it('should call pitchesIDCarbonCertificationsGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDCarbonCertificationsGet
        //instance.pitchesIDCarbonCertificationsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDCarbonCertificationsInspectGet', function() {
      it('should call pitchesIDCarbonCertificationsInspectGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDCarbonCertificationsInspectGet
        //instance.pitchesIDCarbonCertificationsInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
