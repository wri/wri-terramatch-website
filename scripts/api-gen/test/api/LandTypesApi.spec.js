...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandTypesApi();
  });
  ...
  describe('LandTypesApi', function() {
    describe('landTypesGet', function() {
      it('should call landTypesGet successfully', function(done) {
        //uncomment below and update the code to test landTypesGet
        //instance.landTypesGet(function(error) {
