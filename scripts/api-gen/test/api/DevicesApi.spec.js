...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DevicesApi();
  });
  ...
  describe('DevicesApi', function() {
    ...
    describe('devicesIDGet', function() {
      it('should call devicesIDGet successfully', function(done) {
        //uncomment below and update the code to test devicesIDGet
        //instance.devicesIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('devicesIDPatch', function() {
      it('should call devicesIDPatch successfully', function(done) {
        //uncomment below and update the code to test devicesIDPatch
        //instance.devicesIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
