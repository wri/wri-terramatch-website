...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.MatchesApi();
  });
  ...
  describe('MatchesApi', function() {
    ...
    describe('matchesIDGet', function() {
      it('should call matchesIDGet successfully', function(done) {
        //uncomment below and update the code to test matchesIDGet
        //instance.matchesIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
