...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DocumentTypesApi();
  });
  ...
  describe('DocumentTypesApi', function() {
    describe('documentTypesGet', function() {
      it('should call documentTypesGet successfully', function(done) {
        //uncomment below and update the code to test documentTypesGet
        //instance.documentTypesGet(function(error) {
