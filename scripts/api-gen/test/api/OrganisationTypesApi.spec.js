...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationTypesApi();
  });
  ...
  describe('OrganisationTypesApi', function() {
    describe('organisationTypesGet', function() {
      it('should call organisationTypesGet successfully', function(done) {
        //uncomment below and update the code to test organisationTypesGet
        //instance.organisationTypesGet(function(error) {
