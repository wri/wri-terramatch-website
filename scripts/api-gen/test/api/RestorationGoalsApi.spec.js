...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationGoalsApi();
  });
  ...
  describe('RestorationGoalsApi', function() {
    describe('restorationGoalsGet', function() {
      it('should call restorationGoalsGet successfully', function(done) {
        //uncomment below and update the code to test restorationGoalsGet
        //instance.restorationGoalsGet(function(error) {
