  ...
  describe('PitchesApi', function() {
    describe('organisationsIDPitchesGet', function() {
      it('should call organisationsIDPitchesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDPitchesGet
        //instance.organisationsIDPitchesGet(function(error) {
    ...
    describe('organisationsIDPitchesInspectGet', function() {
      it('should call organisationsIDPitchesInspectGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDPitchesInspectGet
        //instance.organisationsIDPitchesInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDCompletePatch', function() {
      it('should call pitchesIDCompletePatch successfully', function(done) {
        //uncomment below and update the code to test pitchesIDCompletePatch
        //instance.pitchesIDCompletePatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDGet', function() {
      it('should call pitchesIDGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDGet
        //instance.pitchesIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDPatch', function() {
      it('should call pitchesIDPatch successfully', function(done) {
        //uncomment below and update the code to test pitchesIDPatch
        //instance.pitchesIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesPost', function() {
      it('should call pitchesPost successfully', function(done) {
        //uncomment below and update the code to test pitchesPost
        //instance.pitchesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesSearchPost', function() {
      it('should call pitchesSearchPost successfully', function(done) {
        //uncomment below and update the code to test pitchesSearchPost
        //instance.pitchesSearchPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
