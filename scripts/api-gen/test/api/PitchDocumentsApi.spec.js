  ...
  describe('PitchDocumentsApi', function() {
    describe('pitchDocumentsIDDelete', function() {
      it('should call pitchDocumentsIDDelete successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentsIDDelete
        //instance.pitchDocumentsIDDelete(function(error) {
    ...
    describe('pitchDocumentsIDGet', function() {
      it('should call pitchDocumentsIDGet successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentsIDGet
        //instance.pitchDocumentsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchDocumentsIDPatch', function() {
      it('should call pitchDocumentsIDPatch successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentsIDPatch
        //instance.pitchDocumentsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchDocumentsPost', function() {
      it('should call pitchDocumentsPost successfully', function(done) {
        //uncomment below and update the code to test pitchDocumentsPost
        //instance.pitchDocumentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDPitchDocumentsGet', function() {
      it('should call pitchesIDPitchDocumentsGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDPitchDocumentsGet
        //instance.pitchesIDPitchDocumentsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pitchesIDPitchDocumentsInspectGet', function() {
      it('should call pitchesIDPitchDocumentsInspectGet successfully', function(done) {
        //uncomment below and update the code to test pitchesIDPitchDocumentsInspectGet
        //instance.pitchesIDPitchDocumentsInspectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
