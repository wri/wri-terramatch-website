...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionsApi();
  });
  ...
  describe('RestorationMethodMetricVersionsApi', function() {
    describe('restorationMethodMetricVersionsIDApprovePatch', function() {
      it('should call restorationMethodMetricVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricVersionsIDApprovePatch
        //instance.restorationMethodMetricVersionsIDApprovePatch(function(error) {
    ...
    describe('restorationMethodMetricVersionsIDDelete', function() {
      it('should call restorationMethodMetricVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricVersionsIDDelete
        //instance.restorationMethodMetricVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricVersionsIDGet', function() {
      it('should call restorationMethodMetricVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricVersionsIDGet
        //instance.restorationMethodMetricVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricVersionsIDRejectPatch', function() {
      it('should call restorationMethodMetricVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricVersionsIDRejectPatch
        //instance.restorationMethodMetricVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restorationMethodMetricsIDRestorationMethodMetricVersionsGet', function() {
      it('should call restorationMethodMetricsIDRestorationMethodMetricVersionsGet successfully', function(done) {
        //uncomment below and update the code to test restorationMethodMetricsIDRestorationMethodMetricVersionsGet
        //instance.restorationMethodMetricsIDRestorationMethodMetricVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
