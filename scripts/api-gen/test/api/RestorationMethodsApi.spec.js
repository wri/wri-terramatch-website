...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodsApi();
  });
  ...
  describe('RestorationMethodsApi', function() {
    describe('restorationMethodsGet', function() {
      it('should call restorationMethodsGet successfully', function(done) {
        //uncomment below and update the code to test restorationMethodsGet
        //instance.restorationMethodsGet(function(error) {
