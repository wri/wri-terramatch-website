...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationTypesApi();
  });
  ...
  describe('CarbonCertificationTypesApi', function() {
    describe('carbonCertificationTypesGet', function() {
      it('should call carbonCertificationTypesGet successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationTypesGet
        //instance.carbonCertificationTypesGet(function(error) {
