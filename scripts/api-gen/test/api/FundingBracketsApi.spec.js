...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FundingBracketsApi();
  });
  ...
  describe('FundingBracketsApi', function() {
    describe('fundingBracketsGet', function() {
      it('should call fundingBracketsGet successfully', function(done) {
        //uncomment below and update the code to test fundingBracketsGet
        //instance.fundingBracketsGet(function(error) {
