...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CompatibilityScoresApi();
  });
  ...
  describe('CompatibilityScoresApi', function() {
    describe('compatibilityScoresPost', function() {
      it('should call compatibilityScoresPost successfully', function(done) {
        //uncomment below and update the code to test compatibilityScoresPost
        //instance.compatibilityScoresPost(function(error) {
