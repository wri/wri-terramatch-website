...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingLevelsApi();
  });
  ...
  describe('ReportingLevelsApi', function() {
    describe('reportingLevelsGet', function() {
      it('should call reportingLevelsGet successfully', function(done) {
        //uncomment below and update the code to test reportingLevelsGet
        //instance.reportingLevelsGet(function(error) {
