...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.VisibilitiesApi();
  });

  describe('(package)', function() {
    describe('VisibilitiesApi', function() {
      describe('visibilitiesGet', function() {
        it('should call visibilitiesGet successfully', function(done) {
          // TODO: uncomment visibilitiesGet call and complete the assertions
          /*

          instance.visibilitiesGet(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(WriRestorationMarketplaceApi.VisibilityReadAll);
