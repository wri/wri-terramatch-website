...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandOwnershipsApi();
  });
  ...
  describe('LandOwnershipsApi', function() {
    describe('landOwnershipsGet', function() {
      it('should call landOwnershipsGet successfully', function(done) {
        //uncomment below and update the code to test landOwnershipsGet
        //instance.landOwnershipsGet(function(error) {
