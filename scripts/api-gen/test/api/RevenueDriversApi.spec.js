...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RevenueDriversApi();
  });
  ...
  describe('RevenueDriversApi', function() {
    describe('revenueDriversGet', function() {
      it('should call revenueDriversGet successfully', function(done) {
        //uncomment below and update the code to test revenueDriversGet
        //instance.revenueDriversGet(function(error) {
