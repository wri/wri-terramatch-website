...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionsApi();
  });
  ...
  describe('CarbonCertificationVersionsApi', function() {
    describe('carbonCertificationVersionsIDApprovePatch', function() {
      it('should call carbonCertificationVersionsIDApprovePatch successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationVersionsIDApprovePatch
        //instance.carbonCertificationVersionsIDApprovePatch(function(error) {
    ...
    describe('carbonCertificationVersionsIDDelete', function() {
      it('should call carbonCertificationVersionsIDDelete successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationVersionsIDDelete
        //instance.carbonCertificationVersionsIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('carbonCertificationVersionsIDGet', function() {
      it('should call carbonCertificationVersionsIDGet successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationVersionsIDGet
        //instance.carbonCertificationVersionsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('carbonCertificationVersionsIDRejectPatch', function() {
      it('should call carbonCertificationVersionsIDRejectPatch successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationVersionsIDRejectPatch
        //instance.carbonCertificationVersionsIDRejectPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('carbonCertificationsIDCarbonCertificationVersionsGet', function() {
      it('should call carbonCertificationsIDCarbonCertificationVersionsGet successfully', function(done) {
        //uncomment below and update the code to test carbonCertificationsIDCarbonCertificationVersionsGet
        //instance.carbonCertificationsIDCarbonCertificationVersionsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
