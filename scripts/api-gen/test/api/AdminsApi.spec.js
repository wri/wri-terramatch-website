...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminsApi();
  });
  ...
  describe('AdminsApi', function() {
    describe('adminsAcceptPost', function() {
      it('should call adminsAcceptPost successfully', function(done) {
        //uncomment below and update the code to test adminsAcceptPost
        //instance.adminsAcceptPost(function(error) {
    ...
    describe('adminsGet', function() {
      it('should call adminsGet successfully', function(done) {
        //uncomment below and update the code to test adminsGet
        //instance.adminsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('adminsIDGet', function() {
      it('should call adminsIDGet successfully', function(done) {
        //uncomment below and update the code to test adminsIDGet
        //instance.adminsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('adminsIDPatch', function() {
      it('should call adminsIDPatch successfully', function(done) {
        //uncomment below and update the code to test adminsIDPatch
        //instance.adminsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('adminsInvitePost', function() {
      it('should call adminsInvitePost successfully', function(done) {
        //uncomment below and update the code to test adminsInvitePost
        //instance.adminsInvitePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
