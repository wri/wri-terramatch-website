...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferDocumentsApi();
  });
  ...
  describe('OfferDocumentsApi', function() {
    describe('offerDocumentsIDDelete', function() {
      it('should call offerDocumentsIDDelete successfully', function(done) {
        //uncomment below and update the code to test offerDocumentsIDDelete
        //instance.offerDocumentsIDDelete(function(error) {
    ...
    describe('offerDocumentsIDGet', function() {
      it('should call offerDocumentsIDGet successfully', function(done) {
        //uncomment below and update the code to test offerDocumentsIDGet
        //instance.offerDocumentsIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offerDocumentsIDPatch', function() {
      it('should call offerDocumentsIDPatch successfully', function(done) {
        //uncomment below and update the code to test offerDocumentsIDPatch
        //instance.offerDocumentsIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offerDocumentsPost', function() {
      it('should call offerDocumentsPost successfully', function(done) {
        //uncomment below and update the code to test offerDocumentsPost
        //instance.offerDocumentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offersIDOfferDocumentsGet', function() {
      it('should call offersIDOfferDocumentsGet successfully', function(done) {
        //uncomment below and update the code to test offersIDOfferDocumentsGet
        //instance.offersIDOfferDocumentsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
