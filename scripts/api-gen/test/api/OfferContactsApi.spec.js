...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferContactsApi();
  });
  ...
  describe('OfferContactsApi', function() {
    describe('offerContactsIDDelete', function() {
      it('should call offerContactsIDDelete successfully', function(done) {
        //uncomment below and update the code to test offerContactsIDDelete
        //instance.offerContactsIDDelete(function(error) {
    ...
    describe('offerContactsPost', function() {
      it('should call offerContactsPost successfully', function(done) {
        //uncomment below and update the code to test offerContactsPost
        //instance.offerContactsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('offersIDOfferContactsGet', function() {
      it('should call offersIDOfferContactsGet successfully', function(done) {
        //uncomment below and update the code to test offersIDOfferContactsGet
        //instance.offersIDOfferContactsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
