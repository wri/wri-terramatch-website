...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TeamMembersApi();
  });
  ...
  describe('TeamMembersApi', function() {
    describe('organisationsIDTeamMembersGet', function() {
      it('should call organisationsIDTeamMembersGet successfully', function(done) {
        //uncomment below and update the code to test organisationsIDTeamMembersGet
        //instance.organisationsIDTeamMembersGet(function(error) {
    ...
    describe('teamMembersIDDelete', function() {
      it('should call teamMembersIDDelete successfully', function(done) {
        //uncomment below and update the code to test teamMembersIDDelete
        //instance.teamMembersIDDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('teamMembersIDGet', function() {
      it('should call teamMembersIDGet successfully', function(done) {
        //uncomment below and update the code to test teamMembersIDGet
        //instance.teamMembersIDGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('teamMembersIDPatch', function() {
      it('should call teamMembersIDPatch successfully', function(done) {
        //uncomment below and update the code to test teamMembersIDPatch
        //instance.teamMembersIDPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('teamMembersPost', function() {
      it('should call teamMembersPost successfully', function(done) {
        //uncomment below and update the code to test teamMembersPost
        //instance.teamMembersPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
