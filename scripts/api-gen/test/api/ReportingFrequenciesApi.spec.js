...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingFrequenciesApi();
  });
  ...
  describe('ReportingFrequenciesApi', function() {
    describe('reportingFrequenciesGet', function() {
      it('should call reportingFrequenciesGet successfully', function(done) {
        //uncomment below and update the code to test reportingFrequenciesGet
        //instance.reportingFrequenciesGet(function(error) {
