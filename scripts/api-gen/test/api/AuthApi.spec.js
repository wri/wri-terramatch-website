...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AuthApi();
  });
  ...
  describe('AuthApi', function() {
    describe('authChangePatch', function() {
      it('should call authChangePatch successfully', function(done) {
        //uncomment below and update the code to test authChangePatch
        //instance.authChangePatch(function(error) {
    ...
    describe('authRefreshGet', function() {
      it('should call authRefreshGet successfully', function(done) {
        //uncomment below and update the code to test authRefreshGet
        //instance.authRefreshGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('authResendGet', function() {
      it('should call authResendGet successfully', function(done) {
        //uncomment below and update the code to test authResendGet
        //instance.authResendGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('authResetPost', function() {
      it('should call authResetPost successfully', function(done) {
        //uncomment below and update the code to test authResetPost
        //instance.authResetPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('authVerifyPatch', function() {
      it('should call authVerifyPatch successfully', function(done) {
        //uncomment below and update the code to test authVerifyPatch
        //instance.authVerifyPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
