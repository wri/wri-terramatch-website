...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataReadOfferContacts', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataReadOfferContacts();
      });

      it('should create an instance of DraftDataReadOfferContacts', function() {
        // TODO: update the code to test DraftDataReadOfferContacts
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataReadOfferContacts);
      });
