...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserReadAll();
  });
  ...
  describe('UserReadAll', function() {
    it('should create an instance of UserReadAll', function() {
      // uncomment below and update the code to test UserReadAll
      //var instance = new WriRestorationMarketplaceApi.UserReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserReadAll);
    });
