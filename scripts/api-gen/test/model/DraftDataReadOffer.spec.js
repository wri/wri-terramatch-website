...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataReadOffer', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataReadOffer();
      });

      it('should create an instance of DraftDataReadOffer', function() {
        // TODO: update the code to test DraftDataReadOffer
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataReadOffer);
      });
      ...
      it('should have the property price_per_tree (base name: "price_per_tree")', function() {
        // TODO: update the code to test the property price_per_tree
        expect(instance).to.have.property('price_per_tree');
        // expect(instance.price_per_tree).to.be(expectedValueLiteral);
      });
