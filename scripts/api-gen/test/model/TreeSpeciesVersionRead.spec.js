...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionRead();
  });
  ...
  describe('TreeSpeciesVersionRead', function() {
    it('should create an instance of TreeSpeciesVersionRead', function() {
      // uncomment below and update the code to test TreeSpeciesVersionRead
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionRead);
    });
