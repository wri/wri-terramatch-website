...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentReadAll();
  });
  ...
  describe('PitchDocumentReadAll', function() {
    it('should create an instance of PitchDocumentReadAll', function() {
      // uncomment below and update the code to test PitchDocumentReadAll
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentReadAll);
    });
