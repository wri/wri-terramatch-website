...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FilterCondition();
  });
  ...
  describe('FilterCondition', function() {
    it('should create an instance of FilterCondition', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.FilterCondition();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FilterCondition);
    });
