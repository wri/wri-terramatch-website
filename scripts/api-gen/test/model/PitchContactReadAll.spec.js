...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchContactReadAll();
  });
  ...
  describe('PitchContactReadAll', function() {
    it('should create an instance of PitchContactReadAll', function() {
      // uncomment below and update the code to test PitchContactReadAll
      //var instance = new WriRestorationMarketplaceApi.PitchContactReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchContactReadAll);
    });
