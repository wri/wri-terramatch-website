...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UploadCreate();
  });
  ...
  describe('UploadCreate', function() {
    it('should create an instance of UploadCreate', function() {
      // uncomment below and update the code to test UploadCreate
      //var instance = new WriRestorationMarketplaceApi.UploadCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UploadCreate);
    });
