...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.MatchReadAll();
  });
  ...
  describe('MatchReadAll', function() {
    it('should create an instance of MatchReadAll', function() {
      // uncomment below and update the code to test MatchReadAll
      //var instance = new WriRestorationMarketplaceApi.MatchReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.MatchReadAll);
    });
