...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentCreate();
  });
  ...
  describe('OrganisationDocumentCreate', function() {
    it('should create an instance of OrganisationDocumentCreate', function() {
      // uncomment below and update the code to test OrganisationDocumentCreate
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentCreate);
    });
