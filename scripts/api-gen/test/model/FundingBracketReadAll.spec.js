...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FundingBracketReadAll();
  });
  ...
  describe('FundingBracketReadAll', function() {
    it('should create an instance of FundingBracketReadAll', function() {
      // uncomment below and update the code to test FundingBracketReadAll
      //var instance = new WriRestorationMarketplaceApi.FundingBracketReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FundingBracketReadAll);
    });
