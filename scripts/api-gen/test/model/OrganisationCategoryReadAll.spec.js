...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationCategoryReadAll();
  });
  ...
  describe('OrganisationCategoryReadAll', function() {
    it('should create an instance of OrganisationCategoryReadAll', function() {
      // uncomment below and update the code to test OrganisationCategoryReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationCategoryReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationCategoryReadAll);
    });
