...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferDocumentReadAll();
  });
  ...
  describe('OfferDocumentReadAll', function() {
    it('should create an instance of OfferDocumentReadAll', function() {
      // uncomment below and update the code to test OfferDocumentReadAll
      //var instance = new WriRestorationMarketplaceApi.OfferDocumentReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferDocumentReadAll);
    });
