...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DeviceRead();
  });
  ...
  describe('DeviceRead', function() {
    it('should create an instance of DeviceRead', function() {
      // uncomment below and update the code to test DeviceRead
      //var instance = new WriRestorationMarketplaceApi.DeviceRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.DeviceRead);
    });
