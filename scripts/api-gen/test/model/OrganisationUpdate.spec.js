...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationUpdate();
  });
  ...
  describe('OrganisationUpdate', function() {
    it('should create an instance of OrganisationUpdate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.OrganisationUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationUpdate);
    });
