...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferContactRead();
  });
  ...
  describe('OfferContactRead', function() {
    it('should create an instance of OfferContactRead', function() {
      // uncomment below and update the code to test OfferContactRead
      //var instance = new WriRestorationMarketplaceApi.OfferContactRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferContactRead);
    });
