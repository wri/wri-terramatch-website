...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodReadAllInner();
  });
  ...
  describe('RestorationMethodReadAllInner', function() {
    it('should create an instance of RestorationMethodReadAllInner', function() {
      // uncomment below and update the code to test RestorationMethodReadAllInner
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodReadAllInner);
    });
