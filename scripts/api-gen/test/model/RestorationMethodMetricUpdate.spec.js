...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
  });
  ...
  describe('RestorationMethodMetricUpdate', function() {
    it('should create an instance of RestorationMethodMetricUpdate', function() {
      // uncomment below and update the code to test RestorationMethodMetricUpdate
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricUpdate);
    });

    it('should have the property restorationMethod (base name: "restoration_method")', function() {
      // uncomment below and update the code to test the property restorationMethod
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
    ...
    it('should have the property pricePerHectare (base name: "price_per_hectare")', function() {
      // uncomment below and update the code to test the property pricePerHectare
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
      //expect(instance).to.be();
    });

    it('should have the property biomassPerHectare (base name: "biomass_per_hectare")', function() {
      // uncomment below and update the code to test the property biomassPerHectare
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
      //expect(instance).to.be();
    });

    it('should have the property carbonImpact (base name: "carbon_impact")', function() {
      // uncomment below and update the code to test the property carbonImpact
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
      //expect(instance).to.be();
    });

    it('should have the property speciesImpacted (base name: "species_impacted")', function() {
      // uncomment below and update the code to test the property speciesImpacted
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricUpdate();
      //expect(instance).to.be();
    });
