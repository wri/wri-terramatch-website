...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PitchContactCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.PitchContactCreateDraft();
      });

      it('should create an instance of PitchContactCreateDraft', function() {
        // TODO: update the code to test PitchContactCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchContactCreateDraft);
      });
