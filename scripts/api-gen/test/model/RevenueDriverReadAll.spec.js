...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RevenueDriverReadAll();
  });
  ...
  describe('RevenueDriverReadAll', function() {
    it('should create an instance of RevenueDriverReadAll', function() {
      // uncomment below and update the code to test RevenueDriverReadAll
      //var instance = new WriRestorationMarketplaceApi.RevenueDriverReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RevenueDriverReadAll);
    });
