...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.Empty();
  });
  ...
  describe('Empty', function() {
    it('should create an instance of Empty', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.Empty();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.Empty);
    });
