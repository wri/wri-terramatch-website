...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationUpdate();
  });
  ...
  describe('CarbonCertificationUpdate', function() {
    it('should create an instance of CarbonCertificationUpdate', function() {
      // uncomment below and update the code to test CarbonCertificationUpdate
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationUpdate);
    });
    ...
    it('should have the property otherValue (base name: "other_value")', function() {
      // uncomment below and update the code to test the property otherValue
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationUpdate();
      //expect(instance).to.be();
    });
