...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse201OFFER', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.InlineResponse201OFFER();
      });

      it('should create an instance of InlineResponse201OFFER', function() {
        // TODO: update the code to test InlineResponse201OFFER
        expect(instance).to.be.a(WriRestorationMarketplaceApi.InlineResponse201OFFER);
      });
