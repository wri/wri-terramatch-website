...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RevenueDriverReadAllInner();
  });
  ...
  describe('RevenueDriverReadAllInner', function() {
    it('should create an instance of RevenueDriverReadAllInner', function() {
      // uncomment below and update the code to test RevenueDriverReadAllInner
      //var instance = new WriRestorationMarketplaceApi.RevenueDriverReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RevenueDriverReadAllInner);
    });
