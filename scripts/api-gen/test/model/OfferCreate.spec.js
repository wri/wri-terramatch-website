...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferCreate();
  });
  ...
  describe('OfferCreate', function() {
    it('should create an instance of OfferCreate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.OfferCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferCreate);
    });
