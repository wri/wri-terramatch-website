...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OfferContactCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.OfferContactCreateDraft();
      });

      it('should create an instance of OfferContactCreateDraft', function() {
        // TODO: update the code to test OfferContactCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferContactCreateDraft);
      });
