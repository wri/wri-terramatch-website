...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentUpdate();
  });
  ...
  describe('OrganisationDocumentUpdate', function() {
    it('should create an instance of OrganisationDocumentUpdate', function() {
      // uncomment below and update the code to test OrganisationDocumentUpdate
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentUpdate);
    });
