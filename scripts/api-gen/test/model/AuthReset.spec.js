...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AuthReset();
  });
  ...
  describe('AuthReset', function() {
    it('should create an instance of AuthReset', function() {
      // uncomment below and update the code to test AuthReset
      //var instance = new WriRestorationMarketplaceApi.AuthReset();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AuthReset);
    });
