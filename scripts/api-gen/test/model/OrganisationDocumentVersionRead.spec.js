...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionRead();
  });
  ...
  describe('OrganisationDocumentVersionRead', function() {
    it('should create an instance of OrganisationDocumentVersionRead', function() {
      // uncomment below and update the code to test OrganisationDocumentVersionRead
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
    });
