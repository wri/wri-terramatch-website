...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionReadAll();
  });
  ...
  describe('CarbonCertificationVersionReadAll', function() {
    it('should create an instance of CarbonCertificationVersionReadAll', function() {
      // uncomment below and update the code to test CarbonCertificationVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionReadAll);
    });
