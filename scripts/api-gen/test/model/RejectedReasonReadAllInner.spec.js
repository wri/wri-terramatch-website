...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RejectedReasonReadAllInner();
  });
  ...
  describe('RejectedReasonReadAllInner', function() {
    it('should create an instance of RejectedReasonReadAllInner', function() {
      // uncomment below and update the code to test RejectedReasonReadAllInner
      //var instance = new WriRestorationMarketplaceApi.RejectedReasonReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RejectedReasonReadAllInner);
    });
