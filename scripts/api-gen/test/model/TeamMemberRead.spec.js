...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TeamMemberRead();
  });
  ...
  describe('TeamMemberRead', function() {
    it('should create an instance of TeamMemberRead', function() {
      // uncomment below and update the code to test TeamMemberRead
      //var instance = new WriRestorationMarketplaceApi.TeamMemberRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TeamMemberRead);
    });
