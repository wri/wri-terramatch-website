...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.MatchContactRead();
  });
  ...
  describe('MatchContactRead', function() {
    it('should create an instance of MatchContactRead', function() {
      // uncomment below and update the code to test MatchContactRead
      //var instance = new WriRestorationMarketplaceApi.MatchContactRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.MatchContactRead);
    });
