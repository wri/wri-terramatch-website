...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentCreate();
  });
  ...
  describe('PitchDocumentCreate', function() {
    it('should create an instance of PitchDocumentCreate', function() {
      // uncomment below and update the code to test PitchDocumentCreate
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentCreate);
    });
