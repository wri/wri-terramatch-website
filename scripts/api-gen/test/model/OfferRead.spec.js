...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferRead();
  });
  ...
  describe('OfferRead', function() {
    it('should create an instance of OfferRead', function() {
      // uncomment below and update the code to test OfferRead
      //var instance = new WriRestorationMarketplaceApi.OfferRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferRead);
    });
