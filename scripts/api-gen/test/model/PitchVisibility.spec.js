...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PitchVisibility', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.PitchVisibility();
      });

      it('should create an instance of PitchVisibility', function() {
        // TODO: update the code to test PitchVisibility
        expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchVisibility);
      });
