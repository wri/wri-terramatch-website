...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferDocumentUpdate();
  });
  ...
  describe('OfferDocumentUpdate', function() {
    it('should create an instance of OfferDocumentUpdate', function() {
      // uncomment below and update the code to test OfferDocumentUpdate
      //var instance = new WriRestorationMarketplaceApi.OfferDocumentUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferDocumentUpdate);
    });
