...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionReadAll();
  });
  ...
  describe('TreeSpeciesVersionReadAll', function() {
    it('should create an instance of TreeSpeciesVersionReadAll', function() {
      // uncomment below and update the code to test TreeSpeciesVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionReadAll);
    });
