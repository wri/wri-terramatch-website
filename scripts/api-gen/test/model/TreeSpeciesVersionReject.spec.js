...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionReject();
  });
  ...
  describe('TreeSpeciesVersionReject', function() {
    it('should create an instance of TreeSpeciesVersionReject', function() {
      // uncomment below and update the code to test TreeSpeciesVersionReject
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesVersionReject);
    });
