...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchUpdate();
  });
  ...
  describe('PitchUpdate', function() {
    it('should create an instance of PitchUpdate', function() {
      // uncomment below and update the code to test PitchUpdate
      //var instance = new WriRestorationMarketplaceApi.PitchUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchUpdate);
    });
