...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DeviceReadAll();
  });
  ...
  describe('DeviceReadAll', function() {
    it('should create an instance of DeviceReadAll', function() {
      // uncomment below and update the code to test DeviceReadAll
      //var instance = new WriRestorationMarketplaceApi.DeviceReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.DeviceReadAll);
    });
