...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchContactRead();
  });
  ...
  describe('PitchContactRead', function() {
    it('should create an instance of PitchContactRead', function() {
      // uncomment below and update the code to test PitchContactRead
      //var instance = new WriRestorationMarketplaceApi.PitchContactRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchContactRead);
    });
