...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationCategoryReadAllInner();
  });
  ...
  describe('OrganisationCategoryReadAllInner', function() {
    it('should create an instance of OrganisationCategoryReadAllInner', function() {
      // uncomment below and update the code to test OrganisationCategoryReadAllInner
      //var instance = new WriRestorationMarketplaceApi.OrganisationCategoryReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationCategoryReadAllInner);
    });
