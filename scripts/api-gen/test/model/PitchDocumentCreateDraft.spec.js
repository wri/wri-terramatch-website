...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PitchDocumentCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.PitchDocumentCreateDraft();
      });

      it('should create an instance of PitchDocumentCreateDraft', function() {
        // TODO: update the code to test PitchDocumentCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentCreateDraft);
      });
