...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestorationMethodMetricCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.RestorationMethodMetricCreateDraft();
      });

      it('should create an instance of RestorationMethodMetricCreateDraft', function() {
        // TODO: update the code to test RestorationMethodMetricCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricCreateDraft);
      });
