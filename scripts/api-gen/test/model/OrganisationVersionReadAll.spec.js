...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationVersionReadAll();
  });
  ...
  describe('OrganisationVersionReadAll', function() {
    it('should create an instance of OrganisationVersionReadAll', function() {
      // uncomment below and update the code to test OrganisationVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionReadAll);
    });
