...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VisibilityReadAll', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.VisibilityReadAll();
      });

      it('should create an instance of VisibilityReadAll', function() {
        // TODO: update the code to test VisibilityReadAll
        expect(instance).to.be.a(WriRestorationMarketplaceApi.VisibilityReadAll);
      });
