...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferDocumentRead();
  });
  ...
  describe('OfferDocumentRead', function() {
    it('should create an instance of OfferDocumentRead', function() {
      // uncomment below and update the code to test OfferDocumentRead
      //var instance = new WriRestorationMarketplaceApi.OfferDocumentRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferDocumentRead);
    });
