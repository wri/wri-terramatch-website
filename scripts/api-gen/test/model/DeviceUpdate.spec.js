...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DeviceUpdate();
  });
  ...
  describe('DeviceUpdate', function() {
    it('should create an instance of DeviceUpdate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.DeviceUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.DeviceUpdate);
    });
