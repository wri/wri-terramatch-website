...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VisibilityReadAllInner', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.VisibilityReadAllInner();
      });

      it('should create an instance of VisibilityReadAllInner', function() {
        // TODO: update the code to test VisibilityReadAllInner
        expect(instance).to.be.a(WriRestorationMarketplaceApi.VisibilityReadAllInner);
      });
