...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingLevelReadAllInner();
  });
  ...
  describe('ReportingLevelReadAllInner', function() {
    it('should create an instance of ReportingLevelReadAllInner', function() {
      // uncomment below and update the code to test ReportingLevelReadAllInner
      //var instance = new WriRestorationMarketplaceApi.ReportingLevelReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ReportingLevelReadAllInner);
    });
