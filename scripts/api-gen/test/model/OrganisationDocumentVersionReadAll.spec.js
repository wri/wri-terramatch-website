...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll();
  });
  ...
  describe('OrganisationDocumentVersionReadAll', function() {
    it('should create an instance of OrganisationDocumentVersionReadAll', function() {
      // uncomment below and update the code to test OrganisationDocumentVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll);
    });
