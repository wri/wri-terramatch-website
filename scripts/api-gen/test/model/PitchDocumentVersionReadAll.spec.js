...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentVersionReadAll();
  });
  ...
  describe('PitchDocumentVersionReadAll', function() {
    it('should create an instance of PitchDocumentVersionReadAll', function() {
      // uncomment below and update the code to test PitchDocumentVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionReadAll);
    });
