...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaskedTeamMemberRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.MaskedTeamMemberRead();
      });

      it('should create an instance of MaskedTeamMemberRead', function() {
        // TODO: update the code to test MaskedTeamMemberRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.MaskedTeamMemberRead);
      });
      ...
      it('should have the property organisation_id (base name: "organisation_id")', function() {
        // TODO: update the code to test the property organisation_id
        expect(instance).to.have.property('organisation_id');
        // expect(instance.organisation_id).to.be(expectedValueLiteral);
      });
