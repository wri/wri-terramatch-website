...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentUpdate();
  });
  ...
  describe('PitchDocumentUpdate', function() {
    it('should create an instance of PitchDocumentUpdate', function() {
      // uncomment below and update the code to test PitchDocumentUpdate
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentUpdate);
    });
