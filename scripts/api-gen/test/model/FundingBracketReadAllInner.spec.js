...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FundingBracketReadAllInner();
  });
  ...
  describe('FundingBracketReadAllInner', function() {
    it('should create an instance of FundingBracketReadAllInner', function() {
      // uncomment below and update the code to test FundingBracketReadAllInner
      //var instance = new WriRestorationMarketplaceApi.FundingBracketReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FundingBracketReadAllInner);
    });
