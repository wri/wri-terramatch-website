...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataOfferReadOfferContacts', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataOfferReadOfferContacts();
      });

      it('should create an instance of DraftDataOfferReadOfferContacts', function() {
        // TODO: update the code to test DraftDataOfferReadOfferContacts
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataOfferReadOfferContacts);
      });

      it('should have the property user_id (base name: "user_id")', function() {
        // TODO: update the code to test the property user_id
        expect(instance).to.have.property('user_id');
        // expect(instance.user_id).to.be(expectedValueLiteral);
      });

      it('should have the property team_member_id (base name: "team_member_id")', function() {
        // TODO: update the code to test the property team_member_id
        expect(instance).to.have.property('team_member_id');
        // expect(instance.team_member_id).to.be(expectedValueLiteral);
      });
