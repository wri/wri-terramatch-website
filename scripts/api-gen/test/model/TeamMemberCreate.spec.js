...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TeamMemberCreate();
  });
  ...
  describe('TeamMemberCreate', function() {
    it('should create an instance of TeamMemberCreate', function() {
      // uncomment below and update the code to test TeamMemberCreate
      //var instance = new WriRestorationMarketplaceApi.TeamMemberCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TeamMemberCreate);
    });
