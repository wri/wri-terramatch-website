...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TokenRead();
  });
  ...
  describe('TokenRead', function() {
    it('should create an instance of TokenRead', function() {
      // uncomment below and update the code to test TokenRead
      //var instance = new WriRestorationMarketplaceApi.TokenRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TokenRead);
    });
