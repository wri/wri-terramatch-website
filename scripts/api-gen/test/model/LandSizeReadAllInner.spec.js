...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandSizeReadAllInner();
  });
  ...
  describe('LandSizeReadAllInner', function() {
    it('should create an instance of LandSizeReadAllInner', function() {
      // uncomment below and update the code to test LandSizeReadAllInner
      //var instance = new WriRestorationMarketplaceApi.LandSizeReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.LandSizeReadAllInner);
    });
