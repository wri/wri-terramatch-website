...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationReadAll();
  });
  ...
  describe('CarbonCertificationReadAll', function() {
    it('should create an instance of CarbonCertificationReadAll', function() {
      // uncomment below and update the code to test CarbonCertificationReadAll
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationReadAll);
    });
