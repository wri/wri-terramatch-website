...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferReadAll();
  });
  ...
  describe('OfferReadAll', function() {
    it('should create an instance of OfferReadAll', function() {
      // uncomment below and update the code to test OfferReadAll
      //var instance = new WriRestorationMarketplaceApi.OfferReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferReadAll);
    });
