...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionReject();
  });
  ...
  describe('OrganisationDocumentVersionReject', function() {
    it('should create an instance of OrganisationDocumentVersionReject', function() {
      // uncomment below and update the code to test OrganisationDocumentVersionReject
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentVersionReject);
    });
