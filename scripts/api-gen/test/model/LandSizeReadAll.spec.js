...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandSizeReadAll();
  });
  ...
  describe('LandSizeReadAll', function() {
    it('should create an instance of LandSizeReadAll', function() {
      // uncomment below and update the code to test LandSizeReadAll
      //var instance = new WriRestorationMarketplaceApi.LandSizeReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.LandSizeReadAll);
    });
