...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionRead();
  });
  ...
  describe('CarbonCertificationVersionRead', function() {
    it('should create an instance of CarbonCertificationVersionRead', function() {
      // uncomment below and update the code to test CarbonCertificationVersionRead
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
    });
