...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CountryReadAll();
  });
  ...
  describe('CountryReadAll', function() {
    it('should create an instance of CountryReadAll', function() {
      // uncomment below and update the code to test CountryReadAll
      //var instance = new WriRestorationMarketplaceApi.CountryReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CountryReadAll);
    });
