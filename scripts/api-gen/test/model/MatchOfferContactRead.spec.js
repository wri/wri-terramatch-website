...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MatchOfferContactRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.MatchOfferContactRead();
      });

      it('should create an instance of MatchOfferContactRead', function() {
        // TODO: update the code to test MatchOfferContactRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.MatchOfferContactRead);
      });
