...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminInvite();
  });
  ...
  describe('AdminInvite', function() {
    it('should create an instance of AdminInvite', function() {
      // uncomment below and update the code to test AdminInvite
      //var instance = new WriRestorationMarketplaceApi.AdminInvite();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AdminInvite);
    });
