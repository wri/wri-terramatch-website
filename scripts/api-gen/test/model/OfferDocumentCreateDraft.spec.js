...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OfferDocumentCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.OfferDocumentCreateDraft();
      });

      it('should create an instance of OfferDocumentCreateDraft', function() {
        // TODO: update the code to test OfferDocumentCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferDocumentCreateDraft);
      });
