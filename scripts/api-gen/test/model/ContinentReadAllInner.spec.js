...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ContinentReadAllInner();
  });
  ...
  describe('ContinentReadAllInner', function() {
    it('should create an instance of ContinentReadAllInner', function() {
      // uncomment below and update the code to test ContinentReadAllInner
      //var instance = new WriRestorationMarketplaceApi.ContinentReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ContinentReadAllInner);
    });
