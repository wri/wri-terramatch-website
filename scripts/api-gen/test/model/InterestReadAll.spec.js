...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.InterestReadAll();
  });
  ...
  describe('InterestReadAll', function() {
    it('should create an instance of InterestReadAll', function() {
      // uncomment below and update the code to test InterestReadAll
      //var instance = new WriRestorationMarketplaceApi.InterestReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.InterestReadAll);
    });
