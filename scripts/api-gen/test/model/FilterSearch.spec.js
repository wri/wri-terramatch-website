...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FilterSearch();
  });
  ...
  describe('FilterSearch', function() {
    it('should create an instance of FilterSearch', function() {
      // uncomment below and update the code to test FilterSearch
      //var instance = new WriRestorationMarketplaceApi.FilterSearch();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FilterSearch);
    });
