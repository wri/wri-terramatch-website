...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OfferVisibility', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.OfferVisibility();
      });

      it('should create an instance of OfferVisibility', function() {
        // TODO: update the code to test OfferVisibility
        expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferVisibility);
      });
