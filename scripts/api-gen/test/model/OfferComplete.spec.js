...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferComplete();
  });
  ...
  describe('OfferComplete', function() {
    it('should create an instance of OfferComplete', function() {
      // uncomment below and update the code to test OfferComplete
      //var instance = new WriRestorationMarketplaceApi.OfferComplete();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferComplete);
    });
