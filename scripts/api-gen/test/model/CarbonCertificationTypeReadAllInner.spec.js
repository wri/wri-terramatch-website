...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner();
  });
  ...
  describe('CarbonCertificationTypeReadAllInner', function() {
    it('should create an instance of CarbonCertificationTypeReadAllInner', function() {
      // uncomment below and update the code to test CarbonCertificationTypeReadAllInner
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner);
    });
