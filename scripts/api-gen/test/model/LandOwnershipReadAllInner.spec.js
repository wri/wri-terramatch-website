...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandOwnershipReadAllInner();
  });
  ...
  describe('LandOwnershipReadAllInner', function() {
    it('should create an instance of LandOwnershipReadAllInner', function() {
      // uncomment below and update the code to test LandOwnershipReadAllInner
      //var instance = new WriRestorationMarketplaceApi.LandOwnershipReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.LandOwnershipReadAllInner);
    });
