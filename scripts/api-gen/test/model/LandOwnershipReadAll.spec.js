...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandOwnershipReadAll();
  });
  ...
  describe('LandOwnershipReadAll', function() {
    it('should create an instance of LandOwnershipReadAll', function() {
      // uncomment below and update the code to test LandOwnershipReadAll
      //var instance = new WriRestorationMarketplaceApi.LandOwnershipReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.LandOwnershipReadAll);
    });
