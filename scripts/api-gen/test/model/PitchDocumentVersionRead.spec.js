...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentVersionRead();
  });
  ...
  describe('PitchDocumentVersionRead', function() {
    it('should create an instance of PitchDocumentVersionRead', function() {
      // uncomment below and update the code to test PitchDocumentVersionRead
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionRead);
    });
