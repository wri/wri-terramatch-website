...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.NotificationRead();
  });
  ...
  describe('NotificationRead', function() {
    it('should create an instance of NotificationRead', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.NotificationRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.NotificationRead);
    });
    ...
    it('should have the property referencedModel (base name: "referenced_model")', function() {
      // uncomment below and update the code to test the property referencedModel
      //var instance = new WriRestorationMarketplaceApi.NotificationRead();
      //expect(instance).to.be();
    });

    it('should have the property referencedModelId (base name: "referenced_model_id")', function() {
      // uncomment below and update the code to test the property referencedModelId
      //var instance = new WriRestorationMarketplaceApi.NotificationRead();
      //expect(instance).to.be();
    });
