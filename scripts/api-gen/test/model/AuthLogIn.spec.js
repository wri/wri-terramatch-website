...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AuthLogIn();
  });
  ...
  describe('AuthLogIn', function() {
    it('should create an instance of AuthLogIn', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.AuthLogIn();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AuthLogIn);
    });
