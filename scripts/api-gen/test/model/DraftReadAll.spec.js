...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftReadAll', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftReadAll();
      });

      it('should create an instance of DraftReadAll', function() {
        // TODO: update the code to test DraftReadAll
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftReadAll);
      });
