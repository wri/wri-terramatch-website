...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaskedUserRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.MaskedUserRead();
      });

      it('should create an instance of MaskedUserRead', function() {
        // TODO: update the code to test MaskedUserRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.MaskedUserRead);
      });
