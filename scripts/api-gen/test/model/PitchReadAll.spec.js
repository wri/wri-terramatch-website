...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchReadAll();
  });
  ...
  describe('PitchReadAll', function() {
    it('should create an instance of PitchReadAll', function() {
      // uncomment below and update the code to test PitchReadAll
      //var instance = new WriRestorationMarketplaceApi.PitchReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchReadAll);
    });
