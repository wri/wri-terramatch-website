...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricCreate();
  });
  ...
  describe('RestorationMethodMetricCreate', function() {
    it('should create an instance of RestorationMethodMetricCreate', function() {
      // uncomment below and update the code to test RestorationMethodMetricCreate
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricCreate);
    });
