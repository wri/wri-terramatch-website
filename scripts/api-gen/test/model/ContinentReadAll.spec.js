...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ContinentReadAll();
  });
  ...
  describe('ContinentReadAll', function() {
    it('should create an instance of ContinentReadAll', function() {
      // uncomment below and update the code to test ContinentReadAll
      //var instance = new WriRestorationMarketplaceApi.ContinentReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ContinentReadAll);
    });
