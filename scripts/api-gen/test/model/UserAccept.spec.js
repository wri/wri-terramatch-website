...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserAccept();
  });
  ...
  describe('UserAccept', function() {
    it('should create an instance of UserAccept', function() {
      // uncomment below and update the code to test UserAccept
      //var instance = new WriRestorationMarketplaceApi.UserAccept();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserAccept);
    });
