...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesReadAll();
  });
  ...
  describe('TreeSpeciesReadAll', function() {
    it('should create an instance of TreeSpeciesReadAll', function() {
      // uncomment below and update the code to test TreeSpeciesReadAll
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesReadAll);
    });
