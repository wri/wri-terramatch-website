...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.SustainableDevelopmentGoalReadAll();
  });
  ...
  describe('SustainableDevelopmentGoalReadAll', function() {
    it('should create an instance of SustainableDevelopmentGoalReadAll', function() {
      // uncomment below and update the code to test SustainableDevelopmentGoalReadAll
      //var instance = new WriRestorationMarketplaceApi.SustainableDevelopmentGoalReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.SustainableDevelopmentGoalReadAll);
    });
