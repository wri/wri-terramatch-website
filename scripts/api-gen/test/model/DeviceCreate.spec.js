...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DeviceCreate();
  });
  ...
  describe('DeviceCreate', function() {
    it('should create an instance of DeviceCreate', function() {
      // uncomment below and update the code to test DeviceCreate
      //var instance = new WriRestorationMarketplaceApi.DeviceCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.DeviceCreate);
    });
    ...
    it('should have the property pushToken (base name: "push_token")', function() {
