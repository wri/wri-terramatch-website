...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ElevatorVideoCreate', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.ElevatorVideoCreate();
      });

      it('should create an instance of ElevatorVideoCreate', function() {
        // TODO: update the code to test ElevatorVideoCreate
        expect(instance).to.be.a(WriRestorationMarketplaceApi.ElevatorVideoCreate);
      });
      ...
      it('should have the property aims (base name: "aims")', function() {
        // TODO: update the code to test the property aims
        expect(instance).to.have.property('aims');
        // expect(instance.aims).to.be(expectedValueLiteral);
      });
