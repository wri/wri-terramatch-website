...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataPitchReadCarbonCertifications', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataPitchReadCarbonCertifications();
      });

      it('should create an instance of DraftDataPitchReadCarbonCertifications', function() {
        // TODO: update the code to test DraftDataPitchReadCarbonCertifications
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataPitchReadCarbonCertifications);
      });
