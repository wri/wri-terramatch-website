...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftRead();
      });

      it('should create an instance of DraftRead', function() {
        // TODO: update the code to test DraftRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftRead);
      });
      ...
      it('should have the property updated_by (base name: "updated_by")', function() {
        // TODO: update the code to test the property updated_by
        expect(instance).to.have.property('updated_by');
        // expect(instance.updated_by).to.be(expectedValueLiteral);
      });
