...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationGoalReadAllInner();
  });
  ...
  describe('RestorationGoalReadAllInner', function() {
    it('should create an instance of RestorationGoalReadAllInner', function() {
      // uncomment below and update the code to test RestorationGoalReadAllInner
      //var instance = new WriRestorationMarketplaceApi.RestorationGoalReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationGoalReadAllInner);
    });
