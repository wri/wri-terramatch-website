...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesUpdate();
  });
  ...
  describe('TreeSpeciesUpdate', function() {
    it('should create an instance of TreeSpeciesUpdate', function() {
      // uncomment below and update the code to test TreeSpeciesUpdate
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesUpdate);
    });
