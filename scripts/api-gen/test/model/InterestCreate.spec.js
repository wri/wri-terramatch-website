...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.InterestCreate();
  });
  ...
  describe('InterestCreate', function() {
    it('should create an instance of InterestCreate', function() {
      // uncomment below and update the code to test InterestCreate
      //var instance = new WriRestorationMarketplaceApi.InterestCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.InterestCreate);
    });
