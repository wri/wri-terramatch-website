...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionReject();
  });
  ...
  describe('CarbonCertificationVersionReject', function() {
    it('should create an instance of CarbonCertificationVersionReject', function() {
      // uncomment below and update the code to test CarbonCertificationVersionReject
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationVersionReject);
    });
