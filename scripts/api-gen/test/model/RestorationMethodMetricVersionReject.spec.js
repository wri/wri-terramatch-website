...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionReject();
  });
  ...
  describe('RestorationMethodMetricVersionReject', function() {
    it('should create an instance of RestorationMethodMetricVersionReject', function() {
      // uncomment below and update the code to test RestorationMethodMetricVersionReject
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionReject);
    });
