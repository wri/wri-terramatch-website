...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricReadAll();
  });
  ...
  describe('RestorationMethodMetricReadAll', function() {
    it('should create an instance of RestorationMethodMetricReadAll', function() {
      // uncomment below and update the code to test RestorationMethodMetricReadAll
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricReadAll);
    });
