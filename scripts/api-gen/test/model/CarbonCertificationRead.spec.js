...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationRead();
  });
  ...
  describe('CarbonCertificationRead', function() {
    it('should create an instance of CarbonCertificationRead', function() {
      // uncomment below and update the code to test CarbonCertificationRead
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationRead);
    });
