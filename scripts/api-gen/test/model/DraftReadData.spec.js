...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftReadData', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftReadData();
      });

      it('should create an instance of DraftReadData', function() {
        // TODO: update the code to test DraftReadData
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftReadData);
      });
