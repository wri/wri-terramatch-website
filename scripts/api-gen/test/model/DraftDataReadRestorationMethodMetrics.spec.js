...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataReadRestorationMethodMetrics', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataReadRestorationMethodMetrics();
      });

      it('should create an instance of DraftDataReadRestorationMethodMetrics', function() {
        // TODO: update the code to test DraftDataReadRestorationMethodMetrics
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataReadRestorationMethodMetrics);
      });

      it('should have the property restoration_method (base name: "restoration_method")', function() {
        // TODO: update the code to test the property restoration_method
        expect(instance).to.have.property('restoration_method');
        // expect(instance.restoration_method).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property price_per_hectare (base name: "price_per_hectare")', function() {
        // TODO: update the code to test the property price_per_hectare
        expect(instance).to.have.property('price_per_hectare');
        // expect(instance.price_per_hectare).to.be(expectedValueLiteral);
      });

      it('should have the property biomass_per_hectare (base name: "biomass_per_hectare")', function() {
        // TODO: update the code to test the property biomass_per_hectare
        expect(instance).to.have.property('biomass_per_hectare');
        // expect(instance.biomass_per_hectare).to.be(expectedValueLiteral);
      });

      it('should have the property carbon_impact (base name: "carbon_impact")', function() {
        // TODO: update the code to test the property carbon_impact
        expect(instance).to.have.property('carbon_impact');
        // expect(instance.carbon_impact).to.be(expectedValueLiteral);
      });

      it('should have the property species_impacted (base name: "species_impacted")', function() {
        // TODO: update the code to test the property species_impacted
        expect(instance).to.have.property('species_impacted');
        // expect(instance.species_impacted).to.be(expectedValueLiteral);
      });
