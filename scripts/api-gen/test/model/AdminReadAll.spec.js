...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminReadAll();
  });
  ...
  describe('AdminReadAll', function() {
    it('should create an instance of AdminReadAll', function() {
      // uncomment below and update the code to test AdminReadAll
      //var instance = new WriRestorationMarketplaceApi.AdminReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AdminReadAll);
    });
