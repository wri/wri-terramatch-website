...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.NotificationReadAll();
  });
  ...
  describe('NotificationReadAll', function() {
    it('should create an instance of NotificationReadAll', function() {
      // uncomment below and update the code to test NotificationReadAll
      //var instance = new WriRestorationMarketplaceApi.NotificationReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.NotificationReadAll);
    });
