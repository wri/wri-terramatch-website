...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferContactReadAll();
  });
  ...
  describe('OfferContactReadAll', function() {
    it('should create an instance of OfferContactReadAll', function() {
      // uncomment below and update the code to test OfferContactReadAll
      //var instance = new WriRestorationMarketplaceApi.OfferContactReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferContactReadAll);
    });
