...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CountryReadAllInner();
  });
  ...
  describe('CountryReadAllInner', function() {
    it('should create an instance of CountryReadAllInner', function() {
      // uncomment below and update the code to test CountryReadAllInner
      //var instance = new WriRestorationMarketplaceApi.CountryReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CountryReadAllInner);
    });
