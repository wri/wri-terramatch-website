...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodReadAll();
  });
  ...
  describe('RestorationMethodReadAll', function() {
    it('should create an instance of RestorationMethodReadAll', function() {
      // uncomment below and update the code to test RestorationMethodReadAll
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodReadAll);
    });
