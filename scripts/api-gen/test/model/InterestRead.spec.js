...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.InterestRead();
  });
  ...
  describe('InterestRead', function() {
    it('should create an instance of InterestRead', function() {
      // uncomment below and update the code to test InterestRead
      //var instance = new WriRestorationMarketplaceApi.InterestRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.InterestRead);
    });
