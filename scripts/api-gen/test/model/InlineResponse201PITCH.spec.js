...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse201PITCH', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.InlineResponse201PITCH();
      });

      it('should create an instance of InlineResponse201PITCH', function() {
        // TODO: update the code to test InlineResponse201PITCH
        expect(instance).to.be.a(WriRestorationMarketplaceApi.InlineResponse201PITCH);
      });
