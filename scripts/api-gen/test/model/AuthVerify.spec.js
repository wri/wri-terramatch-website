...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AuthVerify();
  });
  ...
  describe('AuthVerify', function() {
    it('should create an instance of AuthVerify', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.AuthVerify();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AuthVerify);
    });
