...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationRead();
  });
  ...
  describe('OrganisationRead', function() {
    it('should create an instance of OrganisationRead', function() {
      // uncomment below and update the code to test OrganisationRead
      //var instance = new WriRestorationMarketplaceApi.OrganisationRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationRead);
    });
    ...
    it('should have the property foundedAt (base name: "founded_at")', function() {
      // uncomment below and update the code to test the property foundedAt
      //var instance = new WriRestorationMarketplaceApi.OrganisationRead();
      //expect(instance).to.be();
    });
