...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TeamMemberUpdate();
  });
  ...
  describe('TeamMemberUpdate', function() {
    it('should create an instance of TeamMemberUpdate', function() {
      // uncomment below and update the code to test TeamMemberUpdate
      //var instance = new WriRestorationMarketplaceApi.TeamMemberUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TeamMemberUpdate);
    });
