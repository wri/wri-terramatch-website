...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchVersionRead();
  });
  ...
  describe('PitchVersionRead', function() {
    it('should create an instance of PitchVersionRead', function() {
      // uncomment below and update the code to test PitchVersionRead
      //var instance = new WriRestorationMarketplaceApi.PitchVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchVersionRead);
    });
