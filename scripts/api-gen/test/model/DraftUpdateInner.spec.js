...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftUpdateInner', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftUpdateInner();
      });

      it('should create an instance of DraftUpdateInner', function() {
        // TODO: update the code to test DraftUpdateInner
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftUpdateInner);
      });
