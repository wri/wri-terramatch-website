...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataPitchRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataPitchRead();
      });

      it('should create an instance of DraftDataPitchRead', function() {
        // TODO: update the code to test DraftDataPitchRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataPitchRead);
      });
