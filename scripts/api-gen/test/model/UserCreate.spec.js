...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserCreate();
  });
  ...
  describe('UserCreate', function() {
    it('should create an instance of UserCreate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.UserCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserCreate);
    });
