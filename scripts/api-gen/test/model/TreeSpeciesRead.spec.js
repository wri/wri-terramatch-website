...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesRead();
  });
  ...
  describe('TreeSpeciesRead', function() {
    it('should create an instance of TreeSpeciesRead', function() {
      // uncomment below and update the code to test TreeSpeciesRead
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesRead);
    });
