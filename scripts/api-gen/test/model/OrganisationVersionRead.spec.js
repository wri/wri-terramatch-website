...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationVersionRead();
  });
  ...
  describe('OrganisationVersionRead', function() {
    it('should create an instance of OrganisationVersionRead', function() {
      // uncomment below and update the code to test OrganisationVersionRead
      //var instance = new WriRestorationMarketplaceApi.OrganisationVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionRead);
    });
