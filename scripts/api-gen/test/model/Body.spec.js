...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.Body();
  });
  ...
  describe('Body', function() {
    it('should create an instance of Body', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.Body();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.Body);
    });
