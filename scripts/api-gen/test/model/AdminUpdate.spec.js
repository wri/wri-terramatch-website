...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminUpdate();
  });
  ...
  describe('AdminUpdate', function() {
    it('should create an instance of AdminUpdate', function() {
      // uncomment below and update the code to test AdminUpdate
      //var instance = new WriRestorationMarketplaceApi.AdminUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AdminUpdate);
    });
