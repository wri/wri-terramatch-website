...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentReadAll();
  });
  ...
  describe('OrganisationDocumentReadAll', function() {
    it('should create an instance of OrganisationDocumentReadAll', function() {
      // uncomment below and update the code to test OrganisationDocumentReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentReadAll);
    });
