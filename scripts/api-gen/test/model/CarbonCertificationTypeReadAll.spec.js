...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll();
  });
  ...
  describe('CarbonCertificationTypeReadAll', function() {
    it('should create an instance of CarbonCertificationTypeReadAll', function() {
      // uncomment below and update the code to test CarbonCertificationTypeReadAll
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll);
    });
