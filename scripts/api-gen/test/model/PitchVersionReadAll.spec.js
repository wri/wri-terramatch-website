...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchVersionReadAll();
  });
  ...
  describe('PitchVersionReadAll', function() {
    it('should create an instance of PitchVersionReadAll', function() {
      // uncomment below and update the code to test PitchVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.PitchVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchVersionReadAll);
    });
