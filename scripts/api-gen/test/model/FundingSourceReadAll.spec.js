...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FundingSourceReadAll();
  });
  ...
  describe('FundingSourceReadAll', function() {
    it('should create an instance of FundingSourceReadAll', function() {
      // uncomment below and update the code to test FundingSourceReadAll
      //var instance = new WriRestorationMarketplaceApi.FundingSourceReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FundingSourceReadAll);
    });
