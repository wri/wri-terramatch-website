...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RejectedReasonReadAll();
  });
  ...
  describe('RejectedReasonReadAll', function() {
    it('should create an instance of RejectedReasonReadAll', function() {
      // uncomment below and update the code to test RejectedReasonReadAll
      //var instance = new WriRestorationMarketplaceApi.RejectedReasonReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RejectedReasonReadAll);
    });
