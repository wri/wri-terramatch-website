...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricRead();
  });
  ...
  describe('RestorationMethodMetricRead', function() {
    it('should create an instance of RestorationMethodMetricRead', function() {
      // uncomment below and update the code to test RestorationMethodMetricRead
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricRead);
    });
