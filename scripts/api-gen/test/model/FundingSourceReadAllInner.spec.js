...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.FundingSourceReadAllInner();
  });
  ...
  describe('FundingSourceReadAllInner', function() {
    it('should create an instance of FundingSourceReadAllInner', function() {
      // uncomment below and update the code to test FundingSourceReadAllInner
      //var instance = new WriRestorationMarketplaceApi.FundingSourceReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.FundingSourceReadAllInner);
    });
