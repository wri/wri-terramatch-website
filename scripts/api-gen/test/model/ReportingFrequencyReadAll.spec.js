...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingFrequencyReadAll();
  });
  ...
  describe('ReportingFrequencyReadAll', function() {
    it('should create an instance of ReportingFrequencyReadAll', function() {
      // uncomment below and update the code to test ReportingFrequencyReadAll
      //var instance = new WriRestorationMarketplaceApi.ReportingFrequencyReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ReportingFrequencyReadAll);
    });
