...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationCreate();
  });
  ...
  describe('OrganisationCreate', function() {
    it('should create an instance of OrganisationCreate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.OrganisationCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationCreate);
    });
