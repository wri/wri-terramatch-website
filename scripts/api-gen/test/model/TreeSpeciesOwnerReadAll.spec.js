...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAll();
  });
  ...
  describe('TreeSpeciesOwnerReadAll', function() {
    it('should create an instance of TreeSpeciesOwnerReadAll', function() {
      // uncomment below and update the code to test TreeSpeciesOwnerReadAll
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAll);
    });
