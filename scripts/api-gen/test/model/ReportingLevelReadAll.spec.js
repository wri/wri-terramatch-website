...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingLevelReadAll();
  });
  ...
  describe('ReportingLevelReadAll', function() {
    it('should create an instance of ReportingLevelReadAll', function() {
      // uncomment below and update the code to test ReportingLevelReadAll
      //var instance = new WriRestorationMarketplaceApi.ReportingLevelReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ReportingLevelReadAll);
    });
