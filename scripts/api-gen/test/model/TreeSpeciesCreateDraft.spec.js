...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TreeSpeciesCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.TreeSpeciesCreateDraft();
      });

      it('should create an instance of TreeSpeciesCreateDraft', function() {
        // TODO: update the code to test TreeSpeciesCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesCreateDraft);
      });
