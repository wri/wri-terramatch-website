...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationGoalReadAll();
  });
  ...
  describe('RestorationGoalReadAll', function() {
    it('should create an instance of RestorationGoalReadAll', function() {
      // uncomment below and update the code to test RestorationGoalReadAll
      //var instance = new WriRestorationMarketplaceApi.RestorationGoalReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationGoalReadAll);
    });
