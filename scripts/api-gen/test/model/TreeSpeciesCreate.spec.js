...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
  });
  ...
  describe('TreeSpeciesCreate', function() {
    it('should create an instance of TreeSpeciesCreate', function() {
      // uncomment below and update the code to test TreeSpeciesCreate
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesCreate);
    });
    ...
    it('should have the property isNative (base name: "is_native")', function() {
      // uncomment below and update the code to test the property isNative
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property priceToPlant (base name: "price_to_plant")', function() {
      // uncomment below and update the code to test the property priceToPlant
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property priceToMaintain (base name: "price_to_maintain")', function() {
      // uncomment below and update the code to test the property priceToMaintain
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property saplings (base name: "saplings")', function() {
      // uncomment below and update the code to test the property saplings
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property sitePrep (base name: "site_prep")', function() {
      // uncomment below and update the code to test the property sitePrep
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property survivalRate (base name: "survival_rate")', function() {
      // uncomment below and update the code to test the property survivalRate
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property producesFood (base name: "produces_food")', function() {
      // uncomment below and update the code to test the property producesFood
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property producesFirewood (base name: "produces_firewood")', function() {
      // uncomment below and update the code to test the property producesFirewood
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });

    it('should have the property producesTimber (base name: "produces_timber")', function() {
      // uncomment below and update the code to test the property producesTimber
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesCreate();
      //expect(instance).to.be();
    });
