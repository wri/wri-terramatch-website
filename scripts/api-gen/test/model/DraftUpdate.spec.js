...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftUpdate', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftUpdate();
      });

      it('should create an instance of DraftUpdate', function() {
        // TODO: update the code to test DraftUpdate
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftUpdate);
      });
