...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferDocumentCreate();
  });
  ...
  describe('OfferDocumentCreate', function() {
    it('should create an instance of OfferDocumentCreate', function() {
      // uncomment below and update the code to test OfferDocumentCreate
      //var instance = new WriRestorationMarketplaceApi.OfferDocumentCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferDocumentCreate);
    });
