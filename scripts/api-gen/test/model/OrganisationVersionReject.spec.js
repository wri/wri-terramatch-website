...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationVersionReject();
  });
  ...
  describe('OrganisationVersionReject', function() {
    it('should create an instance of OrganisationVersionReject', function() {
      // uncomment below and update the code to test OrganisationVersionReject
      //var instance = new WriRestorationMarketplaceApi.OrganisationVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationVersionReject);
    });
