...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserRead();
  });
  ...
  describe('UserRead', function() {
    it('should create an instance of UserRead', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.UserRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserRead);
    });
