...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchVersionReject();
  });
  ...
  describe('PitchVersionReject', function() {
    it('should create an instance of PitchVersionReject', function() {
      // uncomment below and update the code to test PitchVersionReject
      //var instance = new WriRestorationMarketplaceApi.PitchVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchVersionReject);
    });
