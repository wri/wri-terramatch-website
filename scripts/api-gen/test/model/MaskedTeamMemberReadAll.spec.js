...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaskedTeamMemberReadAll', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.MaskedTeamMemberReadAll();
      });

      it('should create an instance of MaskedTeamMemberReadAll', function() {
        // TODO: update the code to test MaskedTeamMemberReadAll
        expect(instance).to.be.a(WriRestorationMarketplaceApi.MaskedTeamMemberReadAll);
      });
