...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaskedUserReadAll', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.MaskedUserReadAll();
      });

      it('should create an instance of MaskedUserReadAll', function() {
        // TODO: update the code to test MaskedUserReadAll
        expect(instance).to.be.a(WriRestorationMarketplaceApi.MaskedUserReadAll);
      });
