...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftCreate', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftCreate();
      });

      it('should create an instance of DraftCreate', function() {
        // TODO: update the code to test DraftCreate
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftCreate);
      });
