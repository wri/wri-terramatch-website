...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.ReportingFrequencyReadAllInner();
  });
  ...
  describe('ReportingFrequencyReadAllInner', function() {
    it('should create an instance of ReportingFrequencyReadAllInner', function() {
      // uncomment below and update the code to test ReportingFrequencyReadAllInner
      //var instance = new WriRestorationMarketplaceApi.ReportingFrequencyReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.ReportingFrequencyReadAllInner);
    });
