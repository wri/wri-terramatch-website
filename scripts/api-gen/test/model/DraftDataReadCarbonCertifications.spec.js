...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataReadCarbonCertifications', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataReadCarbonCertifications();
      });

      it('should create an instance of DraftDataReadCarbonCertifications', function() {
        // TODO: update the code to test DraftDataReadCarbonCertifications
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataReadCarbonCertifications);
      });
      ...
      it('should have the property other_value (base name: "other_value")', function() {
        // TODO: update the code to test the property other_value
        expect(instance).to.have.property('other_value');
        // expect(instance.other_value).to.be(expectedValueLiteral);
      });
