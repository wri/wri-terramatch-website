...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchDocumentVersionReject();
  });
  ...
  describe('PitchDocumentVersionReject', function() {
    it('should create an instance of PitchDocumentVersionReject', function() {
      // uncomment below and update the code to test PitchDocumentVersionReject
      //var instance = new WriRestorationMarketplaceApi.PitchDocumentVersionReject();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchDocumentVersionReject);
    });
