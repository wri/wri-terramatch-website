...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataOfferReadOffer', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataOfferReadOffer();
      });

      it('should create an instance of DraftDataOfferReadOffer', function() {
        // TODO: update the code to test DraftDataOfferReadOffer
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataOfferReadOffer);
      });
