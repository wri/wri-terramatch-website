...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataReadOfferDocuments', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataReadOfferDocuments();
      });

      it('should create an instance of DraftDataReadOfferDocuments', function() {
        // TODO: update the code to test DraftDataReadOfferDocuments
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataReadOfferDocuments);
      });
