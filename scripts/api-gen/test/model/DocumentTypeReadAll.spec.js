...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.DocumentTypeReadAll();
  });
  ...
  describe('DocumentTypeReadAll', function() {
    it('should create an instance of DocumentTypeReadAll', function() {
      // uncomment below and update the code to test DocumentTypeReadAll
      //var instance = new WriRestorationMarketplaceApi.DocumentTypeReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.DocumentTypeReadAll);
    });
