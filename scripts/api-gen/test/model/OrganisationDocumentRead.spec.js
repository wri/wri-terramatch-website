...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationDocumentRead();
  });
  ...
  describe('OrganisationDocumentRead', function() {
    it('should create an instance of OrganisationDocumentRead', function() {
      // uncomment below and update the code to test OrganisationDocumentRead
      //var instance = new WriRestorationMarketplaceApi.OrganisationDocumentRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationDocumentRead);
    });
