...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead();
  });
  ...
  describe('RestorationMethodMetricVersionRead', function() {
    it('should create an instance of RestorationMethodMetricVersionRead', function() {
      // uncomment below and update the code to test RestorationMethodMetricVersionRead
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead);
    });
    ...
    it('should have the property rejectedReasonBody (base name: "rejected_reason_body")', function() {
      // uncomment below and update the code to test the property rejectedReasonBody
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead();
      //expect(instance).to.be();
    });

    it('should have the property approvedRejectedBy (base name: "approved_rejected_by")', function() {
      // uncomment below and update the code to test the property approvedRejectedBy
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead();
      //expect(instance).to.be();
    });

    it('should have the property approvedRejectedAt (base name: "approved_rejected_at")', function() {
      // uncomment below and update the code to test the property approvedRejectedAt
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead();
      //expect(instance).to.be();
    });
