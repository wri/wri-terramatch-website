...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PitchByContinentReadAll', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.PitchByContinentReadAll();
      });

      it('should create an instance of PitchByContinentReadAll', function() {
        // TODO: update the code to test PitchByContinentReadAll
        expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchByContinentReadAll);
      });
