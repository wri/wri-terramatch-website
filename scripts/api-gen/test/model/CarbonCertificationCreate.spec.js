...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.CarbonCertificationCreate();
  });
  ...
  describe('CarbonCertificationCreate', function() {
    it('should create an instance of CarbonCertificationCreate', function() {
      // uncomment below and update the code to test CarbonCertificationCreate
      //var instance = new WriRestorationMarketplaceApi.CarbonCertificationCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationCreate);
    });
