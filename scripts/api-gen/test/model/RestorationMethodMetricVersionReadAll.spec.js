...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionReadAll();
  });
  ...
  describe('RestorationMethodMetricVersionReadAll', function() {
    it('should create an instance of RestorationMethodMetricVersionReadAll', function() {
      // uncomment below and update the code to test RestorationMethodMetricVersionReadAll
      //var instance = new WriRestorationMarketplaceApi.RestorationMethodMetricVersionReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.RestorationMethodMetricVersionReadAll);
    });
