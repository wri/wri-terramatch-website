...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminAccept();
  });
  ...
  describe('AdminAccept', function() {
    it('should create an instance of AdminAccept', function() {
      // uncomment below and update the code to test AdminAccept
      //var instance = new WriRestorationMarketplaceApi.AdminAccept();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AdminAccept);
    });
