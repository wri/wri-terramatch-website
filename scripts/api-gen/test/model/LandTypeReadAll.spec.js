...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.LandTypeReadAll();
  });
  ...
  describe('LandTypeReadAll', function() {
    it('should create an instance of LandTypeReadAll', function() {
      // uncomment below and update the code to test LandTypeReadAll
      //var instance = new WriRestorationMarketplaceApi.LandTypeReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.LandTypeReadAll);
    });
