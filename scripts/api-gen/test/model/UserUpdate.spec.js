...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserUpdate();
  });
  ...
  describe('UserUpdate', function() {
    it('should create an instance of UserUpdate', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.UserUpdate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserUpdate);
    });
