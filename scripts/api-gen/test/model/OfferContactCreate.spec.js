...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OfferContactCreate();
  });
  ...
  describe('OfferContactCreate', function() {
    it('should create an instance of OfferContactCreate', function() {
      // uncomment below and update the code to test OfferContactCreate
      //var instance = new WriRestorationMarketplaceApi.OfferContactCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OfferContactCreate);
    });
