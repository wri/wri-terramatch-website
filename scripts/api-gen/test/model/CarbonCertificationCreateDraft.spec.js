...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarbonCertificationCreateDraft', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.CarbonCertificationCreateDraft();
      });

      it('should create an instance of CarbonCertificationCreateDraft', function() {
        // TODO: update the code to test CarbonCertificationCreateDraft
        expect(instance).to.be.a(WriRestorationMarketplaceApi.CarbonCertificationCreateDraft);
      });
