...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.MatchRead();
  });
  ...
  describe('MatchRead', function() {
    it('should create an instance of MatchRead', function() {
      // uncomment below and update the code to test MatchRead
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.MatchRead);
    });
    ...
    it('should have the property offerInterestId (base name: "offer_interest_id")', function() {
      // uncomment below and update the code to test the property offerInterestId
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be();
    });

    it('should have the property offerContacts (base name: "offer_contacts")', function() {
      // uncomment below and update the code to test the property offerContacts
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pitchInterestId (base name: "pitch_interest_id")', function() {
      // uncomment below and update the code to test the property pitchInterestId
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be();
    });

    it('should have the property pitchContacts (base name: "pitch_contacts")', function() {
      // uncomment below and update the code to test the property pitchContacts
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be();
    });

    it('should have the property matchedAt (base name: "matched_at")', function() {
      // uncomment below and update the code to test the property matchedAt
      //var instance = new WriRestorationMarketplaceApi.MatchRead();
      //expect(instance).to.be();
    });
