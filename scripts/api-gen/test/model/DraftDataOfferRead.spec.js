...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataOfferRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataOfferRead();
      });

      it('should create an instance of DraftDataOfferRead', function() {
        // TODO: update the code to test DraftDataOfferRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataOfferRead);
      });
