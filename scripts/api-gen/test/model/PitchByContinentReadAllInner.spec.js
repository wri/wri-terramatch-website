...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PitchByContinentReadAllInner', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.PitchByContinentReadAllInner();
      });

      it('should create an instance of PitchByContinentReadAllInner', function() {
        // TODO: update the code to test PitchByContinentReadAllInner
        expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchByContinentReadAllInner);
      });
