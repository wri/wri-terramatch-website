...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AuthChange();
  });
  ...
  describe('AuthChange', function() {
    it('should create an instance of AuthChange', function() {
      // uncomment below and update the code to test AuthChange
      //var instance = new WriRestorationMarketplaceApi.AuthChange();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AuthChange);
    });
