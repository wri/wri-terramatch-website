...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchContactCreate();
  });
  ...
  describe('PitchContactCreate', function() {
    it('should create an instance of PitchContactCreate', function() {
      // uncomment below and update the code to test PitchContactCreate
      //var instance = new WriRestorationMarketplaceApi.PitchContactCreate();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchContactCreate);
    });
