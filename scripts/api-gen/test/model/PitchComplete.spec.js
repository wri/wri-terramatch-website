...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.PitchComplete();
  });
  ...
  describe('PitchComplete', function() {
    it('should create an instance of PitchComplete', function() {
      // uncomment below and update the code to test PitchComplete
      //var instance = new WriRestorationMarketplaceApi.PitchComplete();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.PitchComplete);
    });
