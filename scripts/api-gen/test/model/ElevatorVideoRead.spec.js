...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ElevatorVideoRead', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.ElevatorVideoRead();
      });

      it('should create an instance of ElevatorVideoRead', function() {
        // TODO: update the code to test ElevatorVideoRead
        expect(instance).to.be.a(WriRestorationMarketplaceApi.ElevatorVideoRead);
      });
      ...
      it('should have the property upload_id (base name: "upload_id")', function() {
        // TODO: update the code to test the property upload_id
        expect(instance).to.have.property('upload_id');
        // expect(instance.upload_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property uploaded_at (base name: "uploaded_at")', function() {
        // TODO: update the code to test the property uploaded_at
        expect(instance).to.have.property('uploaded_at');
        // expect(instance.uploaded_at).to.be(expectedValueLiteral);
      });
