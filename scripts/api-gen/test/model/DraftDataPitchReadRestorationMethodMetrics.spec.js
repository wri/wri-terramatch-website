...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftDataPitchReadRestorationMethodMetrics', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.DraftDataPitchReadRestorationMethodMetrics();
      });

      it('should create an instance of DraftDataPitchReadRestorationMethodMetrics', function() {
        // TODO: update the code to test DraftDataPitchReadRestorationMethodMetrics
        expect(instance).to.be.a(WriRestorationMarketplaceApi.DraftDataPitchReadRestorationMethodMetrics);
      });
