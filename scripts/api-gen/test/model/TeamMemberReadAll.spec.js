...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TeamMemberReadAll();
  });
  ...
  describe('TeamMemberReadAll', function() {
    it('should create an instance of TeamMemberReadAll', function() {
      // uncomment below and update the code to test TeamMemberReadAll
      //var instance = new WriRestorationMarketplaceApi.TeamMemberReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TeamMemberReadAll);
    });
