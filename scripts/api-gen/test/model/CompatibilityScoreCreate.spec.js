...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompatibilityScoreCreate', function() {
      beforeEach(function() {
        instance = new WriRestorationMarketplaceApi.CompatibilityScoreCreate();
      });

      it('should create an instance of CompatibilityScoreCreate', function() {
        // TODO: update the code to test CompatibilityScoreCreate
        expect(instance).to.be.a(WriRestorationMarketplaceApi.CompatibilityScoreCreate);
      });
