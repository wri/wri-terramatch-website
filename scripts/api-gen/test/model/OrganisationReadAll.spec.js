...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationReadAll();
  });
  ...
  describe('OrganisationReadAll', function() {
    it('should create an instance of OrganisationReadAll', function() {
      // uncomment below and update the code to test OrganisationReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationReadAll);
    });
