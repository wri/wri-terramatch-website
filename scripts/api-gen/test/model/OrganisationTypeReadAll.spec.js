...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.OrganisationTypeReadAll();
  });
  ...
  describe('OrganisationTypeReadAll', function() {
    it('should create an instance of OrganisationTypeReadAll', function() {
      // uncomment below and update the code to test OrganisationTypeReadAll
      //var instance = new WriRestorationMarketplaceApi.OrganisationTypeReadAll();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.OrganisationTypeReadAll);
    });
