...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.UserInvite();
  });
  ...
  describe('UserInvite', function() {
    it('should create an instance of UserInvite', function() {
      ...
      //var instance = new WriRestorationMarketplaceApi.UserInvite();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.UserInvite);
    });
