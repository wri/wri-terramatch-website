...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAllInner();
  });
  ...
  describe('TreeSpeciesOwnerReadAllInner', function() {
    it('should create an instance of TreeSpeciesOwnerReadAllInner', function() {
      // uncomment below and update the code to test TreeSpeciesOwnerReadAllInner
      //var instance = new WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAllInner();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAllInner);
    });
