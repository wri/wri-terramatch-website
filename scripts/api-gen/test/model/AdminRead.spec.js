...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WriRestorationMarketplaceApi.AdminRead();
  });
  ...
  describe('AdminRead', function() {
    it('should create an instance of AdminRead', function() {
      // uncomment below and update the code to test AdminRead
      //var instance = new WriRestorationMarketplaceApi.AdminRead();
      //expect(instance).to.be.a(WriRestorationMarketplaceApi.AdminRead);
    });
    ...
    it('should have the property emailAddressVerifiedAt (base name: "email_address_verified_at")', function() {
      // uncomment below and update the code to test the property emailAddressVerifiedAt
      //var instance = new WriRestorationMarketplaceApi.AdminRead();
      //expect(instance).to.be();
    });
