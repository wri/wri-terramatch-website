...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/VisibilityReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/VisibilityReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.VisibilitiesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.VisibilityReadAll);
  }
}(this, function(ApiClient, VisibilityReadAll) {
  'use strict';

  /**
   * Visibilities service.
   * @module api/VisibilitiesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new VisibilitiesApi. 
   * @alias module:api/VisibilitiesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the visibilitiesGet operation.
     * @callback module:api/VisibilitiesApi~visibilitiesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VisibilityReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all visibilities
     * @param {module:api/VisibilitiesApi~visibilitiesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VisibilityReadAll}
     */
    this.visibilitiesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = VisibilityReadAll;
