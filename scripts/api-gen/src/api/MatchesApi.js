...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MatchRead', '../model/MatchReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/MatchRead'), require('../model/MatchReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.MatchesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MatchRead, root.WriRestorationMarketplaceApi.MatchReadAll);
  }
}(this, function(ApiClient, MatchRead, MatchReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MatchesApi~matchesGetCallback
    ...
    /**
     * Read all matches
     * @param {module:api/MatchesApi~matchesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MatchReadAll}
     */
    this.matchesGet = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the matchesIDGet operation.
     * @callback module:api/MatchesApi~matchesIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MatchRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Read a match
     * @param {Number} ID 
     * @param {module:api/MatchesApi~matchesIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MatchRead}
     */
    this.matchesIDGet = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling matchesIDGet");
      }
