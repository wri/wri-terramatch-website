...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RevenueDriverReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RevenueDriverReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RevenueDriversApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RevenueDriverReadAll);
  }
}(this, function(ApiClient, RevenueDriverReadAll) {
  'use strict';

  /**
   * RevenueDrivers service.
   * @module api/RevenueDriversApi
   * @version 1.0.0
   */

  /**
   * Constructs a new RevenueDriversApi. 
   * @alias module:api/RevenueDriversApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the revenueDriversGet operation.
     * @callback module:api/RevenueDriversApi~revenueDriversGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RevenueDriverReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all revenue drivers
     * @param {module:api/RevenueDriversApi~revenueDriversGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RevenueDriverReadAll}
     */
    this.revenueDriversGet = function(callback) {
      var postBody = null;
      ...
      var returnType = RevenueDriverReadAll;
