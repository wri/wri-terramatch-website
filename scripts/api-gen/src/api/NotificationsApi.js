...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/NotificationRead', '../model/NotificationReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/NotificationRead'), require('../model/NotificationReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.NotificationsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.NotificationRead, root.WriRestorationMarketplaceApi.NotificationReadAll);
  }
}(this, function(ApiClient, NotificationRead, NotificationReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/NotificationReadAll} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/NotificationReadAll}
     */
    this.notificationsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = NotificationReadAll;
    ...
    /**
     * Callback function to receive the result of the notificationsIDMarkPatch operation.
     * @callback module:api/NotificationsApi~notificationsIDMarkPatchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/NotificationsApi~notificationsIDMarkPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NotificationRead}
     */
    this.notificationsIDMarkPatch = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling notificationsIDMarkPatch");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = NotificationRead;

      return this.apiClient.callApi(
        '/notifications/{ID}/mark', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
