...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ReportingFrequencyReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ReportingFrequencyReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ReportingFrequenciesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ReportingFrequencyReadAll);
  }
}(this, function(ApiClient, ReportingFrequencyReadAll) {
  'use strict';

  /**
   * ReportingFrequencies service.
   * @module api/ReportingFrequenciesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ReportingFrequenciesApi. 
   * @alias module:api/ReportingFrequenciesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the reportingFrequenciesGet operation.
     * @callback module:api/ReportingFrequenciesApi~reportingFrequenciesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportingFrequencyReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all reporting frequencies
     * @param {module:api/ReportingFrequenciesApi~reportingFrequenciesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportingFrequencyReadAll}
     */
    this.reportingFrequenciesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = ReportingFrequencyReadAll;

      return this.apiClient.callApi(
        '/reporting_frequencies', 'GET',
