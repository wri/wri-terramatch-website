...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/InterestCreate', '../model/InterestRead', '../model/InterestReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/InterestCreate'), require('../model/InterestRead'), require('../model/InterestReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.InterestsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.InterestCreate, root.WriRestorationMarketplaceApi.InterestRead, root.WriRestorationMarketplaceApi.InterestReadAll);
  }
}(this, function(ApiClient, Empty, InterestCreate, InterestRead, InterestReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the interestsIDDelete operation.
     * @callback module:api/InterestsApi~interestsIDDeleteCallback
     ...
     * Delete an interest
     * @param {Number} ID 
     * @param {module:api/InterestsApi~interestsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.interestsIDDelete = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling interestsIDDelete");
      }
    ...
    /**
     * Callback function to receive the result of the interestsInitiatedGet operation.
     * @callback module:api/InterestsApi~interestsInitiatedGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InterestReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all interests initiated
     * @param {module:api/InterestsApi~interestsInitiatedGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InterestReadAll}
     */
    this.interestsInitiatedGet = function(callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = InterestReadAll;

      return this.apiClient.callApi(
        '/interests/initiated', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the interestsPost operation.
     * @callback module:api/InterestsApi~interestsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InterestRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Create an interest
     * @param {module:model/InterestCreate} body 
     * @param {module:api/InterestsApi~interestsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InterestRead}
     */
    this.interestsPost = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling interestsPost");
      }
    ...
    /**
     * Callback function to receive the result of the interestsReceivedGet operation.
     * @callback module:api/InterestsApi~interestsReceivedGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InterestReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InterestsApi~interestsReceivedGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InterestReadAll}
     */
    this.interestsReceivedGet = function(callback) {
      var postBody = null;
