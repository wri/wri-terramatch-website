...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DeviceCreate', '../model/DeviceRead', '../model/DeviceReadAll', '../model/DeviceUpdate', '../model/Empty'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeviceCreate'), require('../model/DeviceRead'), require('../model/DeviceReadAll'), require('../model/DeviceUpdate'), require('../model/Empty'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DevicesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DeviceCreate, root.WriRestorationMarketplaceApi.DeviceRead, root.WriRestorationMarketplaceApi.DeviceReadAll, root.WriRestorationMarketplaceApi.DeviceUpdate, root.WriRestorationMarketplaceApi.Empty);
  }
}(this, function(ApiClient, DeviceCreate, DeviceRead, DeviceReadAll, DeviceUpdate, Empty) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/DeviceReadAll} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/DeviceReadAll}
     */
    this.devicesGet = function(callback) {
      var postBody = null;
     ...
     * @callback module:api/DevicesApi~devicesIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeviceRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Read a device
     * @param {Number} ID 
     * @param {module:api/DevicesApi~devicesIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeviceRead}
     */
    this.devicesIDGet = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the devicesIDPatch operation.
     * @callback module:api/DevicesApi~devicesIDPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeviceRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update a device
     * @param {Number} ID 
     * @param {module:model/DeviceUpdate} body 
     * @param {module:api/DevicesApi~devicesIDPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeviceRead}
     */
    this.devicesIDPatch = function(ID, body, callback) {
      var postBody = body;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling devicesIDPatch");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling devicesIDPatch");
      }
    ...
    /**
     * Create a device
     * @param {module:model/DeviceCreate} body 
