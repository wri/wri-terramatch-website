...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/OfferContactCreate', '../model/OfferContactRead', '../model/OfferContactReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/OfferContactCreate'), require('../model/OfferContactRead'), require('../model/OfferContactReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OfferContactsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.OfferContactCreate, root.WriRestorationMarketplaceApi.OfferContactRead, root.WriRestorationMarketplaceApi.OfferContactReadAll);
  }
}(this, function(ApiClient, Empty, OfferContactCreate, OfferContactRead, OfferContactReadAll) {
  'use strict';

  /**
   * OfferContacts service.
   * @module api/OfferContactsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new OfferContactsApi. 
   * @alias module:api/OfferContactsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the offerContactsIDDelete operation.
     * @callback module:api/OfferContactsApi~offerContactsIDDeleteCallback
     ...
     * @param {Number} ID 
     * @param {module:api/OfferContactsApi~offerContactsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.offerContactsIDDelete = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling offerContactsIDDelete");
      }
    ...
    /**
     * Callback function to receive the result of the offerContactsPost operation.
     * @callback module:api/OfferContactsApi~offerContactsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferContactRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Create an offer contact
     * @param {module:model/OfferContactCreate} body 
     * @param {module:api/OfferContactsApi~offerContactsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferContactRead}
     */
    this.offerContactsPost = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling offerContactsPost");
      }
      ...
      var accepts = ['application/json'];
      var returnType = OfferContactRead;
    ...
    /**
     * Callback function to receive the result of the offersIDOfferContactsGet operation.
     * @callback module:api/OfferContactsApi~offersIDOfferContactsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferContactReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/OfferContactsApi~offersIDOfferContactsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferContactReadAll}
     */
    this.offersIDOfferContactsGet = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling offersIDOfferContactsGet");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = OfferContactReadAll;

      return this.apiClient.callApi(
        '/offers/{ID}/offer_contacts', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
