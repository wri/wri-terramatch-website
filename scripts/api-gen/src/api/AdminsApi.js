...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AdminAccept', '../model/AdminInvite', '../model/AdminRead', '../model/AdminReadAll', '../model/AdminUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AdminAccept'), require('../model/AdminInvite'), require('../model/AdminRead'), require('../model/AdminReadAll'), require('../model/AdminUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.AdminsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.AdminAccept, root.WriRestorationMarketplaceApi.AdminInvite, root.WriRestorationMarketplaceApi.AdminRead, root.WriRestorationMarketplaceApi.AdminReadAll, root.WriRestorationMarketplaceApi.AdminUpdate);
  }
}(this, function(ApiClient, AdminAccept, AdminInvite, AdminRead, AdminReadAll, AdminUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the adminsAcceptPost operation.
     * @callback module:api/AdminsApi~adminsAcceptPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AdminRead} data The data returned by the service call.
     ...
     * @param {module:api/AdminsApi~adminsAcceptPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AdminRead}
     */
    this.adminsAcceptPost = function(body, callback) {
      var postBody = body;
     ...
     * @callback module:api/AdminsApi~adminsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AdminReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/AdminReadAll}
     */
    this.adminsGet = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the adminsIDGet operation.
     * @callback module:api/AdminsApi~adminsIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AdminRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Read an admin
     * @param {Number} ID 
     * @param {module:api/AdminsApi~adminsIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AdminRead}
     */
    this.adminsIDGet = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the adminsIDPatch operation.
     * @callback module:api/AdminsApi~adminsIDPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AdminRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AdminsApi~adminsIDPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AdminRead}
     */
    this.adminsIDPatch = function(ID, body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the adminsInvitePost operation.
     * @callback module:api/AdminsApi~adminsInvitePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AdminRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AdminsApi~adminsInvitePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AdminRead}
     */
    this.adminsInvitePost = function(body, callback) {
      var postBody = body;
