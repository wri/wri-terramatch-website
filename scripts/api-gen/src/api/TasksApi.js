...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MatchReadAll', '../model/OrganisationReadAll', '../model/PitchReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/MatchReadAll'), require('../model/OrganisationReadAll'), require('../model/PitchReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TasksApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MatchReadAll, root.WriRestorationMarketplaceApi.OrganisationReadAll, root.WriRestorationMarketplaceApi.PitchReadAll);
  }
}(this, function(ApiClient, MatchReadAll, OrganisationReadAll, PitchReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the tasksMatchesGet operation.
     * @callback module:api/TasksApi~tasksMatchesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MatchReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all matches
     * @param {module:api/TasksApi~tasksMatchesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MatchReadAll}
     */
    this.tasksMatchesGet = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the tasksOrganisationsGet operation.
     * @callback module:api/TasksApi~tasksOrganisationsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TasksApi~tasksOrganisationsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationReadAll}
     */
    this.tasksOrganisationsGet = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the tasksPitchesGet operation.
     * @callback module:api/TasksApi~tasksPitchesGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TasksApi~tasksPitchesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchReadAll}
     */
    this.tasksPitchesGet = function(callback) {
      var postBody = null;
