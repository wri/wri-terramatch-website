...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DocumentTypeReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DocumentTypeReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DocumentTypesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DocumentTypeReadAll);
  }
}(this, function(ApiClient, DocumentTypeReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the documentTypesGet operation.
     * @callback module:api/DocumentTypesApi~documentTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DocumentTypeReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all document types
     * @param {module:api/DocumentTypesApi~documentTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentTypeReadAll}
     */
    this.documentTypesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = DocumentTypeReadAll;
