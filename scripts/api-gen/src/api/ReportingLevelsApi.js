...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ReportingLevelReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ReportingLevelReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ReportingLevelsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ReportingLevelReadAll);
  }
}(this, function(ApiClient, ReportingLevelReadAll) {
  'use strict';

  /**
   * ReportingLevels service.
   * @module api/ReportingLevelsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ReportingLevelsApi. 
   * @alias module:api/ReportingLevelsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the reportingLevelsGet operation.
     * @callback module:api/ReportingLevelsApi~reportingLevelsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportingLevelReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all reporting levels
     * @param {module:api/ReportingLevelsApi~reportingLevelsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportingLevelReadAll}
     */
    this.reportingLevelsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = ReportingLevelReadAll;

      return this.apiClient.callApi(
        '/reporting_levels', 'GET',
