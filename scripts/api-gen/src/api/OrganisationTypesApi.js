...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationTypeReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/OrganisationTypeReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationTypesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationTypeReadAll);
  }
}(this, function(ApiClient, OrganisationTypeReadAll) {
  'use strict';

  /**
   * OrganisationTypes service.
   * @module api/OrganisationTypesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new OrganisationTypesApi. 
   * @alias module:api/OrganisationTypesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the organisationTypesGet operation.
     * @callback module:api/OrganisationTypesApi~organisationTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrganisationTypeReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all organisation types
     * @param {module:api/OrganisationTypesApi~organisationTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationTypeReadAll}
     */
    this.organisationTypesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = OrganisationTypeReadAll;

      return this.apiClient.callApi(
        '/organisation_types', 'GET',
