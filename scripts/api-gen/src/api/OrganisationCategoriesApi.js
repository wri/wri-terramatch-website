...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationCategoryReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/OrganisationCategoryReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationCategoriesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationCategoryReadAll);
  }
}(this, function(ApiClient, OrganisationCategoryReadAll) {
  'use strict';

  /**
   * OrganisationCategories service.
   * @module api/OrganisationCategoriesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new OrganisationCategoriesApi. 
   * @alias module:api/OrganisationCategoriesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the organisationCategoriesGet operation.
     * @callback module:api/OrganisationCategoriesApi~organisationCategoriesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrganisationCategoryReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all organisation categories
     * @param {module:api/OrganisationCategoriesApi~organisationCategoriesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationCategoryReadAll}
     */
    this.organisationCategoriesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = OrganisationCategoryReadAll;

      return this.apiClient.callApi(
        '/organisation_categories', 'GET',
