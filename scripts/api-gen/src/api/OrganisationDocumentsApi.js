...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/OrganisationDocumentCreate', '../model/OrganisationDocumentRead', '../model/OrganisationDocumentReadAll', '../model/OrganisationDocumentUpdate', '../model/OrganisationDocumentVersionRead', '../model/OrganisationDocumentVersionReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/OrganisationDocumentCreate'), require('../model/OrganisationDocumentRead'), require('../model/OrganisationDocumentReadAll'), require('../model/OrganisationDocumentUpdate'), require('../model/OrganisationDocumentVersionRead'), require('../model/OrganisationDocumentVersionReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationDocumentsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.OrganisationDocumentCreate, root.WriRestorationMarketplaceApi.OrganisationDocumentRead, root.WriRestorationMarketplaceApi.OrganisationDocumentReadAll, root.WriRestorationMarketplaceApi.OrganisationDocumentUpdate, root.WriRestorationMarketplaceApi.OrganisationDocumentVersionRead, root.WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll);
  }
}(this, function(ApiClient, Empty, OrganisationDocumentCreate, OrganisationDocumentRead, OrganisationDocumentReadAll, OrganisationDocumentUpdate, OrganisationDocumentVersionRead, OrganisationDocumentVersionReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the organisationDocumentsIDDelete operation.
     * @callback module:api/OrganisationDocumentsApi~organisationDocumentsIDDeleteCallback
     ...
     * @param {Number} ID 
     * @param {module:api/OrganisationDocumentsApi~organisationDocumentsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.organisationDocumentsIDDelete = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the organisationDocumentsIDGet operation.
     * @callback module:api/OrganisationDocumentsApi~organisationDocumentsIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrganisationDocumentRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/OrganisationDocumentsApi~organisationDocumentsIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationDocumentRead}
     */
    this.organisationDocumentsIDGet = function(ID, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = OrganisationDocumentRead;
    ...
    /**
     * Callback function to receive the result of the organisationDocumentsIDPatch operation.
     * @callback module:api/OrganisationDocumentsApi~organisationDocumentsIDPatchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrganisationDocumentsApi~organisationDocumentsIDPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationDocumentVersionRead}
     */
    this.organisationDocumentsIDPatch = function(ID, body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the organisationDocumentsPost operation.
     * @callback module:api/OrganisationDocumentsApi~organisationDocumentsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrganisationDocumentVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/OrganisationDocumentsApi~organisationDocumentsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationDocumentVersionRead}
     */
    this.organisationDocumentsPost = function(body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the organisationsIDOrganisationDocumentsGet operation.
     * @callback module:api/OrganisationDocumentsApi~organisationsIDOrganisationDocumentsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrganisationDocumentReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/OrganisationDocumentsApi~organisationsIDOrganisationDocumentsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationDocumentReadAll}
     */
    this.organisationsIDOrganisationDocumentsGet = function(ID, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = OrganisationDocumentReadAll;
    ...
    /**
     * Callback function to receive the result of the organisationsIDOrganisationDocumentsInspectGet operation.
     * @callback module:api/OrganisationDocumentsApi~organisationsIDOrganisationDocumentsInspectGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/OrganisationDocumentsApi~organisationsIDOrganisationDocumentsInspectGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrganisationDocumentVersionReadAll}
     */
    this.organisationsIDOrganisationDocumentsInspectGet = function(ID, callback) {
      var postBody = null;
