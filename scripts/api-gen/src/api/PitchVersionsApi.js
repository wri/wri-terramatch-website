...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/PitchVersionRead', '../model/PitchVersionReadAll', '../model/PitchVersionReject'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/PitchVersionRead'), require('../model/PitchVersionReadAll'), require('../model/PitchVersionReject'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchVersionsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.PitchVersionRead, root.WriRestorationMarketplaceApi.PitchVersionReadAll, root.WriRestorationMarketplaceApi.PitchVersionReject);
  }
}(this, function(ApiClient, Empty, PitchVersionRead, PitchVersionReadAll, PitchVersionReject) {
  'use strict';

  /**
   * PitchVersions service.
   * @module api/PitchVersionsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new PitchVersionsApi. 
   * @alias module:api/PitchVersionsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the pitchVersionsIDApprovePatch operation.
     * @callback module:api/PitchVersionsApi~pitchVersionsIDApprovePatchCallback
     ...
     * @param {Number} ID 
     * @param {module:api/PitchVersionsApi~pitchVersionsIDApprovePatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchVersionRead}
     */
    this.pitchVersionsIDApprovePatch = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchVersionsIDApprovePatch");
      }
      ...
      return this.apiClient.callApi(
        '/pitch_versions/{ID}/approve', 'PATCH',
    ...
    /**
     * Callback function to receive the result of the pitchVersionsIDDelete operation.
     * @callback module:api/PitchVersionsApi~pitchVersionsIDDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/PitchVersionsApi~pitchVersionsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.pitchVersionsIDDelete = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchVersionsIDDelete");
      }
    ...
    /**
     * Callback function to receive the result of the pitchVersionsIDGet operation.
     * @callback module:api/PitchVersionsApi~pitchVersionsIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PitchVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/PitchVersionsApi~pitchVersionsIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchVersionRead}
     */
    this.pitchVersionsIDGet = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchVersionsIDGet");
      }
    ...
    /**
     * Callback function to receive the result of the pitchVersionsIDRejectPatch operation.
     * @callback module:api/PitchVersionsApi~pitchVersionsIDRejectPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PitchVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:model/PitchVersionReject} body 
     * @param {module:api/PitchVersionsApi~pitchVersionsIDRejectPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchVersionRead}
     */
    this.pitchVersionsIDRejectPatch = function(ID, body, callback) {
      var postBody = body;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchVersionsIDRejectPatch");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling pitchVersionsIDRejectPatch");
      }
      ...
      return this.apiClient.callApi(
        '/pitch_versions/{ID}/reject', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the pitchVersionsIDRevivePatch operation.
     * @callback module:api/PitchVersionsApi~pitchVersionsIDRevivePatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PitchVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/PitchVersionsApi~pitchVersionsIDRevivePatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchVersionRead}
     */
    this.pitchVersionsIDRevivePatch = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchVersionsIDRevivePatch");
      }
      ...
      return this.apiClient.callApi(
        '/pitch_versions/{ID}/revive', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the pitchesIDPitchVersionsGet operation.
     * @callback module:api/PitchVersionsApi~pitchesIDPitchVersionsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/PitchVersionsApi~pitchesIDPitchVersionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PitchVersionReadAll}
     */
    this.pitchesIDPitchVersionsGet = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling pitchesIDPitchVersionsGet");
      }
