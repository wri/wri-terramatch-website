...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/LandOwnershipReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/LandOwnershipReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.LandOwnershipsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.LandOwnershipReadAll);
  }
}(this, function(ApiClient, LandOwnershipReadAll) {
  'use strict';

  /**
   * LandOwnerships service.
   * @module api/LandOwnershipsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new LandOwnershipsApi. 
   * @alias module:api/LandOwnershipsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the landOwnershipsGet operation.
     * @callback module:api/LandOwnershipsApi~landOwnershipsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LandOwnershipReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all land ownerships
     * @param {module:api/LandOwnershipsApi~landOwnershipsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LandOwnershipReadAll}
     */
    this.landOwnershipsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = LandOwnershipReadAll;
