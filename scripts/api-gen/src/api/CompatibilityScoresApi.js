...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CompatibilityScoreCreate', '../model/InlineResponse200'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CompatibilityScoreCreate'), require('../model/InlineResponse200'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CompatibilityScoresApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CompatibilityScoreCreate, root.WriRestorationMarketplaceApi.InlineResponse200);
  }
}(this, function(ApiClient, CompatibilityScoreCreate, InlineResponse200) {
  'use strict';

  /**
   * CompatibilityScores service.
   * @module api/CompatibilityScoresApi
   * @version 1.0.0
   */

  /**
   * Constructs a new CompatibilityScoresApi. 
   * @alias module:api/CompatibilityScoresApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the compatibilityScoresPost operation.
     * @callback module:api/CompatibilityScoresApi~compatibilityScoresPostCallback
     ...
     * @param {module:model/CompatibilityScoreCreate} body 
     * @param {module:api/CompatibilityScoresApi~compatibilityScoresPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse200}
     */
    this.compatibilityScoresPost = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling compatibilityScoresPost");
      }
