...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CarbonCertificationTypeReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CarbonCertificationTypeReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CarbonCertificationTypesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll);
  }
}(this, function(ApiClient, CarbonCertificationTypeReadAll) {
  'use strict';

  /**
   * CarbonCertificationTypes service.
   * @module api/CarbonCertificationTypesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new CarbonCertificationTypesApi. 
   * @alias module:api/CarbonCertificationTypesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the carbonCertificationTypesGet operation.
     * @callback module:api/CarbonCertificationTypesApi~carbonCertificationTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CarbonCertificationTypeReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all carbon certification types
     * @param {module:api/CarbonCertificationTypesApi~carbonCertificationTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CarbonCertificationTypeReadAll}
     */
    this.carbonCertificationTypesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = CarbonCertificationTypeReadAll;

      return this.apiClient.callApi(
        '/carbon_certification_types', 'GET',
