...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationGoalReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RestorationGoalReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RestorationGoalsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationGoalReadAll);
  }
}(this, function(ApiClient, RestorationGoalReadAll) {
  'use strict';

  /**
   * RestorationGoals service.
   * @module api/RestorationGoalsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new RestorationGoalsApi. 
   * @alias module:api/RestorationGoalsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the restorationGoalsGet operation.
     * @callback module:api/RestorationGoalsApi~restorationGoalsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RestorationGoalReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all restoration goals
     * @param {module:api/RestorationGoalsApi~restorationGoalsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RestorationGoalReadAll}
     */
    this.restorationGoalsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = RestorationGoalReadAll;

      return this.apiClient.callApi(
        '/restoration_goals', 'GET',
