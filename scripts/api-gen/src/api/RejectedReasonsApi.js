...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RejectedReasonReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RejectedReasonReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RejectedReasonsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RejectedReasonReadAll);
  }
}(this, function(ApiClient, RejectedReasonReadAll) {
  'use strict';

  /**
   * RejectedReasons service.
   * @module api/RejectedReasonsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new RejectedReasonsApi. 
   * @alias module:api/RejectedReasonsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the rejectedReasonsGet operation.
     * @callback module:api/RejectedReasonsApi~rejectedReasonsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RejectedReasonReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all rejected reasons
     * @param {module:api/RejectedReasonsApi~rejectedReasonsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RejectedReasonReadAll}
     */
    this.rejectedReasonsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = RejectedReasonReadAll;
