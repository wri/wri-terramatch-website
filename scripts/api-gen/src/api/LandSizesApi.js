...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/LandSizeReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/LandSizeReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.LandSizesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.LandSizeReadAll);
  }
}(this, function(ApiClient, LandSizeReadAll) {
  'use strict';

  /**
   * LandSizes service.
   * @module api/LandSizesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new LandSizesApi. 
   * @alias module:api/LandSizesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the landSizesGet operation.
     * @callback module:api/LandSizesApi~landSizesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LandSizeReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all land sizes
     * @param {module:api/LandSizesApi~landSizesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LandSizeReadAll}
     */
    this.landSizesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = LandSizeReadAll;
