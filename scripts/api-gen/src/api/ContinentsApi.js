...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ContinentReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ContinentReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ContinentsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ContinentReadAll);
  }
}(this, function(ApiClient, ContinentReadAll) {
  'use strict';

  /**
   * Continents service.
   * @module api/ContinentsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ContinentsApi. 
   * @alias module:api/ContinentsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ContinentsApi~continentsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ContinentReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all continents
     * @param {module:api/ContinentsApi~continentsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ContinentReadAll}
     */
    this.continentsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = ContinentReadAll;
