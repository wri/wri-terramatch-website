...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationMethodReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RestorationMethodReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RestorationMethodsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationMethodReadAll);
  }
}(this, function(ApiClient, RestorationMethodReadAll) {
  'use strict';

  /**
   * RestorationMethods service.
   * @module api/RestorationMethodsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new RestorationMethodsApi. 
   * @alias module:api/RestorationMethodsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the restorationMethodsGet operation.
     * @callback module:api/RestorationMethodsApi~restorationMethodsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RestorationMethodReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all restoration methods
     * @param {module:api/RestorationMethodsApi~restorationMethodsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RestorationMethodReadAll}
     */
    this.restorationMethodsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = RestorationMethodReadAll;

      return this.apiClient.callApi(
        '/restoration_methods', 'GET',
