...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/OfferDocumentCreate', '../model/OfferDocumentRead', '../model/OfferDocumentReadAll', '../model/OfferDocumentUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/OfferDocumentCreate'), require('../model/OfferDocumentRead'), require('../model/OfferDocumentReadAll'), require('../model/OfferDocumentUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OfferDocumentsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.OfferDocumentCreate, root.WriRestorationMarketplaceApi.OfferDocumentRead, root.WriRestorationMarketplaceApi.OfferDocumentReadAll, root.WriRestorationMarketplaceApi.OfferDocumentUpdate);
  }
}(this, function(ApiClient, Empty, OfferDocumentCreate, OfferDocumentRead, OfferDocumentReadAll, OfferDocumentUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the offerDocumentsIDDelete operation.
     * @callback module:api/OfferDocumentsApi~offerDocumentsIDDeleteCallback
     ...
     * @param {Number} ID 
     * @param {module:api/OfferDocumentsApi~offerDocumentsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.offerDocumentsIDDelete = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the offerDocumentsIDGet operation.
     * @callback module:api/OfferDocumentsApi~offerDocumentsIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferDocumentRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/OfferDocumentsApi~offerDocumentsIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferDocumentRead}
     */
    this.offerDocumentsIDGet = function(ID, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = OfferDocumentRead;
    ...
    /**
     * Callback function to receive the result of the offerDocumentsIDPatch operation.
     * @callback module:api/OfferDocumentsApi~offerDocumentsIDPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferDocumentRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/OfferDocumentsApi~offerDocumentsIDPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferDocumentRead}
     */
    this.offerDocumentsIDPatch = function(ID, body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the offerDocumentsPost operation.
     * @callback module:api/OfferDocumentsApi~offerDocumentsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferDocumentRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/OfferDocumentsApi~offerDocumentsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferDocumentRead}
     */
    this.offerDocumentsPost = function(body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the offersIDOfferDocumentsGet operation.
     * @callback module:api/OfferDocumentsApi~offersIDOfferDocumentsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OfferDocumentReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/OfferDocumentsApi~offersIDOfferDocumentsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OfferDocumentReadAll}
     */
    this.offersIDOfferDocumentsGet = function(ID, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = OfferDocumentReadAll;
