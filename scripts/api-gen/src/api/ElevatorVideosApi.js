...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ElevatorVideoCreate', '../model/ElevatorVideoRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ElevatorVideoCreate'), require('../model/ElevatorVideoRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ElevatorVideosApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ElevatorVideoCreate, root.WriRestorationMarketplaceApi.ElevatorVideoRead);
  }
}(this, function(ApiClient, ElevatorVideoCreate, ElevatorVideoRead) {
  'use strict';

  /**
   * ElevatorVideos service.
   * @module api/ElevatorVideosApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ElevatorVideosApi. 
   * @alias module:api/ElevatorVideosApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the elevatorVideosIDGet operation.
     * @callback module:api/ElevatorVideosApi~elevatorVideosIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ElevatorVideoRead} data The data returned by the service call.
     ...
     * @param {Number} ID 
     * @param {module:api/ElevatorVideosApi~elevatorVideosIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ElevatorVideoRead}
     */
    this.elevatorVideosIDGet = function(ID, callback) {
      var postBody = null;

      // verify the required parameter 'ID' is set
      if (ID === undefined || ID === null) {
        throw new Error("Missing the required parameter 'ID' when calling elevatorVideosIDGet");
      }
      ...
      var returnType = ElevatorVideoRead;

      return this.apiClient.callApi(
        '/elevator_videos/{ID}', 'GET',
    ...
    /**
     * Callback function to receive the result of the elevatorVideosPost operation.
     * @callback module:api/ElevatorVideosApi~elevatorVideosPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ElevatorVideoRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ElevatorVideoCreate} body 
     * @param {module:api/ElevatorVideosApi~elevatorVideosPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ElevatorVideoRead}
     */
    this.elevatorVideosPost = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling elevatorVideosPost");
      }
