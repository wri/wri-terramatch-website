...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/UploadCreate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/UploadCreate'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.UploadsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.UploadCreate);
  }
}(this, function(ApiClient, UploadCreate) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/UploadCreate} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/UploadCreate}
     */
    this.uploadsPost = function(upload, callback) {
      var postBody = null;

      // verify the required parameter 'upload' is set
      if (upload === undefined || upload === null) {
        throw new Error("Missing the required parameter 'upload' when calling uploadsPost");
      }
