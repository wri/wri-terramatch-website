...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Empty', '../model/TreeSpeciesVersionRead', '../model/TreeSpeciesVersionReadAll', '../model/TreeSpeciesVersionReject'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Empty'), require('../model/TreeSpeciesVersionRead'), require('../model/TreeSpeciesVersionReadAll'), require('../model/TreeSpeciesVersionReject'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TreeSpeciesVersionsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.Empty, root.WriRestorationMarketplaceApi.TreeSpeciesVersionRead, root.WriRestorationMarketplaceApi.TreeSpeciesVersionReadAll, root.WriRestorationMarketplaceApi.TreeSpeciesVersionReject);
  }
}(this, function(ApiClient, Empty, TreeSpeciesVersionRead, TreeSpeciesVersionReadAll, TreeSpeciesVersionReject) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the treeSpeciesIDTreeSpeciesVersionsGet operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesIDTreeSpeciesVersionsGetCallback
     ...
     * @param {Number} ID 
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesIDTreeSpeciesVersionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesVersionReadAll}
     */
    this.treeSpeciesIDTreeSpeciesVersionsGet = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the treeSpeciesVersionsIDApprovePatch operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDApprovePatchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDApprovePatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesVersionRead}
     */
    this.treeSpeciesVersionsIDApprovePatch = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the treeSpeciesVersionsIDDelete operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} ID 
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Empty}
     */
    this.treeSpeciesVersionsIDDelete = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the treeSpeciesVersionsIDGet operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TreeSpeciesVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesVersionRead}
     */
    this.treeSpeciesVersionsIDGet = function(ID, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the treeSpeciesVersionsIDRejectPatch operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDRejectPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TreeSpeciesVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDRejectPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesVersionRead}
     */
    this.treeSpeciesVersionsIDRejectPatch = function(ID, body, callback) {
      var postBody = body;
    ...
    /**
     * Callback function to receive the result of the treeSpeciesVersionsIDRevivePatch operation.
     * @callback module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDRevivePatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TreeSpeciesVersionRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ID 
     * @param {module:api/TreeSpeciesVersionsApi~treeSpeciesVersionsIDRevivePatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesVersionRead}
     */
    this.treeSpeciesVersionsIDRevivePatch = function(ID, callback) {
      var postBody = null;
