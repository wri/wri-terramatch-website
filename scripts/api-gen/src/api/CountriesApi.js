...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CountryReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CountryReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CountriesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CountryReadAll);
  }
}(this, function(ApiClient, CountryReadAll) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CountryReadAll} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/CountryReadAll}
     */
