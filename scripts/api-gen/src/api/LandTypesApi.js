...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/LandTypeReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/LandTypeReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.LandTypesApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.LandTypeReadAll);
  }
}(this, function(ApiClient, LandTypeReadAll) {
  'use strict';

  /**
   * LandTypes service.
   * @module api/LandTypesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new LandTypesApi. 
   * @alias module:api/LandTypesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the landTypesGet operation.
     * @callback module:api/LandTypesApi~landTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LandTypeReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all land types
     * @param {module:api/LandTypesApi~landTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LandTypeReadAll}
     */
    this.landTypesGet = function(callback) {
      var postBody = null;
      ...
      var returnType = LandTypeReadAll;
