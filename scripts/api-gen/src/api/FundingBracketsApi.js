...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/FundingBracketReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FundingBracketReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.FundingBracketsApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.FundingBracketReadAll);
  }
}(this, function(ApiClient, FundingBracketReadAll) {
  'use strict';

  /**
   * FundingBrackets service.
   * @module api/FundingBracketsApi
   * @version 1.0.0
   */

  /**
   * Constructs a new FundingBracketsApi. 
   * @alias module:api/FundingBracketsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the fundingBracketsGet operation.
     * @callback module:api/FundingBracketsApi~fundingBracketsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FundingBracketReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all funding brackets
     * @param {module:api/FundingBracketsApi~fundingBracketsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FundingBracketReadAll}
     */
    this.fundingBracketsGet = function(callback) {
      var postBody = null;
      ...
      var returnType = FundingBracketReadAll;

      return this.apiClient.callApi(
        '/funding_brackets', 'GET',
