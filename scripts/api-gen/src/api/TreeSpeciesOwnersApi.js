...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/TreeSpeciesOwnerReadAll'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/TreeSpeciesOwnerReadAll'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TreeSpeciesOwnersApi = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAll);
  }
}(this, function(ApiClient, TreeSpeciesOwnerReadAll) {
  'use strict';

  /**
   * TreeSpeciesOwners service.
   * @module api/TreeSpeciesOwnersApi
   * @version 1.0.0
   */

  /**
   * Constructs a new TreeSpeciesOwnersApi. 
   * @alias module:api/TreeSpeciesOwnersApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the treeSpeciesOwnersGet operation.
     * @callback module:api/TreeSpeciesOwnersApi~treeSpeciesOwnersGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TreeSpeciesOwnerReadAll} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Read all tree species owners
     * @param {module:api/TreeSpeciesOwnersApi~treeSpeciesOwnersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TreeSpeciesOwnerReadAll}
     */
    this.treeSpeciesOwnersGet = function(callback) {
      var postBody = null;
      ...
      var returnType = TreeSpeciesOwnerReadAll;

      return this.apiClient.callApi(
        '/tree_species_owners', 'GET',
