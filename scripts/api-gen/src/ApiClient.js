...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://test.wrirestorationmarketplace.cubeapis.com/api
     */
    this.basePath = 'https://test.wrirestorationmarketplace.cubeapis.com/api'.replace(/\/+$/, '');
