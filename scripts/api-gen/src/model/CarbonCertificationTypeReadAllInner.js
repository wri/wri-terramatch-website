...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationTypeReadAllInner model module.
   * @module model/CarbonCertificationTypeReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationTypeReadAllInner</code>.
   * @alias module:model/CarbonCertificationTypeReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationTypeReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationTypeReadAllInner} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationTypeReadAllInner} The populated <code>CarbonCertificationTypeReadAllInner</code> instance.
   */
