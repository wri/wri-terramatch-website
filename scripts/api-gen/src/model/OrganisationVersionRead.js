...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrganisationRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationRead);
  }
}(this, function(ApiClient, OrganisationRead) {
  'use strict';

  /**
   * The OrganisationVersionRead model module.
   * @module model/OrganisationVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationVersionRead</code>.
   * @alias module:model/OrganisationVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationVersionRead} obj Optional instance to populate.
   * @return {module:model/OrganisationVersionRead} The populated <code>OrganisationVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = OrganisationRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/OrganisationRead} data
   */
