...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/FundingBracketReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FundingBracketReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.FundingBracketReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.FundingBracketReadAllInner);
  }
}(this, function(ApiClient, FundingBracketReadAllInner) {
  'use strict';

  /**
   * The FundingBracketReadAll model module.
   * @module model/FundingBracketReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundingBracketReadAll</code>.
   * @alias module:model/FundingBracketReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>FundingBracketReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingBracketReadAll} obj Optional instance to populate.
   * @return {module:model/FundingBracketReadAll} The populated <code>FundingBracketReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'FundingBracketReadAllInner');
    }
    return obj;
  }
