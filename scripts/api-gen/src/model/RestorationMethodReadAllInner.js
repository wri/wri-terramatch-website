...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationMethodReadAllInner model module.
   * @module model/RestorationMethodReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodReadAllInner</code>.
   * @alias module:model/RestorationMethodReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodReadAllInner} obj Optional instance to populate.
   * @return {module:model/RestorationMethodReadAllInner} The populated <code>RestorationMethodReadAllInner</code> instance.
   */
