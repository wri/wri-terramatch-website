...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesOwnerReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesOwnerReadAllInner model module.
   * @module model/TreeSpeciesOwnerReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesOwnerReadAllInner</code>.
   * @alias module:model/TreeSpeciesOwnerReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesOwnerReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesOwnerReadAllInner} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesOwnerReadAllInner} The populated <code>TreeSpeciesOwnerReadAllInner</code> instance.
   */
