...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesUpdate model module.
   * @module model/TreeSpeciesUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesUpdate</code>.
   * @alias module:model/TreeSpeciesUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesUpdate} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesUpdate} The populated <code>TreeSpeciesUpdate</code> instance.
   */
