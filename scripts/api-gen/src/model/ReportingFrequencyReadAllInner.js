...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ReportingFrequencyReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ReportingFrequencyReadAllInner model module.
   * @module model/ReportingFrequencyReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReportingFrequencyReadAllInner</code>.
   * @alias module:model/ReportingFrequencyReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>ReportingFrequencyReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReportingFrequencyReadAllInner} obj Optional instance to populate.
   * @return {module:model/ReportingFrequencyReadAllInner} The populated <code>ReportingFrequencyReadAllInner</code> instance.
   */
