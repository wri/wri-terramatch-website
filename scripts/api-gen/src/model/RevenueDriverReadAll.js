...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RevenueDriverReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RevenueDriverReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RevenueDriverReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RevenueDriverReadAllInner);
  }
}(this, function(ApiClient, RevenueDriverReadAllInner) {
  'use strict';

  /**
   * The RevenueDriverReadAll model module.
   * @module model/RevenueDriverReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RevenueDriverReadAll</code>.
   * @alias module:model/RevenueDriverReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RevenueDriverReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RevenueDriverReadAll} obj Optional instance to populate.
   * @return {module:model/RevenueDriverReadAll} The populated <code>RevenueDriverReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RevenueDriverReadAllInner');
    }
    return obj;
  }
