...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MaskedUserRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MaskedUserRead model module.
   * @module model/MaskedUserRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MaskedUserRead</code>.
   * @alias module:model/MaskedUserRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MaskedUserRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MaskedUserRead} obj Optional instance to populate.
   * @return {module:model/MaskedUserRead} The populated <code>MaskedUserRead</code> instance.
   */
