...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CompatibilityScoreCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompatibilityScoreCreate model module.
   * @module model/CompatibilityScoreCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CompatibilityScoreCreate</code>.
   * @alias module:model/CompatibilityScoreCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>CompatibilityScoreCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompatibilityScoreCreate} obj Optional instance to populate.
   * @return {module:model/CompatibilityScoreCreate} The populated <code>CompatibilityScoreCreate</code> instance.
   */
