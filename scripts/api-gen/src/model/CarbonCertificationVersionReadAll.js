...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CarbonCertificationVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CarbonCertificationVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CarbonCertificationVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationVersionRead);
  }
}(this, function(ApiClient, CarbonCertificationVersionRead) {
  'use strict';

  /**
   * The CarbonCertificationVersionReadAll model module.
   * @module model/CarbonCertificationVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationVersionReadAll</code>.
   * @alias module:model/CarbonCertificationVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationVersionReadAll} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationVersionReadAll} The populated <code>CarbonCertificationVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'CarbonCertificationVersionRead');
    }
    return obj;
  }
