...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesCreate model module.
   * @module model/TreeSpeciesCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesCreate</code>.
   * @alias module:model/TreeSpeciesCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesCreate} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesCreate} The populated <code>TreeSpeciesCreate</code> instance.
   */
