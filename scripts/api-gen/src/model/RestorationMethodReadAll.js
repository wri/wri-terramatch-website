...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationMethodReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RestorationMethodReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RestorationMethodReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationMethodReadAllInner);
  }
}(this, function(ApiClient, RestorationMethodReadAllInner) {
  'use strict';

  /**
   * The RestorationMethodReadAll model module.
   * @module model/RestorationMethodReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodReadAll</code>.
   * @alias module:model/RestorationMethodReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RestorationMethodReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodReadAll} obj Optional instance to populate.
   * @return {module:model/RestorationMethodReadAll} The populated <code>RestorationMethodReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RestorationMethodReadAllInner');
    }
    return obj;
  }
