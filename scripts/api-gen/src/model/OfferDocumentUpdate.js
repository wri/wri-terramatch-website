...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferDocumentUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferDocumentUpdate model module.
   * @module model/OfferDocumentUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferDocumentUpdate</code>.
   * @alias module:model/OfferDocumentUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferDocumentUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferDocumentUpdate} obj Optional instance to populate.
   * @return {module:model/OfferDocumentUpdate} The populated <code>OfferDocumentUpdate</code> instance.
   */
