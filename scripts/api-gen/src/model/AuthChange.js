...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AuthChange = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AuthChange model module.
   * @module model/AuthChange
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AuthChange</code>.
   * @alias module:model/AuthChange
   * @class
   */
  ...
  /**
   * Constructs a <code>AuthChange</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AuthChange} obj Optional instance to populate.
   * @return {module:model/AuthChange} The populated <code>AuthChange</code> instance.
   */
