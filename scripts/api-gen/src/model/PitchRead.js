...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchRead model module.
   * @module model/PitchRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchRead</code>.
   * @alias module:model/PitchRead
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchRead} obj Optional instance to populate.
   * @return {module:model/PitchRead} The populated <code>PitchRead</code> instance.
   */
   ...
   */
  exports.prototype.compatibility_score = undefined;

  /**
   * @member {Number} price_per_tree
   */
  exports.prototype.price_per_tree = undefined;
