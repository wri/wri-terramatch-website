...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationDocumentVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationDocumentVersionReject model module.
   * @module model/OrganisationDocumentVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentVersionReject</code>.
   * @alias module:model/OrganisationDocumentVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentVersionReject} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentVersionReject} The populated <code>OrganisationDocumentVersionReject</code> instance.
   */
