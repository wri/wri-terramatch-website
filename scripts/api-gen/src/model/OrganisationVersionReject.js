...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationVersionReject model module.
   * @module model/OrganisationVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationVersionReject</code>.
   * @alias module:model/OrganisationVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationVersionReject} obj Optional instance to populate.
   * @return {module:model/OrganisationVersionReject} The populated <code>OrganisationVersionReject</code> instance.
   */
