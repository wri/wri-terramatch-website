...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationRead model module.
   * @module model/CarbonCertificationRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationRead</code>.
   * @alias module:model/CarbonCertificationRead
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationRead} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationRead} The populated <code>CarbonCertificationRead</code> instance.
   */
