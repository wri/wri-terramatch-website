...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchByContinentReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchByContinentReadAllInner model module.
   * @module model/PitchByContinentReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchByContinentReadAllInner</code>.
   * @alias module:model/PitchByContinentReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchByContinentReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchByContinentReadAllInner} obj Optional instance to populate.
   * @return {module:model/PitchByContinentReadAllInner} The populated <code>PitchByContinentReadAllInner</code> instance.
   */
