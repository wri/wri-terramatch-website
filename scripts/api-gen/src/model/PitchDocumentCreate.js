...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchDocumentCreate model module.
   * @module model/PitchDocumentCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentCreate</code>.
   * @alias module:model/PitchDocumentCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentCreate} obj Optional instance to populate.
   * @return {module:model/PitchDocumentCreate} The populated <code>PitchDocumentCreate</code> instance.
   */
