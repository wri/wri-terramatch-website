...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchContactRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchContactRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchContactReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchContactRead);
  }
}(this, function(ApiClient, PitchContactRead) {
  'use strict';

  /**
   * The PitchContactReadAll model module.
   * @module model/PitchContactReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchContactReadAll</code>.
   * @alias module:model/PitchContactReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchContactReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchContactReadAll} obj Optional instance to populate.
   * @return {module:model/PitchContactReadAll} The populated <code>PitchContactReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchContactRead');
    }
    return obj;
  }
