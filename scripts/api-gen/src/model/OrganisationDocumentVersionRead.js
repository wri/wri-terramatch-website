...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationDocumentRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrganisationDocumentRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationDocumentVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationDocumentRead);
  }
}(this, function(ApiClient, OrganisationDocumentRead) {
  'use strict';

  /**
   * The OrganisationDocumentVersionRead model module.
   * @module model/OrganisationDocumentVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentVersionRead</code>.
   * @alias module:model/OrganisationDocumentVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentVersionRead} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentVersionRead} The populated <code>OrganisationDocumentVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = OrganisationDocumentRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/OrganisationDocumentRead} data
   */
