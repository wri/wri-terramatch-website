...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AuthReset = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AuthReset model module.
   * @module model/AuthReset
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AuthReset</code>.
   * @alias module:model/AuthReset
   * @class
   */
  ...
  /**
   * Constructs a <code>AuthReset</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AuthReset} obj Optional instance to populate.
   * @return {module:model/AuthReset} The populated <code>AuthReset</code> instance.
   */
