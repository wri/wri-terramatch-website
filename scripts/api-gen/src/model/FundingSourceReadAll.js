...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/FundingSourceReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FundingSourceReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.FundingSourceReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.FundingSourceReadAllInner);
  }
}(this, function(ApiClient, FundingSourceReadAllInner) {
  'use strict';

  /**
   * The FundingSourceReadAll model module.
   * @module model/FundingSourceReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundingSourceReadAll</code>.
   * @alias module:model/FundingSourceReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>FundingSourceReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingSourceReadAll} obj Optional instance to populate.
   * @return {module:model/FundingSourceReadAll} The populated <code>FundingSourceReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'FundingSourceReadAllInner');
    }
    return obj;
  }
