...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchByContinentReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchByContinentReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchByContinentReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchByContinentReadAllInner);
  }
}(this, function(ApiClient, PitchByContinentReadAllInner) {
  'use strict';

  /**
   * The PitchByContinentReadAll model module.
   * @module model/PitchByContinentReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchByContinentReadAll</code>.
   * @alias module:model/PitchByContinentReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchByContinentReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchByContinentReadAll} obj Optional instance to populate.
   * @return {module:model/PitchByContinentReadAll} The populated <code>PitchByContinentReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchByContinentReadAllInner');
    }
    return obj;
  }
