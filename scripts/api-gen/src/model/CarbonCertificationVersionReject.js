...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationVersionReject model module.
   * @module model/CarbonCertificationVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationVersionReject</code>.
   * @alias module:model/CarbonCertificationVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationVersionReject} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationVersionReject} The populated <code>CarbonCertificationVersionReject</code> instance.
   */
