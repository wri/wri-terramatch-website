...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CarbonCertificationRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CarbonCertificationRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CarbonCertificationVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationRead);
  }
}(this, function(ApiClient, CarbonCertificationRead) {
  'use strict';

  /**
   * The CarbonCertificationVersionRead model module.
   * @module model/CarbonCertificationVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationVersionRead</code>.
   * @alias module:model/CarbonCertificationVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationVersionRead} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationVersionRead} The populated <code>CarbonCertificationVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = CarbonCertificationRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CarbonCertificationRead} data
   */
