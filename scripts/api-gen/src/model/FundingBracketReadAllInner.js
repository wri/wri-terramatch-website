...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.FundingBracketReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The FundingBracketReadAllInner model module.
   * @module model/FundingBracketReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundingBracketReadAllInner</code>.
   * @alias module:model/FundingBracketReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>FundingBracketReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingBracketReadAllInner} obj Optional instance to populate.
   * @return {module:model/FundingBracketReadAllInner} The populated <code>FundingBracketReadAllInner</code> instance.
   */
   ...
   */
  exports.prototype.bracket = undefined;
