...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationDocumentRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationDocumentRead model module.
   * @module model/OrganisationDocumentRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentRead</code>.
   * @alias module:model/OrganisationDocumentRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentRead} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentRead} The populated <code>OrganisationDocumentRead</code> instance.
   */
   ...
   */
  exports.prototype.organisation_id = undefined;
