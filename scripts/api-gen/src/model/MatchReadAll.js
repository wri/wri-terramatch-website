...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MatchRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MatchRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.MatchReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MatchRead);
  }
}(this, function(ApiClient, MatchRead) {
  'use strict';

  /**
   * The MatchReadAll model module.
   * @module model/MatchReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MatchReadAll</code>.
   * @alias module:model/MatchReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>MatchReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MatchReadAll} obj Optional instance to populate.
   * @return {module:model/MatchReadAll} The populated <code>MatchReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'MatchRead');
    }
    return obj;
  }
