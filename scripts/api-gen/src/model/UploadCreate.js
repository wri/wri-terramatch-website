...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.UploadCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UploadCreate model module.
   * @module model/UploadCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UploadCreate</code>.
   * @alias module:model/UploadCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>UploadCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UploadCreate} obj Optional instance to populate.
   * @return {module:model/UploadCreate} The populated <code>UploadCreate</code> instance.
   */
