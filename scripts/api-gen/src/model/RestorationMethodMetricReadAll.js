...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodMetricReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationMethodMetricRead);
  }
}(this, function(ApiClient, RestorationMethodMetricRead) {
  'use strict';

  /**
   * The RestorationMethodMetricReadAll model module.
   * @module model/RestorationMethodMetricReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricReadAll</code>.
   * @alias module:model/RestorationMethodMetricReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricReadAll} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricReadAll} The populated <code>RestorationMethodMetricReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RestorationMethodMetricRead');
    }
    return obj;
  }
