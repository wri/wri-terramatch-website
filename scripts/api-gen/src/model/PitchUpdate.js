...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchUpdate model module.
   * @module model/PitchUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchUpdate</code>.
   * @alias module:model/PitchUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchUpdate} obj Optional instance to populate.
   * @return {module:model/PitchUpdate} The populated <code>PitchUpdate</code> instance.
   */
