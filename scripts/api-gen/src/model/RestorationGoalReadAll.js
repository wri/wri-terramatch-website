...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationGoalReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationGoalReadAllInner);
  }
}(this, function(ApiClient, RestorationGoalReadAllInner) {
  'use strict';

  /**
   * The RestorationGoalReadAll model module.
   * @module model/RestorationGoalReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationGoalReadAll</code>.
   * @alias module:model/RestorationGoalReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RestorationGoalReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationGoalReadAll} obj Optional instance to populate.
   * @return {module:model/RestorationGoalReadAll} The populated <code>RestorationGoalReadAll</code> instance.
   */
