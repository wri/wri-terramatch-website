...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesRead model module.
   * @module model/TreeSpeciesRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesRead</code>.
   * @alias module:model/TreeSpeciesRead
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesRead} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesRead} The populated <code>TreeSpeciesRead</code> instance.
   */
