...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DraftRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DraftRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DraftReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DraftRead);
  }
}(this, function(ApiClient, DraftRead) {
  'use strict';

  /**
   * The DraftReadAll model module.
   * @module model/DraftReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftReadAll</code>.
   * @alias module:model/DraftReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>DraftReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftReadAll} obj Optional instance to populate.
   * @return {module:model/DraftReadAll} The populated <code>DraftReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'DraftRead');
    }
    return obj;
  }
