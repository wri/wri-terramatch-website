...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchContactRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchContactRead model module.
   * @module model/PitchContactRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchContactRead</code>.
   * @alias module:model/PitchContactRead
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchContactRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchContactRead} obj Optional instance to populate.
   * @return {module:model/PitchContactRead} The populated <code>PitchContactRead</code> instance.
   */
