...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OfferRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfferRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OfferReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OfferRead);
  }
}(this, function(ApiClient, OfferRead) {
  'use strict';

  /**
   * The OfferReadAll model module.
   * @module model/OfferReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferReadAll</code>.
   * @alias module:model/OfferReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OfferReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferReadAll} obj Optional instance to populate.
   * @return {module:model/OfferReadAll} The populated <code>OfferReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OfferRead');
    }
    return obj;
  }
