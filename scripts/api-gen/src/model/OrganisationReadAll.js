...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationRead);
  }
}(this, function(ApiClient, OrganisationRead) {
  'use strict';

  /**
   * The OrganisationReadAll model module.
   * @module model/OrganisationReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationReadAll</code>.
   * @alias module:model/OrganisationReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationReadAll} The populated <code>OrganisationReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OrganisationRead');
    }
    return obj;
  }
