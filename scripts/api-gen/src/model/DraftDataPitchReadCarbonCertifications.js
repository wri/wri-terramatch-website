...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataPitchReadCarbonCertifications = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataPitchReadCarbonCertifications model module.
   * @module model/DraftDataPitchReadCarbonCertifications
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataPitchReadCarbonCertifications</code>.
   * @alias module:model/DraftDataPitchReadCarbonCertifications
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataPitchReadCarbonCertifications</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataPitchReadCarbonCertifications} obj Optional instance to populate.
   * @return {module:model/DraftDataPitchReadCarbonCertifications} The populated <code>DraftDataPitchReadCarbonCertifications</code> instance.
   */
