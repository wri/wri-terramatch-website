...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchContactCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchContactCreateDraft model module.
   * @module model/PitchContactCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchContactCreateDraft</code>.
   * @alias module:model/PitchContactCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchContactCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchContactCreateDraft} obj Optional instance to populate.
   * @return {module:model/PitchContactCreateDraft} The populated <code>PitchContactCreateDraft</code> instance.
   */
