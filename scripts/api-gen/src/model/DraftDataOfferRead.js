...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OfferContactCreateDraft', '../model/OfferCreate', '../model/OfferDocumentCreateDraft'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfferContactCreateDraft'), require('./OfferCreate'), require('./OfferDocumentCreateDraft'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DraftDataOfferRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OfferContactCreateDraft, root.WriRestorationMarketplaceApi.OfferCreate, root.WriRestorationMarketplaceApi.OfferDocumentCreateDraft);
  }
}(this, function(ApiClient, OfferContactCreateDraft, OfferCreate, OfferDocumentCreateDraft) {
  'use strict';

  /**
   * The DraftDataOfferRead model module.
   * @module model/DraftDataOfferRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataOfferRead</code>.
   * @alias module:model/DraftDataOfferRead
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataOfferRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataOfferRead} obj Optional instance to populate.
   * @return {module:model/DraftDataOfferRead} The populated <code>DraftDataOfferRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('offer'))
        obj.offer = OfferCreate.constructFromObject(data['offer']);
      if (data.hasOwnProperty('offer_documents'))
        obj.offer_documents = ApiClient.convertToType(data['offer_documents'], [OfferDocumentCreateDraft]);
      if (data.hasOwnProperty('offer_contacts'))
        obj.offer_contacts = OfferContactCreateDraft.constructFromObject(data['offer_contacts']);
    }
    return obj;
  }

  /**
   * @member {module:model/OfferCreate} offer
   */
  exports.prototype.offer = undefined;

  /**
   * @member {Array.<module:model/OfferDocumentCreateDraft>} offer_documents
   */
  exports.prototype.offer_documents = undefined;

  /**
   * @member {module:model/OfferContactCreateDraft} offer_contacts
   */
