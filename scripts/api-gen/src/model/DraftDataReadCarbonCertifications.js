...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadCarbonCertifications = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadCarbonCertifications model module.
   * @module model/DraftDataReadCarbonCertifications
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadCarbonCertifications</code>.
   * @alias module:model/DraftDataReadCarbonCertifications
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadCarbonCertifications</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadCarbonCertifications} obj Optional instance to populate.
   * @return {module:model/DraftDataReadCarbonCertifications} The populated <code>DraftDataReadCarbonCertifications</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('other_value'))
        obj.other_value = ApiClient.convertToType(data['other_value'], 'String');
  ...
  /**
   * @member {String} other_value
   */
  exports.prototype.other_value = undefined;
