...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferDocumentRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferDocumentRead model module.
   * @module model/OfferDocumentRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferDocumentRead</code>.
   * @alias module:model/OfferDocumentRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferDocumentRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferDocumentRead} obj Optional instance to populate.
   * @return {module:model/OfferDocumentRead} The populated <code>OfferDocumentRead</code> instance.
   */
