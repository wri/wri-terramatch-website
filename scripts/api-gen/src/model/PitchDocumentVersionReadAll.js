...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchDocumentVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchDocumentVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchDocumentVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchDocumentVersionRead);
  }
}(this, function(ApiClient, PitchDocumentVersionRead) {
  'use strict';

  /**
   * The PitchDocumentVersionReadAll model module.
   * @module model/PitchDocumentVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentVersionReadAll</code>.
   * @alias module:model/PitchDocumentVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchDocumentVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentVersionReadAll} obj Optional instance to populate.
   * @return {module:model/PitchDocumentVersionReadAll} The populated <code>PitchDocumentVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchDocumentVersionRead');
    }
    return obj;
  }
