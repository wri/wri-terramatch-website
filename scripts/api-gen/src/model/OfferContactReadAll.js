...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OfferContactRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfferContactRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OfferContactReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OfferContactRead);
  }
}(this, function(ApiClient, OfferContactRead) {
  'use strict';

  /**
   * The OfferContactReadAll model module.
   * @module model/OfferContactReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferContactReadAll</code>.
   * @alias module:model/OfferContactReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OfferContactReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferContactReadAll} obj Optional instance to populate.
   * @return {module:model/OfferContactReadAll} The populated <code>OfferContactReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OfferContactRead');
    }
    return obj;
  }
