...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationDocumentVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrganisationDocumentVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationDocumentVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationDocumentVersionRead);
  }
}(this, function(ApiClient, OrganisationDocumentVersionRead) {
  'use strict';

  /**
   * The OrganisationDocumentVersionReadAll model module.
   * @module model/OrganisationDocumentVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentVersionReadAll</code>.
   * @alias module:model/OrganisationDocumentVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentVersionReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentVersionReadAll} The populated <code>OrganisationDocumentVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OrganisationDocumentVersionRead');
    }
    return obj;
  }
