...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DraftDataRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DraftDataRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DraftRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DraftDataRead);
  }
}(this, function(ApiClient, DraftDataRead) {
  'use strict';

  /**
   * The DraftRead model module.
   * @module model/DraftRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftRead</code>.
   * @alias module:model/DraftRead
   * @class
   */
   ...
   * @param {module:model/DraftRead} obj Optional instance to populate.
   * @return {module:model/DraftRead} The populated <code>DraftRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = DraftDataRead.constructFromObject(data['data']);
  ...
  /**
   * @member {module:model/DraftDataRead} data
   */
