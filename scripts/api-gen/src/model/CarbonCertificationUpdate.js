...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationUpdate model module.
   * @module model/CarbonCertificationUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationUpdate</code>.
   * @alias module:model/CarbonCertificationUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationUpdate} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationUpdate} The populated <code>CarbonCertificationUpdate</code> instance.
   */
