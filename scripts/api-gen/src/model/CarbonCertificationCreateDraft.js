...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationCreateDraft model module.
   * @module model/CarbonCertificationCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationCreateDraft</code>.
   * @alias module:model/CarbonCertificationCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationCreateDraft} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationCreateDraft} The populated <code>CarbonCertificationCreateDraft</code> instance.
   */
