...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataPitchReadRestorationMethodMetrics = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataPitchReadRestorationMethodMetrics model module.
   * @module model/DraftDataPitchReadRestorationMethodMetrics
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataPitchReadRestorationMethodMetrics</code>.
   * @alias module:model/DraftDataPitchReadRestorationMethodMetrics
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataPitchReadRestorationMethodMetrics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataPitchReadRestorationMethodMetrics} obj Optional instance to populate.
   * @return {module:model/DraftDataPitchReadRestorationMethodMetrics} The populated <code>DraftDataPitchReadRestorationMethodMetrics</code> instance.
   */
