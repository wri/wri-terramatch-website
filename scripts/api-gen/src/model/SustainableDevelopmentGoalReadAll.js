...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationGoalReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RestorationGoalReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.SustainableDevelopmentGoalReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationGoalReadAllInner);
  }
}(this, function(ApiClient, RestorationGoalReadAllInner) {
  'use strict';

  /**
   * The SustainableDevelopmentGoalReadAll model module.
   * @module model/SustainableDevelopmentGoalReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SustainableDevelopmentGoalReadAll</code>.
   * @alias module:model/SustainableDevelopmentGoalReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>SustainableDevelopmentGoalReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SustainableDevelopmentGoalReadAll} obj Optional instance to populate.
   * @return {module:model/SustainableDevelopmentGoalReadAll} The populated <code>SustainableDevelopmentGoalReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RestorationGoalReadAllInner');
    }
    return obj;
  }
