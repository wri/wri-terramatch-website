...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.InterestCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InterestCreate model module.
   * @module model/InterestCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InterestCreate</code>.
   * @alias module:model/InterestCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>InterestCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InterestCreate} obj Optional instance to populate.
   * @return {module:model/InterestCreate} The populated <code>InterestCreate</code> instance.
   */
