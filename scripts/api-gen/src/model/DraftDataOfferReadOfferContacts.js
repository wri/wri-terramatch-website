...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataOfferReadOfferContacts = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataOfferReadOfferContacts model module.
   * @module model/DraftDataOfferReadOfferContacts
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataOfferReadOfferContacts</code>.
   * @alias module:model/DraftDataOfferReadOfferContacts
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataOfferReadOfferContacts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataOfferReadOfferContacts} obj Optional instance to populate.
   * @return {module:model/DraftDataOfferReadOfferContacts} The populated <code>DraftDataOfferReadOfferContacts</code> instance.
   */
