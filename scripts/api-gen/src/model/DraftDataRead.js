...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DraftDataReadCarbonCertifications', '../model/DraftDataReadOffer', '../model/DraftDataReadOfferContacts', '../model/DraftDataReadOfferDocuments', '../model/DraftDataReadPitch', '../model/DraftDataReadRestorationMethodMetrics', '../model/DraftDataReadTreeSpecies'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DraftDataReadCarbonCertifications'), require('./DraftDataReadOffer'), require('./DraftDataReadOfferContacts'), require('./DraftDataReadOfferDocuments'), require('./DraftDataReadPitch'), require('./DraftDataReadRestorationMethodMetrics'), require('./DraftDataReadTreeSpecies'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DraftDataRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DraftDataReadCarbonCertifications, root.WriRestorationMarketplaceApi.DraftDataReadOffer, root.WriRestorationMarketplaceApi.DraftDataReadOfferContacts, root.WriRestorationMarketplaceApi.DraftDataReadOfferDocuments, root.WriRestorationMarketplaceApi.DraftDataReadPitch, root.WriRestorationMarketplaceApi.DraftDataReadRestorationMethodMetrics, root.WriRestorationMarketplaceApi.DraftDataReadTreeSpecies);
  }
}(this, function(ApiClient, DraftDataReadCarbonCertifications, DraftDataReadOffer, DraftDataReadOfferContacts, DraftDataReadOfferDocuments, DraftDataReadPitch, DraftDataReadRestorationMethodMetrics, DraftDataReadTreeSpecies) {
  'use strict';

  /**
   * The DraftDataRead model module.
   * @module model/DraftDataRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataRead</code>.
   * @alias module:model/DraftDataRead
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataRead} obj Optional instance to populate.
   * @return {module:model/DraftDataRead} The populated <code>DraftDataRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('offer'))
        obj.offer = DraftDataReadOffer.constructFromObject(data['offer']);
      if (data.hasOwnProperty('offer_contacts'))
        obj.offer_contacts = ApiClient.convertToType(data['offer_contacts'], [DraftDataReadOfferContacts]);
      if (data.hasOwnProperty('offer_documents'))
        obj.offer_documents = ApiClient.convertToType(data['offer_documents'], [DraftDataReadOfferDocuments]);
      if (data.hasOwnProperty('pitch'))
        obj.pitch = DraftDataReadPitch.constructFromObject(data['pitch']);
      if (data.hasOwnProperty('pitch_contacts'))
        obj.pitch_contacts = ApiClient.convertToType(data['pitch_contacts'], [DraftDataReadOfferContacts]);
      if (data.hasOwnProperty('pitch_documents'))
        obj.pitch_documents = ApiClient.convertToType(data['pitch_documents'], [DraftDataReadOfferDocuments]);
      if (data.hasOwnProperty('carbon_certifications'))
        obj.carbon_certifications = ApiClient.convertToType(data['carbon_certifications'], [DraftDataReadCarbonCertifications]);
      if (data.hasOwnProperty('restoration_method_metrics'))
        obj.restoration_method_metrics = ApiClient.convertToType(data['restoration_method_metrics'], [DraftDataReadRestorationMethodMetrics]);
      if (data.hasOwnProperty('tree_species'))
        obj.tree_species = ApiClient.convertToType(data['tree_species'], [DraftDataReadTreeSpecies]);
    }
    return obj;
  }

  /**
   * @member {module:model/DraftDataReadOffer} offer
   */
  exports.prototype.offer = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadOfferContacts>} offer_contacts
   */
  exports.prototype.offer_contacts = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadOfferDocuments>} offer_documents
   */
  exports.prototype.offer_documents = undefined;

  /**
   * @member {module:model/DraftDataReadPitch} pitch
   */
  exports.prototype.pitch = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadOfferContacts>} pitch_contacts
   */
  exports.prototype.pitch_contacts = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadOfferDocuments>} pitch_documents
   */
  exports.prototype.pitch_documents = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadCarbonCertifications>} carbon_certifications
   */
  exports.prototype.carbon_certifications = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadRestorationMethodMetrics>} restoration_method_metrics
   */
  exports.prototype.restoration_method_metrics = undefined;

  /**
   * @member {Array.<module:model/DraftDataReadTreeSpecies>} tree_species
   */
