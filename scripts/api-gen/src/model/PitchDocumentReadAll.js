...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchDocumentRead);
  }
}(this, function(ApiClient, PitchDocumentRead) {
  'use strict';

  /**
   * The PitchDocumentReadAll model module.
   * @module model/PitchDocumentReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentReadAll</code>.
   * @alias module:model/PitchDocumentReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchDocumentReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentReadAll} obj Optional instance to populate.
   * @return {module:model/PitchDocumentReadAll} The populated <code>PitchDocumentReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchDocumentRead');
    }
    return obj;
  }
