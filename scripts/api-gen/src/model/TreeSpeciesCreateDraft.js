...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesCreateDraft model module.
   * @module model/TreeSpeciesCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesCreateDraft</code>.
   * @alias module:model/TreeSpeciesCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesCreateDraft} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesCreateDraft} The populated <code>TreeSpeciesCreateDraft</code> instance.
   */
