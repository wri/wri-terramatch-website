...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MaskedTeamMemberRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MaskedTeamMemberRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.MaskedTeamMemberReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MaskedTeamMemberRead);
  }
}(this, function(ApiClient, MaskedTeamMemberRead) {
  'use strict';

  /**
   * The MaskedTeamMemberReadAll model module.
   * @module model/MaskedTeamMemberReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MaskedTeamMemberReadAll</code>.
   * @alias module:model/MaskedTeamMemberReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>MaskedTeamMemberReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MaskedTeamMemberReadAll} obj Optional instance to populate.
   * @return {module:model/MaskedTeamMemberReadAll} The populated <code>MaskedTeamMemberReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'MaskedTeamMemberRead');
    }
    return obj;
  }
