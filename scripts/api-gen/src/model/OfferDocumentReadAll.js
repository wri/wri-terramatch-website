...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OfferDocumentRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfferDocumentRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OfferDocumentReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OfferDocumentRead);
  }
}(this, function(ApiClient, OfferDocumentRead) {
  'use strict';

  /**
   * The OfferDocumentReadAll model module.
   * @module model/OfferDocumentReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferDocumentReadAll</code>.
   * @alias module:model/OfferDocumentReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OfferDocumentReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferDocumentReadAll} obj Optional instance to populate.
   * @return {module:model/OfferDocumentReadAll} The populated <code>OfferDocumentReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OfferDocumentRead');
    }
    return obj;
  }
