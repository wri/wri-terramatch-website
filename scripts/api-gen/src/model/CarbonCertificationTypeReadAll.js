...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CarbonCertificationTypeReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CarbonCertificationTypeReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner);
  }
}(this, function(ApiClient, CarbonCertificationTypeReadAllInner) {
  'use strict';

  /**
   * The CarbonCertificationTypeReadAll model module.
   * @module model/CarbonCertificationTypeReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationTypeReadAll</code>.
   * @alias module:model/CarbonCertificationTypeReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationTypeReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationTypeReadAll} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationTypeReadAll} The populated <code>CarbonCertificationTypeReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'CarbonCertificationTypeReadAllInner');
    }
    return obj;
  }
