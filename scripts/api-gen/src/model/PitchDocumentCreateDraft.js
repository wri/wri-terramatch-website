...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchDocumentCreateDraft model module.
   * @module model/PitchDocumentCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentCreateDraft</code>.
   * @alias module:model/PitchDocumentCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentCreateDraft} obj Optional instance to populate.
   * @return {module:model/PitchDocumentCreateDraft} The populated <code>PitchDocumentCreateDraft</code> instance.
   */
