...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodMetricVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationMethodMetricVersionReject model module.
   * @module model/RestorationMethodMetricVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricVersionReject</code>.
   * @alias module:model/RestorationMethodMetricVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricVersionReject} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricVersionReject} The populated <code>RestorationMethodMetricVersionReject</code> instance.
   */
