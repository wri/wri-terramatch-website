...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.TreeSpeciesRead);
  }
}(this, function(ApiClient, TreeSpeciesRead) {
  'use strict';

  /**
   * The TreeSpeciesReadAll model module.
   * @module model/TreeSpeciesReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesReadAll</code>.
   * @alias module:model/TreeSpeciesReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesReadAll} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesReadAll} The populated <code>TreeSpeciesReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'TreeSpeciesRead');
    }
    return obj;
  }
