...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchVersionRead);
  }
}(this, function(ApiClient, PitchVersionRead) {
  'use strict';

  /**
   * The PitchVersionReadAll model module.
   * @module model/PitchVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchVersionReadAll</code>.
   * @alias module:model/PitchVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchVersionReadAll} obj Optional instance to populate.
   * @return {module:model/PitchVersionReadAll} The populated <code>PitchVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchVersionRead');
    }
    return obj;
  }
