...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationGoalReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationGoalReadAllInner model module.
   * @module model/RestorationGoalReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationGoalReadAllInner</code>.
   * @alias module:model/RestorationGoalReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationGoalReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationGoalReadAllInner} obj Optional instance to populate.
   * @return {module:model/RestorationGoalReadAllInner} The populated <code>RestorationGoalReadAllInner</code> instance.
   */
