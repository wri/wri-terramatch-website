...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MaskedTeamMemberRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MaskedTeamMemberRead model module.
   * @module model/MaskedTeamMemberRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MaskedTeamMemberRead</code>.
   * @alias module:model/MaskedTeamMemberRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MaskedTeamMemberRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MaskedTeamMemberRead} obj Optional instance to populate.
   * @return {module:model/MaskedTeamMemberRead} The populated <code>MaskedTeamMemberRead</code> instance.
   */
