...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AdminRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.AdminReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.AdminRead);
  }
}(this, function(ApiClient, AdminRead) {
  'use strict';

  /**
   * The AdminReadAll model module.
   * @module model/AdminReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdminReadAll</code>.
   * @alias module:model/AdminReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>AdminReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminReadAll} obj Optional instance to populate.
   * @return {module:model/AdminReadAll} The populated <code>AdminReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'AdminRead');
    }
    return obj;
  }
