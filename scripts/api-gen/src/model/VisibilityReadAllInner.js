...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.VisibilityReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The VisibilityReadAllInner model module.
   * @module model/VisibilityReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VisibilityReadAllInner</code>.
   * @alias module:model/VisibilityReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>VisibilityReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VisibilityReadAllInner} obj Optional instance to populate.
   * @return {module:model/VisibilityReadAllInner} The populated <code>VisibilityReadAllInner</code> instance.
   */
