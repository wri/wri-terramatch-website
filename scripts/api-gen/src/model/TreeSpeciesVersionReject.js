...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TreeSpeciesVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TreeSpeciesVersionReject model module.
   * @module model/TreeSpeciesVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesVersionReject</code>.
   * @alias module:model/TreeSpeciesVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesVersionReject} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesVersionReject} The populated <code>TreeSpeciesVersionReject</code> instance.
   */
