...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/TreeSpeciesRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TreeSpeciesRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TreeSpeciesVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.TreeSpeciesRead);
  }
}(this, function(ApiClient, TreeSpeciesRead) {
  'use strict';

  /**
   * The TreeSpeciesVersionRead model module.
   * @module model/TreeSpeciesVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesVersionRead</code>.
   * @alias module:model/TreeSpeciesVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesVersionRead} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesVersionRead} The populated <code>TreeSpeciesVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = TreeSpeciesRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/TreeSpeciesRead} data
   */
