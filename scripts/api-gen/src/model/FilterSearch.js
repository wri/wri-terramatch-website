...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/FilterCondition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FilterCondition'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.FilterSearch = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.FilterCondition);
  }
}(this, function(ApiClient, FilterCondition) {
  'use strict';

  /**
   * The FilterSearch model module.
   * @module model/FilterSearch
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FilterSearch</code>.
   * @alias module:model/FilterSearch
   * @class
   */
  ...
  /**
   * Constructs a <code>FilterSearch</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FilterSearch} obj Optional instance to populate.
   * @return {module:model/FilterSearch} The populated <code>FilterSearch</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sortAttribute'))
        obj.sort_attribute = ApiClient.convertToType(data['sortAttribute'], 'String');
      if (data.hasOwnProperty('sortDirection'))
        obj.sort_direction = ApiClient.convertToType(data['sortDirection'], 'String');
      if (data.hasOwnProperty('filters'))
        obj.filters = ApiClient.convertToType(data['filters'], [FilterCondition]);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/FilterSearch.SortAttributeEnum} sort_attribute
   */
  exports.prototype.sort_attribute = undefined;

  /**
   * @member {module:model/FilterSearch.SortDirectionEnum} sort_direction
   */
  exports.prototype.sort_direction = undefined;

  /**
   * @member {Array.<module:model/FilterCondition>} filters
   */
  exports.prototype.filters = undefined;


  /**
   * Allowed values for the <code>sort_attribute</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SortAttributeEnum = {
    /**
     * value: "created_at"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>sort_direction</code> property.
   * @enum {String}
   * @readonly
   */
