...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrganisationVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationVersionRead);
  }
}(this, function(ApiClient, OrganisationVersionRead) {
  'use strict';

  /**
   * The OrganisationVersionReadAll model module.
   * @module model/OrganisationVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationVersionReadAll</code>.
   * @alias module:model/OrganisationVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationVersionReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationVersionReadAll} The populated <code>OrganisationVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OrganisationVersionRead');
    }
    return obj;
  }
