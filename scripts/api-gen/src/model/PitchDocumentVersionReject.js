...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchDocumentVersionReject model module.
   * @module model/PitchDocumentVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentVersionReject</code>.
   * @alias module:model/PitchDocumentVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentVersionReject} obj Optional instance to populate.
   * @return {module:model/PitchDocumentVersionReject} The populated <code>PitchDocumentVersionReject</code> instance.
   */
