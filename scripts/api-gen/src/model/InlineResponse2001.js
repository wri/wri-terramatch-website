...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AdminRead', '../model/UserRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminRead'), require('./UserRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.InlineResponse2001 = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.AdminRead, root.WriRestorationMarketplaceApi.UserRead);
  }
}(this, function(ApiClient, AdminRead, UserRead) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ADMIN'))
        obj.ADMIN = AdminRead.constructFromObject(data['ADMIN']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AdminRead} ADMIN
   */
