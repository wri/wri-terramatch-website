...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferContactRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferContactRead model module.
   * @module model/OfferContactRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferContactRead</code>.
   * @alias module:model/OfferContactRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferContactRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferContactRead} obj Optional instance to populate.
   * @return {module:model/OfferContactRead} The populated <code>OfferContactRead</code> instance.
   */
