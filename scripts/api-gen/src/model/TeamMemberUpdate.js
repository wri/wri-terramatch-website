...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TeamMemberUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TeamMemberUpdate model module.
   * @module model/TeamMemberUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TeamMemberUpdate</code>.
   * @alias module:model/TeamMemberUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>TeamMemberUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TeamMemberUpdate} obj Optional instance to populate.
   * @return {module:model/TeamMemberUpdate} The populated <code>TeamMemberUpdate</code> instance.
   */
