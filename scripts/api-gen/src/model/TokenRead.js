...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TokenRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TokenRead model module.
   * @module model/TokenRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TokenRead</code>.
   * @alias module:model/TokenRead
   * @class
   */
  ...
  /**
   * Constructs a <code>TokenRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TokenRead} obj Optional instance to populate.
   * @return {module:model/TokenRead} The populated <code>TokenRead</code> instance.
   */
