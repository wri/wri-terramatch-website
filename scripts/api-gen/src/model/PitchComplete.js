...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchComplete = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchComplete model module.
   * @module model/PitchComplete
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchComplete</code>.
   * @alias module:model/PitchComplete
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchComplete</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchComplete} obj Optional instance to populate.
   * @return {module:model/PitchComplete} The populated <code>PitchComplete</code> instance.
   */
