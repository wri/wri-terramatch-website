...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferDocumentCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferDocumentCreateDraft model module.
   * @module model/OfferDocumentCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferDocumentCreateDraft</code>.
   * @alias module:model/OfferDocumentCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferDocumentCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferDocumentCreateDraft} obj Optional instance to populate.
   * @return {module:model/OfferDocumentCreateDraft} The populated <code>OfferDocumentCreateDraft</code> instance.
   */
