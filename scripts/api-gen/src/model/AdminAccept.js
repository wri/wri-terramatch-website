...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AdminAccept = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AdminAccept model module.
   * @module model/AdminAccept
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdminAccept</code>.
   * @alias module:model/AdminAccept
   * @class
   */
  ...
  /**
   * Constructs a <code>AdminAccept</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminAccept} obj Optional instance to populate.
   * @return {module:model/AdminAccept} The populated <code>AdminAccept</code> instance.
   */
