...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DocumentTypeReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner);
  }
}(this, function(ApiClient, CarbonCertificationTypeReadAllInner) {
  'use strict';

  /**
   * The DocumentTypeReadAll model module.
   * @module model/DocumentTypeReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DocumentTypeReadAll</code>.
   * @alias module:model/DocumentTypeReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>DocumentTypeReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocumentTypeReadAll} obj Optional instance to populate.
   * @return {module:model/DocumentTypeReadAll} The populated <code>DocumentTypeReadAll</code> instance.
   */
