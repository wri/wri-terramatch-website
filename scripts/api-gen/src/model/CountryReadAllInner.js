...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CountryReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CountryReadAllInner model module.
   * @module model/CountryReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CountryReadAllInner</code>.
   * @alias module:model/CountryReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>CountryReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CountryReadAllInner} obj Optional instance to populate.
   * @return {module:model/CountryReadAllInner} The populated <code>CountryReadAllInner</code> instance.
   */
