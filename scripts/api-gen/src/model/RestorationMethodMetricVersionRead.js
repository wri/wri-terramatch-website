...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationMethodMetricRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RestorationMethodMetricRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationMethodMetricRead);
  }
}(this, function(ApiClient, RestorationMethodMetricRead) {
  'use strict';

  /**
   * The RestorationMethodMetricVersionRead model module.
   * @module model/RestorationMethodMetricVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricVersionRead</code>.
   * @alias module:model/RestorationMethodMetricVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricVersionRead} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricVersionRead} The populated <code>RestorationMethodMetricVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rejected_reason_body'))
        obj.rejected_reason_body = ApiClient.convertToType(data['rejected_reason_body'], 'String');
      if (data.hasOwnProperty('approved_rejected_by'))
        obj.approved_rejected_by = ApiClient.convertToType(data['approved_rejected_by'], 'Number');
      if (data.hasOwnProperty('approved_rejected_at'))
        obj.approved_rejected_at = ApiClient.convertToType(data['approved_rejected_at'], 'Date');
      if (data.hasOwnProperty('created_at'))
        obj.created_at = ApiClient.convertToType(data['created_at'], 'Date');
      if (data.hasOwnProperty('updated_at'))
        obj.updated_at = ApiClient.convertToType(data['updated_at'], 'Date');
      if (data.hasOwnProperty('data'))
        obj.data = RestorationMethodMetricRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {String} rejected_reason_body
   */
  exports.prototype.rejected_reason_body = undefined;

  /**
   * @member {Number} approved_rejected_by
   */
  exports.prototype.approved_rejected_by = undefined;

  /**
   * @member {Date} approved_rejected_at
   */
  exports.prototype.approved_rejected_at = undefined;
  ...
  /**
   * @member {module:model/RestorationMethodMetricRead} data
   */
