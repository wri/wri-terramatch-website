...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ReportingFrequencyReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReportingFrequencyReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ReportingFrequencyReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ReportingFrequencyReadAllInner);
  }
}(this, function(ApiClient, ReportingFrequencyReadAllInner) {
  'use strict';

  /**
   * The ReportingFrequencyReadAll model module.
   * @module model/ReportingFrequencyReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReportingFrequencyReadAll</code>.
   * @alias module:model/ReportingFrequencyReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>ReportingFrequencyReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReportingFrequencyReadAll} obj Optional instance to populate.
   * @return {module:model/ReportingFrequencyReadAll} The populated <code>ReportingFrequencyReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'ReportingFrequencyReadAllInner');
    }
    return obj;
  }
