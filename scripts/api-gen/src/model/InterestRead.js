...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.InterestRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InterestRead model module.
   * @module model/InterestRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InterestRead</code>.
   * @alias module:model/InterestRead
   * @class
   */
  ...
  /**
   * Constructs a <code>InterestRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InterestRead} obj Optional instance to populate.
   * @return {module:model/InterestRead} The populated <code>InterestRead</code> instance.
   */
