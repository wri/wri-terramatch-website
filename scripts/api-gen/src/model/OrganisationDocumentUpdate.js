...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationDocumentUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationDocumentUpdate model module.
   * @module model/OrganisationDocumentUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentUpdate</code>.
   * @alias module:model/OrganisationDocumentUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentUpdate} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentUpdate} The populated <code>OrganisationDocumentUpdate</code> instance.
   */
