...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadOfferDocuments = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadOfferDocuments model module.
   * @module model/DraftDataReadOfferDocuments
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadOfferDocuments</code>.
   * @alias module:model/DraftDataReadOfferDocuments
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadOfferDocuments</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadOfferDocuments} obj Optional instance to populate.
   * @return {module:model/DraftDataReadOfferDocuments} The populated <code>DraftDataReadOfferDocuments</code> instance.
   */
