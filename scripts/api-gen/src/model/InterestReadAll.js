...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InterestRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InterestRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.InterestReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.InterestRead);
  }
}(this, function(ApiClient, InterestRead) {
  'use strict';

  /**
   * The InterestReadAll model module.
   * @module model/InterestReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InterestReadAll</code>.
   * @alias module:model/InterestReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>InterestReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InterestReadAll} obj Optional instance to populate.
   * @return {module:model/InterestReadAll} The populated <code>InterestReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'InterestRead');
    }
    return obj;
  }
