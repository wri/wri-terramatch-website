...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ContinentReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContinentReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ContinentReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ContinentReadAllInner);
  }
}(this, function(ApiClient, ContinentReadAllInner) {
  'use strict';

  /**
   * The ContinentReadAll model module.
   * @module model/ContinentReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ContinentReadAll</code>.
   * @alias module:model/ContinentReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>ContinentReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContinentReadAll} obj Optional instance to populate.
   * @return {module:model/ContinentReadAll} The populated <code>ContinentReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'ContinentReadAllInner');
    }
    return obj;
  }
