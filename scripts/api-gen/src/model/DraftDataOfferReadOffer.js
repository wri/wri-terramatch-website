...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataOfferReadOffer = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataOfferReadOffer model module.
   * @module model/DraftDataOfferReadOffer
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataOfferReadOffer</code>.
   * @alias module:model/DraftDataOfferReadOffer
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataOfferReadOffer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataOfferReadOffer} obj Optional instance to populate.
   * @return {module:model/DraftDataOfferReadOffer} The populated <code>DraftDataOfferReadOffer</code> instance.
   */
