...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DraftDataOfferRead', '../model/DraftDataPitchRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DraftDataOfferRead'), require('./DraftDataPitchRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DraftReadData = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DraftDataOfferRead, root.WriRestorationMarketplaceApi.DraftDataPitchRead);
  }
}(this, function(ApiClient, DraftDataOfferRead, DraftDataPitchRead) {
  'use strict';

  /**
   * The DraftReadData model module.
   * @module model/DraftReadData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftReadData</code>.
   * @alias module:model/DraftReadData
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftReadData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftReadData} obj Optional instance to populate.
   * @return {module:model/DraftReadData} The populated <code>DraftReadData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('OFFER'))
        obj.OFFER = DraftDataOfferRead.constructFromObject(data['OFFER']);
      if (data.hasOwnProperty('PITCH'))
        obj.PITCH = DraftDataPitchRead.constructFromObject(data['PITCH']);
    }
    return obj;
  }

  /**
   * @member {module:model/DraftDataOfferRead} OFFER
   */
  exports.prototype.OFFER = undefined;

  /**
   * @member {module:model/DraftDataPitchRead} PITCH
   */
