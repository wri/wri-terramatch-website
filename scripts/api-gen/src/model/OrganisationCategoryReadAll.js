...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/OrganisationCategoryReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrganisationCategoryReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.OrganisationCategoryReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationCategoryReadAllInner);
  }
}(this, function(ApiClient, OrganisationCategoryReadAllInner) {
  'use strict';

  /**
   * The OrganisationCategoryReadAll model module.
   * @module model/OrganisationCategoryReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationCategoryReadAll</code>.
   * @alias module:model/OrganisationCategoryReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationCategoryReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationCategoryReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationCategoryReadAll} The populated <code>OrganisationCategoryReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OrganisationCategoryReadAllInner');
    }
    return obj;
  }
