...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.FundingSourceReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The FundingSourceReadAllInner model module.
   * @module model/FundingSourceReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundingSourceReadAllInner</code>.
   * @alias module:model/FundingSourceReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>FundingSourceReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingSourceReadAllInner} obj Optional instance to populate.
   * @return {module:model/FundingSourceReadAllInner} The populated <code>FundingSourceReadAllInner</code> instance.
   */
