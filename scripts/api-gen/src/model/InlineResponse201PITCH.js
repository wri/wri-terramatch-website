...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.InlineResponse201PITCH = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse201PITCH model module.
   * @module model/InlineResponse201PITCH
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse201PITCH</code>.
   * @alias module:model/InlineResponse201PITCH
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse201PITCH</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse201PITCH} obj Optional instance to populate.
   * @return {module:model/InlineResponse201PITCH} The populated <code>InlineResponse201PITCH</code> instance.
   */
