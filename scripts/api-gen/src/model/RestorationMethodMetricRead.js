...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodMetricRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationMethodMetricRead model module.
   * @module model/RestorationMethodMetricRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricRead</code>.
   * @alias module:model/RestorationMethodMetricRead
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricRead} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricRead} The populated <code>RestorationMethodMetricRead</code> instance.
   */
