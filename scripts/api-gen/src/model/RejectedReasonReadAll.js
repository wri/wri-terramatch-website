...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RejectedReasonReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RejectedReasonReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RejectedReasonReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RejectedReasonReadAllInner);
  }
}(this, function(ApiClient, RejectedReasonReadAllInner) {
  'use strict';

  /**
   * The RejectedReasonReadAll model module.
   * @module model/RejectedReasonReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RejectedReasonReadAll</code>.
   * @alias module:model/RejectedReasonReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RejectedReasonReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RejectedReasonReadAll} obj Optional instance to populate.
   * @return {module:model/RejectedReasonReadAll} The populated <code>RejectedReasonReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RejectedReasonReadAllInner');
    }
    return obj;
  }
