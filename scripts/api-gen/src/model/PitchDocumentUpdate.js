...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchDocumentUpdate model module.
   * @module model/PitchDocumentUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentUpdate</code>.
   * @alias module:model/PitchDocumentUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentUpdate} obj Optional instance to populate.
   * @return {module:model/PitchDocumentUpdate} The populated <code>PitchDocumentUpdate</code> instance.
   */
