...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadOffer = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadOffer model module.
   * @module model/DraftDataReadOffer
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadOffer</code>.
   * @alias module:model/DraftDataReadOffer
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadOffer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadOffer} obj Optional instance to populate.
   * @return {module:model/DraftDataReadOffer} The populated <code>DraftDataReadOffer</code> instance.
   */
