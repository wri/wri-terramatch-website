...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationDocumentCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationDocumentCreate model module.
   * @module model/OrganisationDocumentCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentCreate</code>.
   * @alias module:model/OrganisationDocumentCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentCreate} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentCreate} The populated <code>OrganisationDocumentCreate</code> instance.
   */
