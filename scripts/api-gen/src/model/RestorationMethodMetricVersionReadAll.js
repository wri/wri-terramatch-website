...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/RestorationMethodMetricVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RestorationMethodMetricVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.RestorationMethodMetricVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.RestorationMethodMetricVersionRead);
  }
}(this, function(ApiClient, RestorationMethodMetricVersionRead) {
  'use strict';

  /**
   * The RestorationMethodMetricVersionReadAll model module.
   * @module model/RestorationMethodMetricVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricVersionReadAll</code>.
   * @alias module:model/RestorationMethodMetricVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricVersionReadAll} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricVersionReadAll} The populated <code>RestorationMethodMetricVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RestorationMethodMetricVersionRead');
    }
    return obj;
  }
