...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TeamMemberRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TeamMemberRead model module.
   * @module model/TeamMemberRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TeamMemberRead</code>.
   * @alias module:model/TeamMemberRead
   * @class
   */
  ...
  /**
   * Constructs a <code>TeamMemberRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TeamMemberRead} obj Optional instance to populate.
   * @return {module:model/TeamMemberRead} The populated <code>TeamMemberRead</code> instance.
   */
