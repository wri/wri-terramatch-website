...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MaskedUserRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MaskedUserRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.MaskedUserReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MaskedUserRead);
  }
}(this, function(ApiClient, MaskedUserRead) {
  'use strict';

  /**
   * The MaskedUserReadAll model module.
   * @module model/MaskedUserReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MaskedUserReadAll</code>.
   * @alias module:model/MaskedUserReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>MaskedUserReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MaskedUserReadAll} obj Optional instance to populate.
   * @return {module:model/MaskedUserReadAll} The populated <code>MaskedUserReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'MaskedUserRead');
    }
    return obj;
  }
