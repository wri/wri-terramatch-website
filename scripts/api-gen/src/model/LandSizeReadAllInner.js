...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.LandSizeReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The LandSizeReadAllInner model module.
   * @module model/LandSizeReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LandSizeReadAllInner</code>.
   * @alias module:model/LandSizeReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>LandSizeReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LandSizeReadAllInner} obj Optional instance to populate.
   * @return {module:model/LandSizeReadAllInner} The populated <code>LandSizeReadAllInner</code> instance.
   */
