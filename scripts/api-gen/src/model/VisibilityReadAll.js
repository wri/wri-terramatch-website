...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/VisibilityReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VisibilityReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.VisibilityReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.VisibilityReadAllInner);
  }
}(this, function(ApiClient, VisibilityReadAllInner) {
  'use strict';

  /**
   * The VisibilityReadAll model module.
   * @module model/VisibilityReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VisibilityReadAll</code>.
   * @alias module:model/VisibilityReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>VisibilityReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VisibilityReadAll} obj Optional instance to populate.
   * @return {module:model/VisibilityReadAll} The populated <code>VisibilityReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'VisibilityReadAllInner');
    }
    return obj;
  }
