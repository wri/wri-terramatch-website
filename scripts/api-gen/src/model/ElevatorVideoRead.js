...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ElevatorVideoRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ElevatorVideoRead model module.
   * @module model/ElevatorVideoRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ElevatorVideoRead</code>.
   * @alias module:model/ElevatorVideoRead
   * @class
   */
  ...
  /**
   * Constructs a <code>ElevatorVideoRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ElevatorVideoRead} obj Optional instance to populate.
   * @return {module:model/ElevatorVideoRead} The populated <code>ElevatorVideoRead</code> instance.
   */
