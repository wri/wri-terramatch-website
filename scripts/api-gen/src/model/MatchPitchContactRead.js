...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MatchPitchContactRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MatchPitchContactRead model module.
   * @module model/MatchPitchContactRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MatchPitchContactRead</code>.
   * @alias module:model/MatchPitchContactRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MatchPitchContactRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MatchPitchContactRead} obj Optional instance to populate.
   * @return {module:model/MatchPitchContactRead} The populated <code>MatchPitchContactRead</code> instance.
   */
