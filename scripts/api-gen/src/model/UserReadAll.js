...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.UserReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.UserRead);
  }
}(this, function(ApiClient, UserRead) {
  'use strict';

  /**
   * The UserReadAll model module.
   * @module model/UserReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UserReadAll</code>.
   * @alias module:model/UserReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>UserReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserReadAll} obj Optional instance to populate.
   * @return {module:model/UserReadAll} The populated <code>UserReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'UserRead');
    }
    return obj;
  }
