...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchRead);
  }
}(this, function(ApiClient, PitchRead) {
  'use strict';

  /**
   * The PitchReadAll model module.
   * @module model/PitchReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchReadAll</code>.
   * @alias module:model/PitchReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>PitchReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchReadAll} obj Optional instance to populate.
   * @return {module:model/PitchReadAll} The populated <code>PitchReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'PitchRead');
    }
    return obj;
  }
