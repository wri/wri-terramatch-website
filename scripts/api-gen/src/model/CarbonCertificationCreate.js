...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CarbonCertificationCreate model module.
   * @module model/CarbonCertificationCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationCreate</code>.
   * @alias module:model/CarbonCertificationCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationCreate} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationCreate} The populated <code>CarbonCertificationCreate</code> instance.
   */
