...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DeviceRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeviceRead model module.
   * @module model/DeviceRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeviceRead</code>.
   * @alias module:model/DeviceRead
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceRead} obj Optional instance to populate.
   * @return {module:model/DeviceRead} The populated <code>DeviceRead</code> instance.
   */
