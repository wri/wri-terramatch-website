...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferComplete = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferComplete model module.
   * @module model/OfferComplete
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferComplete</code>.
   * @alias module:model/OfferComplete
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferComplete</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferComplete} obj Optional instance to populate.
   * @return {module:model/OfferComplete} The populated <code>OfferComplete</code> instance.
   */
