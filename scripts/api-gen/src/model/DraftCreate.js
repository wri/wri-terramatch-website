...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftCreate model module.
   * @module model/DraftCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftCreate</code>.
   * @alias module:model/DraftCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftCreate} obj Optional instance to populate.
   * @return {module:model/DraftCreate} The populated <code>DraftCreate</code> instance.
   */
