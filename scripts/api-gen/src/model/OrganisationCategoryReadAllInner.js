...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationCategoryReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationCategoryReadAllInner model module.
   * @module model/OrganisationCategoryReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationCategoryReadAllInner</code>.
   * @alias module:model/OrganisationCategoryReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationCategoryReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationCategoryReadAllInner} obj Optional instance to populate.
   * @return {module:model/OrganisationCategoryReadAllInner} The populated <code>OrganisationCategoryReadAllInner</code> instance.
   */
