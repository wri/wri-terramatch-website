...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.InlineResponse201OFFER = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse201OFFER model module.
   * @module model/InlineResponse201OFFER
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse201OFFER</code>.
   * @alias module:model/InlineResponse201OFFER
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse201OFFER</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse201OFFER} obj Optional instance to populate.
   * @return {module:model/InlineResponse201OFFER} The populated <code>InlineResponse201OFFER</code> instance.
   */
