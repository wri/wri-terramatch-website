...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OrganisationRead model module.
   * @module model/OrganisationRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationRead</code>.
   * @alias module:model/OrganisationRead
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganisationRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationRead} obj Optional instance to populate.
   * @return {module:model/OrganisationRead} The populated <code>OrganisationRead</code> instance.
   */
