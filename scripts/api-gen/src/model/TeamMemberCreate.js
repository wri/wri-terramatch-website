...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.TeamMemberCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TeamMemberCreate model module.
   * @module model/TeamMemberCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TeamMemberCreate</code>.
   * @alias module:model/TeamMemberCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>TeamMemberCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TeamMemberCreate} obj Optional instance to populate.
   * @return {module:model/TeamMemberCreate} The populated <code>TeamMemberCreate</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('avatar'))
        obj.avatar = ApiClient.convertToType(data['avatar'], 'Number');
