...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.LandOwnershipReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The LandOwnershipReadAllInner model module.
   * @module model/LandOwnershipReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LandOwnershipReadAllInner</code>.
   * @alias module:model/LandOwnershipReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>LandOwnershipReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LandOwnershipReadAllInner} obj Optional instance to populate.
   * @return {module:model/LandOwnershipReadAllInner} The populated <code>LandOwnershipReadAllInner</code> instance.
   */
