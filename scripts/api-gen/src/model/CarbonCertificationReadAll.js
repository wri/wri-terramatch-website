...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.CarbonCertificationReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationRead);
  }
}(this, function(ApiClient, CarbonCertificationRead) {
  'use strict';

  /**
   * The CarbonCertificationReadAll model module.
   * @module model/CarbonCertificationReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CarbonCertificationReadAll</code>.
   * @alias module:model/CarbonCertificationReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>CarbonCertificationReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarbonCertificationReadAll} obj Optional instance to populate.
   * @return {module:model/CarbonCertificationReadAll} The populated <code>CarbonCertificationReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'CarbonCertificationRead');
    }
    return obj;
  }
