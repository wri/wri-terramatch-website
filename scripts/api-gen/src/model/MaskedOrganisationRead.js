...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MaskedOrganisationRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MaskedOrganisationRead model module.
   * @module model/MaskedOrganisationRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MaskedOrganisationRead</code>.
   * @alias module:model/MaskedOrganisationRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MaskedOrganisationRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MaskedOrganisationRead} obj Optional instance to populate.
   * @return {module:model/MaskedOrganisationRead} The populated <code>MaskedOrganisationRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('founded_at'))
        obj.founded_at = ApiClient.convertToType(data['founded_at'], 'Date');
  ...
  /**
   * @member {Date} founded_at
   */
  exports.prototype.founded_at = undefined;
