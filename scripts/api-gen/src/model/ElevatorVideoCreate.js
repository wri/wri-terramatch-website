...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ElevatorVideoCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ElevatorVideoCreate model module.
   * @module model/ElevatorVideoCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ElevatorVideoCreate</code>.
   * @alias module:model/ElevatorVideoCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>ElevatorVideoCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ElevatorVideoCreate} obj Optional instance to populate.
   * @return {module:model/ElevatorVideoCreate} The populated <code>ElevatorVideoCreate</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('introduction'))
        obj.introduction = ApiClient.convertToType(data['introduction'], 'Number');
      if (data.hasOwnProperty('aims'))
        obj.aims = ApiClient.convertToType(data['aims'], 'Number');
   ...
   * @member {Number} aims
   */
  exports.prototype.aims = undefined;
