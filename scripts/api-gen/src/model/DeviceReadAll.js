...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DeviceRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DeviceRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.DeviceReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.DeviceRead);
  }
}(this, function(ApiClient, DeviceRead) {
  'use strict';

  /**
   * The DeviceReadAll model module.
   * @module model/DeviceReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeviceReadAll</code>.
   * @alias module:model/DeviceReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>DeviceReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceReadAll} obj Optional instance to populate.
   * @return {module:model/DeviceReadAll} The populated <code>DeviceReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'DeviceRead');
    }
    return obj;
  }
