...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AdminInvite = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AdminInvite model module.
   * @module model/AdminInvite
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdminInvite</code>.
   * @alias module:model/AdminInvite
   * @class
   */
  ...
  /**
   * Constructs a <code>AdminInvite</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminInvite} obj Optional instance to populate.
   * @return {module:model/AdminInvite} The populated <code>AdminInvite</code> instance.
   */
