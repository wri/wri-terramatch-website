...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationTypeReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CarbonCertificationTypeReadAllInner);
  }
}(this, function(ApiClient, CarbonCertificationTypeReadAllInner) {
  'use strict';

  /**
   * The OrganisationTypeReadAll model module.
   * @module model/OrganisationTypeReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationTypeReadAll</code>.
   * @alias module:model/OrganisationTypeReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationTypeReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationTypeReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationTypeReadAll} The populated <code>OrganisationTypeReadAll</code> instance.
   */
