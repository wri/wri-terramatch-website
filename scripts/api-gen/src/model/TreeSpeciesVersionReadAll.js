...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/TreeSpeciesVersionRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TreeSpeciesVersionRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TreeSpeciesVersionReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.TreeSpeciesVersionRead);
  }
}(this, function(ApiClient, TreeSpeciesVersionRead) {
  'use strict';

  /**
   * The TreeSpeciesVersionReadAll model module.
   * @module model/TreeSpeciesVersionReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TreeSpeciesVersionReadAll</code>.
   * @alias module:model/TreeSpeciesVersionReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>TreeSpeciesVersionReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TreeSpeciesVersionReadAll} obj Optional instance to populate.
   * @return {module:model/TreeSpeciesVersionReadAll} The populated <code>TreeSpeciesVersionReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'TreeSpeciesVersionRead');
    }
    return obj;
  }
