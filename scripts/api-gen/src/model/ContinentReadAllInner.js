...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ContinentReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContinentReadAllInner model module.
   * @module model/ContinentReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ContinentReadAllInner</code>.
   * @alias module:model/ContinentReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>ContinentReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContinentReadAllInner} obj Optional instance to populate.
   * @return {module:model/ContinentReadAllInner} The populated <code>ContinentReadAllInner</code> instance.
   */
