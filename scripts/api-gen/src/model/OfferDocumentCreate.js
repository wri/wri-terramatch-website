...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferDocumentCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferDocumentCreate model module.
   * @module model/OfferDocumentCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferDocumentCreate</code>.
   * @alias module:model/OfferDocumentCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferDocumentCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferDocumentCreate} obj Optional instance to populate.
   * @return {module:model/OfferDocumentCreate} The populated <code>OfferDocumentCreate</code> instance.
   */
