...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchDocumentRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchDocumentRead model module.
   * @module model/PitchDocumentRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentRead</code>.
   * @alias module:model/PitchDocumentRead
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentRead} obj Optional instance to populate.
   * @return {module:model/PitchDocumentRead} The populated <code>PitchDocumentRead</code> instance.
   */
