...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchDocumentRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchDocumentRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchDocumentVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchDocumentRead);
  }
}(this, function(ApiClient, PitchDocumentRead) {
  'use strict';

  /**
   * The PitchDocumentVersionRead model module.
   * @module model/PitchDocumentVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchDocumentVersionRead</code>.
   * @alias module:model/PitchDocumentVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchDocumentVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchDocumentVersionRead} obj Optional instance to populate.
   * @return {module:model/PitchDocumentVersionRead} The populated <code>PitchDocumentVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = PitchDocumentRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PitchDocumentRead} data
   */
