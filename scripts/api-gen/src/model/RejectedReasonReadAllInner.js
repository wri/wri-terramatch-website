...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RejectedReasonReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RejectedReasonReadAllInner model module.
   * @module model/RejectedReasonReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RejectedReasonReadAllInner</code>.
   * @alias module:model/RejectedReasonReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>RejectedReasonReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RejectedReasonReadAllInner} obj Optional instance to populate.
   * @return {module:model/RejectedReasonReadAllInner} The populated <code>RejectedReasonReadAllInner</code> instance.
   */
