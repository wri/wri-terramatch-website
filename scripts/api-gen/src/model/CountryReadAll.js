...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/CountryReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CountryReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.CountryReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.CountryReadAllInner);
  }
}(this, function(ApiClient, CountryReadAllInner) {
  'use strict';

  /**
   * The CountryReadAll model module.
   * @module model/CountryReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CountryReadAll</code>.
   * @alias module:model/CountryReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>CountryReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CountryReadAll} obj Optional instance to populate.
   * @return {module:model/CountryReadAll} The populated <code>CountryReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'CountryReadAllInner');
    }
    return obj;
  }
