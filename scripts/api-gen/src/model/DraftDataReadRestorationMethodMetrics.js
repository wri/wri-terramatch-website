...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadRestorationMethodMetrics = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadRestorationMethodMetrics model module.
   * @module model/DraftDataReadRestorationMethodMetrics
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadRestorationMethodMetrics</code>.
   * @alias module:model/DraftDataReadRestorationMethodMetrics
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadRestorationMethodMetrics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadRestorationMethodMetrics} obj Optional instance to populate.
   * @return {module:model/DraftDataReadRestorationMethodMetrics} The populated <code>DraftDataReadRestorationMethodMetrics</code> instance.
   */
   ...
   */
  exports.prototype.restoration_method = undefined;
   ...
   */
  exports.prototype.price_per_hectare = undefined;

  /**
   * @member {Number} biomass_per_hectare
   */
  exports.prototype.biomass_per_hectare = undefined;

  /**
   * @member {Number} carbon_impact
   */
  exports.prototype.carbon_impact = undefined;

  /**
   * @member {Array.<String>} species_impacted
   */
  exports.prototype.species_impacted = undefined;
