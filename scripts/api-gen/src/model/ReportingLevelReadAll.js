...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ReportingLevelReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReportingLevelReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.ReportingLevelReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.ReportingLevelReadAllInner);
  }
}(this, function(ApiClient, ReportingLevelReadAllInner) {
  'use strict';

  /**
   * The ReportingLevelReadAll model module.
   * @module model/ReportingLevelReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReportingLevelReadAll</code>.
   * @alias module:model/ReportingLevelReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>ReportingLevelReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReportingLevelReadAll} obj Optional instance to populate.
   * @return {module:model/ReportingLevelReadAll} The populated <code>ReportingLevelReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'ReportingLevelReadAllInner');
    }
    return obj;
  }
