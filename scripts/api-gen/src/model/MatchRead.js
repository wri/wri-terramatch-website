...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/MatchOfferContactRead', '../model/MatchPitchContactRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MatchOfferContactRead'), require('./MatchPitchContactRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.MatchRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.MatchOfferContactRead, root.WriRestorationMarketplaceApi.MatchPitchContactRead);
  }
}(this, function(ApiClient, MatchOfferContactRead, MatchPitchContactRead) {
  'use strict';

  /**
   * The MatchRead model module.
   * @module model/MatchRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MatchRead</code>.
   * @alias module:model/MatchRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MatchRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MatchRead} obj Optional instance to populate.
   * @return {module:model/MatchRead} The populated <code>MatchRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('offer_interest_id'))
        obj.offer_interest_id = ApiClient.convertToType(data['offer_interest_id'], 'Number');
      if (data.hasOwnProperty('offer_contacts'))
        obj.offer_contacts = ApiClient.convertToType(data['offer_contacts'], [MatchOfferContactRead]);
      if (data.hasOwnProperty('pitch_id'))
        obj.pitch_id = ApiClient.convertToType(data['pitch_id'], 'Number');
      if (data.hasOwnProperty('pitch_interest_id'))
        obj.pitch_interest_id = ApiClient.convertToType(data['pitch_interest_id'], 'Number');
      if (data.hasOwnProperty('pitch_contacts'))
        obj.pitch_contacts = ApiClient.convertToType(data['pitch_contacts'], [MatchPitchContactRead]);
      if (data.hasOwnProperty('matched_at'))
        obj.matched_at = ApiClient.convertToType(data['matched_at'], 'Date');
    }
    return obj;
  }
  ...
  /**
   * @member {Number} offer_interest_id
   */
  exports.prototype.offer_interest_id = undefined;

  /**
   * @member {Array.<module:model/MatchOfferContactRead>} offer_contacts
   */
  ...
  /**
   * @member {Number} pitch_interest_id
   */
  exports.prototype.pitch_interest_id = undefined;

  /**
   * @member {Array.<module:model/MatchPitchContactRead>} pitch_contacts
   */
  exports.prototype.pitch_contacts = undefined;

  /**
   * @member {Date} matched_at
   */
  exports.prototype.matched_at = undefined;
