...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OrganisationDocumentReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.OrganisationDocumentRead);
  }
}(this, function(ApiClient, OrganisationDocumentRead) {
  'use strict';

  /**
   * The OrganisationDocumentReadAll model module.
   * @module model/OrganisationDocumentReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganisationDocumentReadAll</code>.
   * @alias module:model/OrganisationDocumentReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>OrganisationDocumentReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganisationDocumentReadAll} obj Optional instance to populate.
   * @return {module:model/OrganisationDocumentReadAll} The populated <code>OrganisationDocumentReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'OrganisationDocumentRead');
    }
    return obj;
  }
