...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchVisibility = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchVisibility model module.
   * @module model/PitchVisibility
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchVisibility</code>.
   * @alias module:model/PitchVisibility
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchVisibility</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchVisibility} obj Optional instance to populate.
   * @return {module:model/PitchVisibility} The populated <code>PitchVisibility</code> instance.
   */
