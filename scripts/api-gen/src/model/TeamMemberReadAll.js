...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/TeamMemberRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TeamMemberRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.TeamMemberReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.TeamMemberRead);
  }
}(this, function(ApiClient, TeamMemberRead) {
  'use strict';

  /**
   * The TeamMemberReadAll model module.
   * @module model/TeamMemberReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TeamMemberReadAll</code>.
   * @alias module:model/TeamMemberReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>TeamMemberReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TeamMemberReadAll} obj Optional instance to populate.
   * @return {module:model/TeamMemberReadAll} The populated <code>TeamMemberReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'TeamMemberRead');
    }
    return obj;
  }
