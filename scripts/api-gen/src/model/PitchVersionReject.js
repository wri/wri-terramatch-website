...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchVersionReject = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchVersionReject model module.
   * @module model/PitchVersionReject
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchVersionReject</code>.
   * @alias module:model/PitchVersionReject
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchVersionReject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchVersionReject} obj Optional instance to populate.
   * @return {module:model/PitchVersionReject} The populated <code>PitchVersionReject</code> instance.
   */
