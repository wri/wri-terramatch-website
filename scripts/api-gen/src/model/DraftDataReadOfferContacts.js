...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadOfferContacts = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadOfferContacts model module.
   * @module model/DraftDataReadOfferContacts
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadOfferContacts</code>.
   * @alias module:model/DraftDataReadOfferContacts
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadOfferContacts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadOfferContacts} obj Optional instance to populate.
   * @return {module:model/DraftDataReadOfferContacts} The populated <code>DraftDataReadOfferContacts</code> instance.
   */
