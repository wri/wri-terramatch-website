...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MatchContactRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MatchContactRead model module.
   * @module model/MatchContactRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MatchContactRead</code>.
   * @alias module:model/MatchContactRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MatchContactRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MatchContactRead} obj Optional instance to populate.
   * @return {module:model/MatchContactRead} The populated <code>MatchContactRead</code> instance.
   */
