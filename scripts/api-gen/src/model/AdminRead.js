...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AdminRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AdminRead model module.
   * @module model/AdminRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdminRead</code>.
   * @alias module:model/AdminRead
   * @class
   */
  ...
  /**
   * Constructs a <code>AdminRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminRead} obj Optional instance to populate.
   * @return {module:model/AdminRead} The populated <code>AdminRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('email_address_verified_at'))
        obj.email_address_verified_at = ApiClient.convertToType(data['email_address_verified_at'], 'Date');
      if (data.hasOwnProperty('role'))
        obj.role = ApiClient.convertToType(data['role'], 'String');
      if (data.hasOwnProperty('last_logged_in_at'))
        obj.last_logged_in_at = ApiClient.convertToType(data['last_logged_in_at'], 'Date');
  ...
  /**
   * @member {Date} email_address_verified_at
   */
  exports.prototype.email_address_verified_at = undefined;
   ...
   */
  exports.prototype.job_role = undefined;
