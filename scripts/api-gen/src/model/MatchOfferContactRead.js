...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.MatchOfferContactRead = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MatchOfferContactRead model module.
   * @module model/MatchOfferContactRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MatchOfferContactRead</code>.
   * @alias module:model/MatchOfferContactRead
   * @class
   */
  ...
  /**
   * Constructs a <code>MatchOfferContactRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MatchOfferContactRead} obj Optional instance to populate.
   * @return {module:model/MatchOfferContactRead} The populated <code>MatchOfferContactRead</code> instance.
   */
