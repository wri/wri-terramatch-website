...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferContactCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferContactCreateDraft model module.
   * @module model/OfferContactCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferContactCreateDraft</code>.
   * @alias module:model/OfferContactCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferContactCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferContactCreateDraft} obj Optional instance to populate.
   * @return {module:model/OfferContactCreateDraft} The populated <code>OfferContactCreateDraft</code> instance.
   */
