...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/LandOwnershipReadAllInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LandOwnershipReadAllInner'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.LandOwnershipReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.LandOwnershipReadAllInner);
  }
}(this, function(ApiClient, LandOwnershipReadAllInner) {
  'use strict';

  /**
   * The LandOwnershipReadAll model module.
   * @module model/LandOwnershipReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LandOwnershipReadAll</code>.
   * @alias module:model/LandOwnershipReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>LandOwnershipReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LandOwnershipReadAll} obj Optional instance to populate.
   * @return {module:model/LandOwnershipReadAll} The populated <code>LandOwnershipReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'LandOwnershipReadAllInner');
    }
    return obj;
  }
