...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferVisibility = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferVisibility model module.
   * @module model/OfferVisibility
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferVisibility</code>.
   * @alias module:model/OfferVisibility
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferVisibility</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferVisibility} obj Optional instance to populate.
   * @return {module:model/OfferVisibility} The populated <code>OfferVisibility</code> instance.
   */
