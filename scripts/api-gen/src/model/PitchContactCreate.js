...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.PitchContactCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PitchContactCreate model module.
   * @module model/PitchContactCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchContactCreate</code>.
   * @alias module:model/PitchContactCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchContactCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchContactCreate} obj Optional instance to populate.
   * @return {module:model/PitchContactCreate} The populated <code>PitchContactCreate</code> instance.
   */
