...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.ReportingLevelReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ReportingLevelReadAllInner model module.
   * @module model/ReportingLevelReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReportingLevelReadAllInner</code>.
   * @alias module:model/ReportingLevelReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>ReportingLevelReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReportingLevelReadAllInner} obj Optional instance to populate.
   * @return {module:model/ReportingLevelReadAllInner} The populated <code>ReportingLevelReadAllInner</code> instance.
   */
