...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/NotificationRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotificationRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.NotificationReadAll = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.NotificationRead);
  }
}(this, function(ApiClient, NotificationRead) {
  'use strict';

  /**
   * The NotificationReadAll model module.
   * @module model/NotificationReadAll
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NotificationReadAll</code>.
   * @alias module:model/NotificationReadAll
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>NotificationReadAll</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotificationReadAll} obj Optional instance to populate.
   * @return {module:model/NotificationReadAll} The populated <code>NotificationReadAll</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'NotificationRead');
    }
    return obj;
  }
