...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.OfferContactCreate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OfferContactCreate model module.
   * @module model/OfferContactCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OfferContactCreate</code>.
   * @alias module:model/OfferContactCreate
   * @class
   */
  ...
  /**
   * Constructs a <code>OfferContactCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfferContactCreate} obj Optional instance to populate.
   * @return {module:model/OfferContactCreate} The populated <code>OfferContactCreate</code> instance.
   */
