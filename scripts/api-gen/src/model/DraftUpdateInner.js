...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftUpdateInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftUpdateInner model module.
   * @module model/DraftUpdateInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftUpdateInner</code>.
   * @alias module:model/DraftUpdateInner
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftUpdateInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftUpdateInner} obj Optional instance to populate.
   * @return {module:model/DraftUpdateInner} The populated <code>DraftUpdateInner</code> instance.
   */
