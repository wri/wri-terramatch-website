...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/PitchRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PitchRead'));
  } else {
    // Browser globals (root is window)
    if (!root.WriRestorationMarketplaceApi) {
      root.WriRestorationMarketplaceApi = {};
    }
    root.WriRestorationMarketplaceApi.PitchVersionRead = factory(root.WriRestorationMarketplaceApi.ApiClient, root.WriRestorationMarketplaceApi.PitchRead);
  }
}(this, function(ApiClient, PitchRead) {
  'use strict';

  /**
   * The PitchVersionRead model module.
   * @module model/PitchVersionRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PitchVersionRead</code>.
   * @alias module:model/PitchVersionRead
   * @class
   */
  ...
  /**
   * Constructs a <code>PitchVersionRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PitchVersionRead} obj Optional instance to populate.
   * @return {module:model/PitchVersionRead} The populated <code>PitchVersionRead</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = PitchRead.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PitchRead} data
   */
