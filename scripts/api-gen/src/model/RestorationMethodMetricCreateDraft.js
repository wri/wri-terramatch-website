...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodMetricCreateDraft = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationMethodMetricCreateDraft model module.
   * @module model/RestorationMethodMetricCreateDraft
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricCreateDraft</code>.
   * @alias module:model/RestorationMethodMetricCreateDraft
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricCreateDraft</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricCreateDraft} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricCreateDraft} The populated <code>RestorationMethodMetricCreateDraft</code> instance.
   */
