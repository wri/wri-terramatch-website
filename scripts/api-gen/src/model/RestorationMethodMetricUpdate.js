...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RestorationMethodMetricUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RestorationMethodMetricUpdate model module.
   * @module model/RestorationMethodMetricUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RestorationMethodMetricUpdate</code>.
   * @alias module:model/RestorationMethodMetricUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>RestorationMethodMetricUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestorationMethodMetricUpdate} obj Optional instance to populate.
   * @return {module:model/RestorationMethodMetricUpdate} The populated <code>RestorationMethodMetricUpdate</code> instance.
   */
