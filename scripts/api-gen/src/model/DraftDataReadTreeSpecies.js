...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.DraftDataReadTreeSpecies = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DraftDataReadTreeSpecies model module.
   * @module model/DraftDataReadTreeSpecies
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DraftDataReadTreeSpecies</code>.
   * @alias module:model/DraftDataReadTreeSpecies
   * @class
   */
  ...
  /**
   * Constructs a <code>DraftDataReadTreeSpecies</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DraftDataReadTreeSpecies} obj Optional instance to populate.
   * @return {module:model/DraftDataReadTreeSpecies} The populated <code>DraftDataReadTreeSpecies</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_native'))
        obj.is_native = ApiClient.convertToType(data['is_native'], 'Boolean');
      if (data.hasOwnProperty('count'))
        obj.count = ApiClient.convertToType(data['count'], 'Number');
      if (data.hasOwnProperty('price_to_plant'))
        obj.price_to_plant = ApiClient.convertToType(data['price_to_plant'], 'Number');
      if (data.hasOwnProperty('price_to_maintain'))
        obj.price_to_maintain = ApiClient.convertToType(data['price_to_maintain'], 'Number');
      if (data.hasOwnProperty('saplings'))
        obj.saplings = ApiClient.convertToType(data['saplings'], 'Number');
      if (data.hasOwnProperty('site_prep'))
        obj.site_prep = ApiClient.convertToType(data['site_prep'], 'Number');
      if (data.hasOwnProperty('survival_rate'))
        obj.survival_rate = ApiClient.convertToType(data['survival_rate'], 'Number');
      if (data.hasOwnProperty('produces_food'))
        obj.produces_food = ApiClient.convertToType(data['produces_food'], 'Boolean');
      if (data.hasOwnProperty('produces_firewood'))
        obj.produces_firewood = ApiClient.convertToType(data['produces_firewood'], 'Boolean');
      if (data.hasOwnProperty('produces_timber'))
        obj.produces_timber = ApiClient.convertToType(data['produces_timber'], 'Boolean');
  ...
  /**
   * @member {Boolean} is_native
   */
  exports.prototype.is_native = undefined;
  ...
  /**
   * @member {Number} price_to_plant
   */
  exports.prototype.price_to_plant = undefined;

  /**
   * @member {Number} price_to_maintain
   */
  exports.prototype.price_to_maintain = undefined;

  /**
   * @member {Number} saplings
   */
  exports.prototype.saplings = undefined;

  /**
   * @member {Number} site_prep
   */
  exports.prototype.site_prep = undefined;

  /**
   * @member {Number} survival_rate
   */
  exports.prototype.survival_rate = undefined;

  /**
   * @member {Boolean} produces_food
   */
  exports.prototype.produces_food = undefined;

  /**
   * @member {Boolean} produces_firewood
   */
  exports.prototype.produces_firewood = undefined;

  /**
   * @member {Boolean} produces_timber
   */
  exports.prototype.produces_timber = undefined;
