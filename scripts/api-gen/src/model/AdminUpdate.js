...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.AdminUpdate = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AdminUpdate model module.
   * @module model/AdminUpdate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdminUpdate</code>.
   * @alias module:model/AdminUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>AdminUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminUpdate} obj Optional instance to populate.
   * @return {module:model/AdminUpdate} The populated <code>AdminUpdate</code> instance.
   */
