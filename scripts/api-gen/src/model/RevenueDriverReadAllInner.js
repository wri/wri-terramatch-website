...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.RevenueDriverReadAllInner = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RevenueDriverReadAllInner model module.
   * @module model/RevenueDriverReadAllInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RevenueDriverReadAllInner</code>.
   * @alias module:model/RevenueDriverReadAllInner
   * @class
   */
  ...
  /**
   * Constructs a <code>RevenueDriverReadAllInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RevenueDriverReadAllInner} obj Optional instance to populate.
   * @return {module:model/RevenueDriverReadAllInner} The populated <code>RevenueDriverReadAllInner</code> instance.
   */
