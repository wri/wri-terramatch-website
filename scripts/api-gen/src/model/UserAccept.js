...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WriRestorationMarketplaceApi.UserAccept = factory(root.WriRestorationMarketplaceApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UserAccept model module.
   * @module model/UserAccept
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UserAccept</code>.
   * @alias module:model/UserAccept
   * @class
   */
  ...
  /**
   * Constructs a <code>UserAccept</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserAccept} obj Optional instance to populate.
   * @return {module:model/UserAccept} The populated <code>UserAccept</code> instance.
   */
