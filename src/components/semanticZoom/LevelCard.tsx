...
export interface LevelCardProps {
  ...
  expectations?: Partial<Record<(typeof INDICATOR_ORDER)[number], string>>;
  /** The "what just changed" line, rendered between the header and the indicators. */
  delta?: ReactNode;
        ...
        <ul>
          {INDICATOR_ORDER.map(key => (
            <IndicatorRow
              ...
              goal={goals?.[key] ?? null}
              expectation={expectations?.[key] ?? null}
            />
          ))}
        </ul>
