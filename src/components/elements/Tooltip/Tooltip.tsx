  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute bottom-0 left-1/2 ml-[-4px] mb-[-9px] border-[5px] border-darkCustom border-r-transparent border-b-transparent border-l-transparent group-hover:block" />
