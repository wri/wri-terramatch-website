          ...
          <div className="absolute bottom-1 w-max rounded-lg bg-white p-2 shadow">
            ...
            >
              <div className="text-12-semibold flex items-center">
                <div className="mr-2 h-3 w-3 rounded-sm bg-blue lg:h-4 lg:w-4 wide:h-5 wide:w-5" />
                {t("Submitted")}
              </div>
            </Button>
            <Button
            ...
            >
              <div className="text-12-semibold flex items-center">
                <div className="mr-2 h-3 w-3 rounded-sm bg-green lg:h-4 lg:w-4 wide:h-5 wide:w-5" />
                {t("Approved")}
              </div>
            </Button>
          </div>
