...
export const getCoreTeamLeadersTableHeaders = (
  ...
  { accessorKey: "gender", header: t("Gender") },
...
const RHFCoreTeamLeadersDataTable = ({
  ...
  return (
    <DataTable
      ...
      tableHeaders={getCoreTeamLeadersTableHeaders(t)}
      fields={[
        {
          label: "Core Team Member first name",
          name: "first_name",
        ...
        {
          label: "Core Team member last name",
          name: "last_name",
          type: FieldType.Input,
          validation: yup.string().required(),
          fieldProps: {
