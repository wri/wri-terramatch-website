...
export type AboutPageItemDisplayProps = Pick<PageItemProps, "flexProps" | "className"> & {
...
const AboutPageItemDisplay: FC<AboutPageItemDisplayProps> = ({
  aboutSection,
  flexProps,
  className,
  contentClassName,
...
export default AboutPageItemDisplay;
