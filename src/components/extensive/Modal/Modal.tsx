  ...
  return (
    <div
      ...
      className={classNames(
        className,
        "margin-4 m-auto flex max-h-full max-w-[800px] flex-col items-center justify-start overflow-y-auto rounded-lg border-2 border-neutral-100 bg-white p-15"
      )}
    >
      {children}
    </div>
    ...
    <ModalBase {...rest}>
      <When condition={!!iconProps}>
        <Icon
          width={40}
          {...iconProps!}
          className={classNames(iconProps?.className, "mb-8")}
          style={{ minHeight: iconProps?.height || 40 }}
        />
      </When>
