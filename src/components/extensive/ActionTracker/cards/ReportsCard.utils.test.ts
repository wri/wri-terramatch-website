...
describe("ReportsCard.utils (TM-2947)", () => {
  ...
  describe("groupSiteAndNurseryReportsByTask", () => {
    ...
    it("ignores site and nursery reports without taskUuid", () => {
      const actions = [
        { targetableType: "siteReports", target: { projectUuid: "proj-1" } },
        { targetableType: "nurseryReports", target: { projectUuid: "proj-1" } }
      ] as unknown as ActionDto[];
