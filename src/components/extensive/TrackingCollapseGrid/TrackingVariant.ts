import { TrackingGridVariantProps } from "./types";

export const GRID_VARIANT_DEFAULT: TrackingGridVariantProps = {
...
export const GRID_VARIANT_GREEN: TrackingGridVariantProps = {
...
export const GRID_VARIANT_NARROW: TrackingGridVariantProps = {
  header: "rounded bg-neutral-350",
