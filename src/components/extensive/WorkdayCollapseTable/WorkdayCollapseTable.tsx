        ...
        <div className="bg-neutral-75 px-4 py-5">
          <div className="overflow-hiden grid w-full grid-cols-15 gap-x-px gap-y-px rounded-2xl border border-neutral-200 bg-neutral-200 leading-normal ">
            {content.map((contents, index) => (
              <Fragment key={index}>
                <div className={classNames("col-span-4 row-span-5 flex items-center justify-center bg-white")}>
                ...
                <div className="col-span-4 bg-white">
                  <Text
                    ...
                    className="flex items-start justify-center gap-2 bg-neutral-450 px-4 py-2 leading-normal text-customBlue-50"
                  >
                    {contents.total}
                    <Icon name={IconNames.ROUND_CUSTOM_TICK} width={16} height={16} className="text-customGreen-200" />
                  </Text>
                ...
                <When condition={contents.type === "Ethnicity"}>
                  ...
                  <div className="col-span-4 bg-white">
                    <input className="text-14-light w-full border border-b border-transparent border-b-neutral-200 px-4 py-[9.5px] text-center outline-0 hover:border-primary hover:shadow-blue-border-input" />
                  </div>
                </When>
              </Fragment>
            ))}
