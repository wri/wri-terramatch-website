import {
  MultiActionButton as WriMultiActionButton,
  MultiActionButtonProps as WriMultiActionButtonProps
...
export interface IMultiActionButtonProps extends WriMultiActionButtonProps {
  className?: string;
}
