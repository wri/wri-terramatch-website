...
const Banner: FC<BannerProps> = ({ breadcrumbs, suffix, toolbar, className, children }) => {
  ...
  return (
    <>
      <Box
        className={classNames("border-theme-neutral-300 sticky top-[0px] z-20 border-b px-1 sm:top-[70px]", className)}
      >
        <ToolbarObject
          breadcrumbs={{
      ...
      {children}
      <Box className="border-theme-neutral-200 sticky top-[45px] z-20 border-b-4 px-0.5 sm:top-[115px]">
