...
const NURSERY_TYPE_MAP: Record<string, NurseryTypeConfig> = {
  ...
  building: { icon: <NurseryBuildingIcon className="h-8 w-8 text-theme-secondary-800" />, label: "New Nursery" },
  managing: { icon: <NurseryManagingIcon className="h-8 w-8 text-theme-secondary-800" />, label: "Co-managed Nursery" }
};
