...
export const HECTARES_UNDER_RESTORATION =
...
export const NUMBER_OF_TREES_PLANTED_BY_YEAR = "Number of trees planted in each year.";

export const TOP_5_PROJECTS_WITH_MOST_PLANTED_TREES =
...
export const JOBS_CREATED_BY_GENDER = "Total number of employees broken down by gender.";
...
export const VOLUNTEERS_CREATED_BY_GENDER = "Total number of volunteers broken down by gender.";
...
export const TREES_RESTORED_SECTION =
...
export const HECTARES_UNDER_RESTORATION_SECTION =
...
export const JOBS_CREATED_SECTION =
