...
const PastRestorationExperience = ({ organization }: PastRestorationExperienceProps) => {
  ...
  try {
    projectBoundary =
      organization?.historicMonitoringGeojson != null ? JSON.parse(organization.historicMonitoringGeojson) : undefined;
  } catch (e) {
    ...
    <section className="my-10 rounded-lg bg-neutral-150 p-8">
      ...
      <div className="mt-10 flex flex-col gap-4">
        ...
        <TextRow
          ...
          value={organization?.restorationTypesImplemented
            ?.map((item: string) => {
          ...
          nameClassName="w-1/3"
        />
        <When condition={organization?.historicMonitoringGeojson != null}>
          <div>
