...
const AuditLog = ({ label, srpReport, refresh: refreshSite, enableChangeStatus, ...rest }: ReportingTasksProps) => {
  ...
  const [buttonToggle, setButtonToggle] = useState(AuditLogButtonStates.SRP_REPORT);
  ...
  const entityTypeSrpReport = srpReportLevel ? AuditLogEntityEnum.Srp_Report : entityType;
                ...
                <div className="grid w-[64%] gap-6 mobile:w-full">
                  ...
                  <When condition={buttonToggle === ButtonStates.PROJECTS}>
                    ...
                    <Link
                      ...
                      href={`/project/${srpReport?.projectUuid}?tab=audit-log`}
                    >
