...
const AuditLog: FC<AuditLogProps> = ({ nurseryReport, refresh: refreshReport }) => {
  const nurseryReportButtonToggle = AuditLogButtonStates.NURSERY_REPORT;
  const {
    onStatusChange,
    onChangeRequest,
    valuesForStatus,
    ...
    record: nurseryReport,
    buttonToggle: nurseryReportButtonToggle,
    entityLevel: nurseryReportButtonToggle
  });

  useValueChanged(nurseryReportButtonToggle, () => {
    refetch();
    loadEntityList();
  });
