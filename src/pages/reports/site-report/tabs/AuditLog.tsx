...
const AuditLog: FC<AuditLogProps> = ({ siteReport, refresh: refreshReport }) => {
  const siteReportButtonToggle = AuditLogButtonStates.SITE_REPORT;
  ...
  const {
    ...
    entityLevel: siteReportButtonToggle
  });

  useValueChanged(siteReportButtonToggle, () => {
    refetch();
    loadEntityList();
  });
