...
import { useFailureToast } from "@/hooks/useConnectionUpdate";
import { NothingToReportEntity } from "@/pages/project/[uuid]/reporting-task/types";
...
const NothingToReportModal: FC<NothingToReportModalProps> = ({ entity, uuid }) => {
  const [entityLoaded, { update, isUpdating, updateFailure }] = useFullEntity(entity, uuid);
  ...
  useFailureToast(isUpdating, updateFailure);
