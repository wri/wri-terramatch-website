...
const KeyIndicatorsInsightsTab: FC<KeyIndicatorsInsightsProps> = ({ project }) => {
  ...
  return (
    <FrameworkProvider frameworkKey={effectiveFrameworkKey}>
      <Flex gap={isSmallResolution ? 10 : 3} flex={1} justify={isLargerResolution ? "flex-start" : "space-between"}>
        ...
        />
        <ContextCondition frameworksShow={[Framework.TF_3]}>
          <MetricCard
            title="Trees Grown"
            progress={0}
            goal={treesGrownGoal}
        ...
        <ContextCondition frameworksHide={[Framework.TF_3]}>
          <MetricCard
