...
export type GetV2TasksIDIdPathParams = {
  id: number;
};

export type GetV2TasksIDIdError = Fetcher.ErrorWrapper<undefined>;

export type GetV2TasksIDIdResponse = {
  uuid?: string;
};

export type GetV2TasksIDIdVariables = {
  pathParams: GetV2TasksIDIdPathParams;
} & ApiContext["fetcherOptions"];

export const fetchGetV2TasksIDId = (variables: GetV2TasksIDIdVariables, signal?: AbortSignal) =>
  apiFetch<GetV2TasksIDIdResponse, GetV2TasksIDIdError, undefined, {}, {}, GetV2TasksIDIdPathParams>({
    url: "/v2/tasks/{id}/id",
    method: "get",
    ...variables,
    signal
...
export const useGetV2TasksIDId = <TData = GetV2TasksIDIdResponse>(
  variables: GetV2TasksIDIdVariables,
  options?: Omit<reactQuery.UseQueryOptions<GetV2TasksIDIdResponse, GetV2TasksIDIdError, TData>, "queryKey" | "queryFn">
) => {
  const { fetcherOptions, queryOptions, queryKeyFn } = useApiContext(options);
  return reactQuery.useQuery<GetV2TasksIDIdResponse, GetV2TasksIDIdError, TData>(
    queryKeyFn({ path: "/v2/tasks/{ID}/id", operationId: "getV2TasksIDId", variables }),
    ({ signal }) => fetchGetV2TasksIDId({ ...fetcherOptions, ...variables }, signal),
    {
      ...options,
      ...queryOptions
    }
