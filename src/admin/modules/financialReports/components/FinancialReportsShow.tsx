        ...
        <RecordFrameworkProvider>
          <TabbedShowLayout>
            ...
            <TabbedShowLayout.Tab label="Organization Details">
              ...
              />
              <TextField
                source="organisation.hq_street_1"
                label="Headquarters Street address"
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.hq_street_2"
                label="Headquarters Street address 2"
                emptyText="Not Provided"
              />
              <TextField source="organisation.hq_city" label="Headquarters City" emptyText="Not Provided" />
              <TextField
                source="organisation.hq_state"
                label="Headquarters address State/Province"
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.hq_zipcode"
                label="Headquarters address Zipcode"
                emptyText="Not Provided"
              />
              <SelectField
                source="organisation.hq_country"
                label="Headquarters address Country"
                choices={countryChoices}
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.phone"
                label="Organization WhatsApp Enabled Phone Number"
                emptyText="Not Provided"
              />
              <DateField
                source="organisation.founding_date"
                label="Date organization founded"
                emptyText="Not Provided"
                locales="en-GB"
              />
              <TextField source="organisation.description" label="Organization Details" emptyText="Not Provided" />
              <ImageField source="organisation.logo.url" label="Logo" title="logo.file_name" emptyText="Not Provided" />
              <ImageField
                source="organisation.cover.url"
                label="Cover"
                title="cover.file_name"
                emptyText="Not Provided"
              />

              <FileArrayField source="organisation.reference" label="Reference Letters" />
              <FileArrayField source="organisation.additional" label="Other additional documents" />
              <FileArrayField source="organisation.legal_registration" label="Proof of legal registrations" />
              <Divider />

              <Typography variant="h6" component="h3">
                Social Media
              </Typography>
              <UrlField source="organisation.web_url" label="Website" emptyText="Not Provided" target="_blank" />
              <UrlField source="organisation.facebook_url" label="Facebook" emptyText="Not Provided" target="_blank" />
              <UrlField
                source="organisation.instagram_url"
                label="Instagram"
                emptyText="Not Provided"
                target="_blank"
              />
              <UrlField source="organisation.linkedin_url" label="LinkedIn" emptyText="Not Provided" target="_blank" />
              <UrlField source="organisation.twitter_url" label="Twitter" emptyText="Not Provided" target="_blank" />
            ...
            <TabbedShowLayout.Tab label="Community Engagement">
              <SimpleChipFieldArray
                source="organisation.engagement_farmers"
              ...
              />
              <SimpleChipFieldArray
                source="organisation.engagement_women"
              ...
              />
              <SimpleChipFieldArray
                source="organisation.engagement_youth"
              ...
              />
              <TextField
                source="organisation.community_experience"
                label="Community Engagement Experience/Approach"
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.total_engaged_community_members_3yr"
            ...
            <TabbedShowLayout.Tab label="Restoration Experience">
              <NumberField
                source="organisation.relevant_experience_years"
                label="Years of relevant restoration experience"
                emptyText="Not Provided"
              />
              <NumberField
                source="organisation.ha_restored_total"
                label="Total Hectares Restored"
                emptyText="Not Provided"
              />
              <NumberField
                source="organisation.ha_restored_3year"
                label="Hectares Restored in the last 3 years"
                emptyText="Not Provided"
              />
              <NumberField source="organisation.trees_grown_total" label="Total Trees Grown" emptyText="Not Provided" />
              <NumberField
                source="organisation.trees_grown_3year"
                label="Trees Grown in the last 3 years"
                emptyText="Not Provided"
              />
              <ArrayField
                source="organisation.tree_species_historical"
              ...
              <NumberField
                source="organisation.avg_tree_survival_rate"
                label="Average Tree Survival Rate"
                emptyText="Not Provided"
              />
              <SimpleChipFieldArray
                source="organisation.restoration_types_implemented"
                label="Restoration Intervention Types Implemented"
                choices={optionToChoices(getRestorationInterventionTypeOptions())}
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.tree_maintenance_aftercare_approach"
                label="Tree Maintenance & After Care Approach"
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.restored_areas_description"
                label="Description of areas restored"
                emptyText="Not Provided"
              />
              <TextField
                source="organisation.monitoring_evaluation_experience"
                label="Monitoring and evaluation experience"
                emptyText="Not Provided"
              />
              <MapField
                label="Historic monitoring shapefile"
                source="organisation.historic_monitoring_geojson"
                emptyText="Not Provided"
              />
              <FileArrayField
                source="organisation.previous_annual_reports"
                label="Previous Annual Reports for Monitored Restoration Projects"
                emptyText="Not Provided"
              />
              <FileArrayField
                source="organisation.historic_restoration"
