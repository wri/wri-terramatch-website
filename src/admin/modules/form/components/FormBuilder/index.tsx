...
import { ArrayInput, DateTimeInput, maxLength, required, TextInput } from "react-admin";
...
import { maxFileSize, minArrayLength } from "@/admin/utils/forms";
import {
...
export const FormBuilderForm = () => {
  ...
  const { getValues } = useFormContext<FormRead>();
  ...
  return (
    <>
      ...
      <ArrayInput source="form_sections" label="Form Sections" validate={[minArrayLength(1, "Section")]}>
        ...
        >
          ...
          <QuestionArrayInput
            ...
            title="Question"
            linkedFieldsData={linkedFieldsData?.data || []}
