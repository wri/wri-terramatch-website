...
/**
 * react-admin bridge: opens the standalone site polygon review page from the site show tab. Reviews,
 * validates, and edits the site's polygons in the new dedicated page (opened in a new browser tab).
 */
