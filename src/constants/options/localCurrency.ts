...
export const currencySymbol = (currency: any) =>
  Object.keys(CURRENCY_INPUT).includes(currency) ? CURRENCY_INPUT[currency as keyof typeof CURRENCY_INPUT] : "";
...
export const getCurrencyOptions = (t: typeof useT = (t: string) => t): Option[] => [
  ...
  { title: t("CDF - Congolese Fran"), value: "CDF" },
